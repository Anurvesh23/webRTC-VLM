...
var Dn = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof __require < "u" ? __require : t)[r] }) : e)(function(e) {
...
var Gp = (e, t, r, n) => {
  if (t && typeof t == "object" || typeof t == "function") for (let o of Wp(t)) !Lp.call(e, o) && o !== r && zn(e, o, { get: () => t[o], enumerable: !(n = Vp(t, o)) || n.enumerable });
  return e;
};
var qt = (e) => Gp(zn({}, "__esModule", { value: true }), e);
var hr;
var St;
var Tt;
var Hp;
  ...
  hr = /* @__PURE__ */ new Map(), St = [], Tt = (e, t, r) => {
    if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
      ...
      if (r >= 0) {
        let o = St.indexOf(e);
        o !== -1 && St.splice(o, 1);
        for (let i = 0; i < St.length; i++) if (hr.get(St[i]).priority <= r) {
          St.splice(i, 0, e);
          return;
        }
        St.push(e);
    ...
    let t = e.executionProviders || [], r = t.map((d) => typeof d == "string" ? d : d.name), n = r.length === 0 ? St : r, o, i = [], a = /* @__PURE__ */ new Set();
    for (let d of n) {
      let c = await Hp(d);
...
var Mn = U(() => {
  "use strict";
  ji();
  Zi = "warning", Me = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: Ki }, set logLevel(e) {
    if (e !== void 0) {
...
var Ji = U(() => {
  ...
  Yi = (e, t) => {
    ...
    if (n != null) {
      let o, i;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (o = e.dims[2], i = e.dims[3]) : (o = e.dims[3], i = e.dims[2]);
      let a = (t == null ? void 0 : t.format) !== void 0 ? t.format : "RGB", u = t == null ? void 0 : t.norm, d, c;
      ...
      for (let _ = 0; _ < i; _++) for (let S = 0; S < o; S++) {
        let $ = (e.data[m++] - c[0]) * d[0], w = (e.data[f++] - c[1]) * d[1], x = (e.data[b++] - c[2]) * d[2], T = g === -1 ? 255 : (e.data[g++] - c[3]) * d[3];
        n.fillStyle = "rgba(" + $ + "," + w + "," + x + "," + T + ")", n.fillRect(S, _, 1, 1);
      }
    ...
    if (r != null) {
      let o, i, a;
      (t == null ? void 0 : t.tensorLayout) !== void 0 && t.tensorLayout === "NHWC" ? (o = e.dims[2], i = e.dims[1], a = e.dims[3]) : (o = e.dims[3], i = e.dims[2], a = e.dims[1]);
      let u = t !== void 0 && t.format !== void 0 ? t.format : "RGB", d = t == null ? void 0 : t.norm, c, p;
      ...
      let f = 4, b = 0, g = 1, _ = 2, S = 3, $ = 0, w = m, x = m * 2, T = -1;
      u === "RGBA" ? ($ = 0, w = m, x = m * 2, T = m * 3) : u === "RGB" ? ($ = 0, w = m, x = m * 2) : u === "RBG" && ($ = 0, x = m, w = m * 2), n = r.createImageData(o, i);
      for (let k = 0; k < i * o; b += f, g += f, _ += f, S += f, k++) n.data[b] = (e.data[$++] - p[0]) * c[0], n.data[g] = (e.data[w++] - p[1]) * c[1], n.data[_] = (e.data[x++] - p[2]) * c[2], n.data[S] = T === -1 ? 255 : (e.data[T++] - p[3]) * c[3];
    } else throw new Error("Can not access image data");
    return n;
  };
});
...
var ia = U(() => {
  ...
  Rn = (e, t) => {
    ...
    let u = t.format !== void 0 ? t.format : "RGBA", d = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : "RGB", c = r * n, p = d === "RGBA" ? new Float32Array(c * 4) : new Float32Array(c * 3), m = 4, f = 0, b = 1, g = 2, _ = 3, S = 0, $ = c, w = c * 2, x = -1;
    u === "RGB" && (m = 3, f = 0, b = 1, g = 2, _ = -1), d === "RGBA" ? x = c * 3 : d === "RBG" ? (S = 0, w = c, $ = c * 2) : d === "BGR" && (w = 0, $ = c, S = c * 2);
    for (let k = 0; k < c; k++, f += m, g += m, b += m, _ += m) p[S++] = (e[f] + a[0]) / i[0], p[$++] = (e[b] + a[1]) / i[1], p[w++] = (e[g] + a[2]) / i[2], x !== -1 && _ !== -1 && (p[x++] = (e[_] + a[3]) / i[3]);
    ...
    if (r) {
      ...
      if (m != null) {
        let f = e.height, b = e.width;
        return m.drawImage(e, 0, 0, b, f), a = m.getImageData(0, 0, b, f).data, u.height = f, u.width = b, Rn(a, u);
      } else throw new Error("Can not access image data");
    } else {
      if (i) return new Promise((p, m) => {
        ...
        g.crossOrigin = "Anonymous", g.src = e, g.onload = () => {
          ...
          u.height = f.height, u.width = f.width, p(Rn(_.data, u));
        };
      });
      throw new Error("Input data provided is not supported - aborted tensor creation");
    }
    if (a !== void 0) return Rn(a, u);
    throw new Error("Input data provided is not supported - aborted tensor creation");
  }, ta = (e, t) => {
...
var ua = U(() => {
  ...
  It = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), Kt = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), aa = false, sa = () => {
    if (!aa) {
      ...
      e && (It.set("int64", BigInt64Array), Kt.set(BigInt64Array, "int64")), t && (It.set("uint64", BigUint64Array), Kt.set(BigUint64Array, "uint64")), n ? (It.set("float16", r), Kt.set(r, "float16")) : It.set("float16", Uint16Array);
    }
  };
});
var da;
  ...
  yr = class e {
    ...
    async run(t, r, n) {
      ...
      if (typeof r == "object") {
        ...
        if (Array.isArray(r)) {
          ...
          for (let m of this.outputNames) if (p.indexOf(m) !== -1) {
            let f = r[m];
            (f === null || f instanceof He) && (c = true, a = false, o[m] = f);
          }
          if (c) {
            if (typeof n == "object" && n !== null) i = n;
            else if (typeof n < "u") throw new TypeError("'options' must be an object.");
      ...
      for (let c in u) if (Object.hasOwnProperty.call(u, c)) {
        let p = u[c];
        p instanceof He ? d[c] = p : d[c] = new He(p.type, p.data, p.dims);
      }
      return De(), d;
    }
    async release() {
...
var Vn = {};
Rt(Vn, { InferenceSession: () => Fp, TRACE: () => br, TRACE_FUNC_BEGIN: () => Re, TRACE_FUNC_END: () => De, Tensor: () => He, env: () => be, registerBackend: () => Tt });
var We = U(() => {
  "use strict";
  qi();
  Qi();
...
var xa = U(() => {
  ...
  yt();
  wr();
  wa = "ort-wasm-proxy-worker", va = ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === wa;
  va && (self.onmessage = (e) => {
    ...
    try {
      switch (t) {
        ...
        case "release":
          Tr(r), postMessage({ type: t });
          break;
        case "run": {
          let { sessionId: n, inputIndices: o, inputs: i, outputIndices: a, options: u } = r;
          Ir(n, o, i, a, new Array(a.length).fill(null), u).then((d) => {
            d.some((c) => c[3] !== "cpu") ? postMessage({ type: t, err: "Proxy does not support non-cpu tensor location." }) : postMessage({ type: t, out: d }, Ar([...i, ...d]));
          }, (d) => {
  ...
  qp = va ? null : (e) => new Worker(e ?? Ue, { type: "module", name: wa });
});
var Ta = {};
Rt(Ta, { default: () => Kp });
var Ln;
...
var Ia = U(() => {
  "use strict";
  var _a2, _b;
  Sa = (Ln = import.meta.url, async function(e = {}) {
    var _a3;
    var t, r, n = e, o = new Promise((s, l) => {
      t = s, r = l;
    }), i = typeof window == "object", a = typeof WorkerGlobalScope < "u", u = a && ((_a3 = self.name) == null ? void 0 : _a3.startsWith("em-pthread"));
    n.mountExternalData = (s, l) => {
      s.startsWith("./") && (s = s.substring(2)), (n.Fb || (n.Fb = /* @__PURE__ */ new Map())).set(s, l);
    ...
    let c = (s) => async (...l) => {
      ...
      try {
        ...
        let h = n.Gb = { ec: l[0], errors: [] }, y = await s(...l);
        if (n.Gb !== h) throw Error("Session mismatch");
        (_a4 = n.Kb) == null ? void 0 : _a4.flush();
        let v = h.errors;
        if (0 < v.length) {
          let A = await Promise.all(v);
          if (A = A.filter((D) => D), 0 < A.length) throw Error(A.join(`
`));
        }
        return y;
      } finally {
    ...
    n.jsepInit = (s, l) => {
      if (s === "webgpu") {
        [n.Kb, n.Vb, n.Zb, n.Lb, n.Yb, n.kb, n.$b, n.bc, n.Wb, n.Xb, n.ac] = l;
        let h = n.Kb;
        n.jsepRegisterBuffer = (y, v, A, D) => h.registerBuffer(y, v, A, D), n.jsepGetBuffer = (y) => h.getBuffer(y), n.jsepCreateDownloader = (y, v, A) => h.createDownloader(y, v, A), n.jsepOnCreateSession = (y) => {
          h.onCreateSession(y);
        }, n.jsepOnReleaseSession = (y) => {
          h.onReleaseSession(y);
        }, n.jsepOnRunStart = (y) => h.onRunStart(y), n.cc = (y, v) => {
          h.upload(y, v);
        };
      } else if (s === "webnn") {
        let h = l[0];
        [n.oc, n.Ob, n.webnnEnsureTensor, n.Pb, n.webnnDownloadTensor] = l.slice(1), n.webnnReleaseTensorId = n.Ob, n.webnnUploadTensor = n.Pb, n.webnnOnRunStart = (y) => h.onRunStart(y), n.webnnOnRunEnd = h.onRunEnd.bind(h), n.webnnRegisterMLContext = (y, v) => {
          h.registerMLContext(y, v);
        }, n.webnnOnReleaseSession = (y) => {
          h.onReleaseSession(y);
        }, n.webnnCreateMLTensorDownloader = (y, v) => h.createMLTensorDownloader(y, v), n.webnnRegisterMLTensor = (y, v, A, D) => h.registerMLTensor(y, v, A, D), n.webnnCreateMLContext = (y) => h.createMLContext(y), n.webnnRegisterMLConstant = (y, v, A, D, R, G) => h.registerMLConstant(y, v, A, D, R, n.Fb, G), n.webnnRegisterGraphInput = h.registerGraphInput.bind(h), n.webnnIsGraphInput = h.isGraphInput.bind(h), n.webnnRegisterGraphOutput = h.registerGraphOutput.bind(h), n.webnnIsGraphOutput = h.isGraphOutput.bind(h), n.webnnCreateTemporaryTensor = h.createTemporaryTensor.bind(h), n.webnnIsGraphInputOutputTypeSupported = h.isGraphInputOutputTypeSupported.bind(h);
      }
    };
    let p = () => {
      let s = (l, h, y) => (...v) => {
        let A = Qe, D = h == null ? void 0 : h();
        v = l(...v);
        let R = h == null ? void 0 : h();
        return D !== R && (l = R, y(D), h = y = null), Qe != A ? new Promise((G, K) => {
          Tn = { resolve: G, reject: K };
        }) : v;
      };
      (() => {
    ...
    (i || a) && (a ? _ = self.location.href : typeof document < "u" && document.currentScript && (_ = document.currentScript.src), Ln && (_ = Ln), _ = _.startsWith("blob:") ? "" : _.slice(0, _.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (f = (s) => {
      var l = new XMLHttpRequest();
      return l.open("GET", s, false), l.responseType = "arraybuffer", l.send(null), new Uint8Array(l.response);
    }), m = async (s) => {
      if (Z(s)) return new Promise((h, y) => {
        var v = new XMLHttpRequest();
        v.open("GET", s, true), v.responseType = "arraybuffer", v.onload = () => {
          v.status == 200 || v.status == 0 && v.response ? h(v.response) : y(v.status);
        }, v.onerror = y, v.send(null);
      });
      var l = await fetch(s, { credentials: "same-origin" });
      if (l.ok) return l.arrayBuffer();
      throw Error(l.status + " : " + l.url);
    });
    var S = console.log.bind(console), $ = console.error.bind(console), w = S, x = $;
    Object.assign(n, b), b = null;
    var T, k, I, O, z, B, W, q, j, te, V, de, J, H = n.wasmBinary, ae = false, Z = (s) => s.startsWith("file://");
    function re() {
      return T.buffer != O.buffer && ce(), O;
    }
    function ve() {
      return T.buffer != O.buffer && ce(), z;
    }
    function _e() {
      return T.buffer != O.buffer && ce(), B;
    }
    function ee() {
      return T.buffer != O.buffer && ce(), W;
    }
    function C() {
      return T.buffer != O.buffer && ce(), q;
    }
    function L() {
      return T.buffer != O.buffer && ce(), j;
    }
    function le() {
      return T.buffer != O.buffer && ce(), te;
    }
    function Ce() {
      return T.buffer != O.buffer && ce(), J;
    }
    if (u) {
      let s = function(l) {
        try {
          ...
          if (y === "load") {
            let v = [];
            self.onmessage = (A) => v.push(A), self.startWorker = () => {
              postMessage({ Cb: "loaded" });
              for (let A of v) s(A);
              self.onmessage = s;
            };
            for (let A of h.Sb) n[A] && !n[A].proxy || (n[A] = (...D) => {
              postMessage({ Cb: "callHandler", Rb: A, args: D });
            }, A == "print" && (w = n[A]), A == "printErr" && (x = n[A]));
            T = h.lc, ce(), ze(h.mc);
          } else if (y === "run") {
            wc(h.Bb), kn(h.Bb, 0, 0, 1, 0, 0), No(), xn(h.Bb), xe || (zi(), xe = true);
            try {
              vc(h.hc, h.Ib);
            } catch (v) {
              if (v != "unwind") throw v;
            }
          } else h.target !== "setimmediate" && (y === "checkMailbox" ? xe && or() : y && (x(`worker: received unknown command ${y}`), x(h)));
        } catch (v) {
          throw Di(), v;
        }
      };
      ...
      x = function(...l) {
        ...
        postMessage({ Cb: "alert", text: l.join(" "), jc: pr() });
    ...
    function ce() {
      var s = T.buffer;
      n.HEAP8 = O = new Int8Array(s), n.HEAP16 = B = new Int16Array(s), n.HEAPU8 = z = new Uint8Array(s), n.HEAPU16 = W = new Uint16Array(s), n.HEAP32 = q = new Int32Array(s), n.HEAPU32 = j = new Uint32Array(s), n.HEAPF32 = te = new Float32Array(s), n.HEAPF64 = J = new Float64Array(s), n.HEAP64 = V = new BigInt64Array(s), n.HEAPU64 = de = new BigUint64Array(s);
    }
    function Ge() {
      u ? startWorker(n) : Q.Da();
    }
    ...
    function pt(s) {
      throw x(s = "Aborted(" + s + ")"), ae = true, s = new WebAssembly.RuntimeError(s + ". Build with -sASSERTIONS for more info."), r(s), s;
    }
    function zo() {
      return { a: { L: _c, Aa: yc, b: xc, $: Go, A: qo, pa: Ko, X: Zo, Z: Qo, qa: Yo, na: Xo, ga: Jo, ma: ei, J: ti, Y: ri, V: ni, oa: oi, W: ii, va: Sc, E: Ic, Q: Cc, O: kc, D: Pc, v: Oc, r: zc, P: Dc, z: Wc, R: Lc, ja: Gc, T: Hc, aa: Fc, M: qc, F: Kc, ia: xn, sa: jc, t: Zc, Ca: Qc, w: Jc, o: ep, m: rp, c: wn, Ba: np, n: op, j: sp, u: up, p: dp, f: lp, s: cp, l: pp, e: mp, k: fp, h: hp, g: gp, d: bp, da: yp, ea: _p, fa: wp, ba: _i, ca: wi, N: vi, xa: $p, ua: Tp, i: Ip, C: Cp, G: Ap, ta: xp, x: kp, ra: Ep, U: Pp, q: vp, y: Op, K: zp, S: Dp, za: Bp, ya: Mp, ka: Ti, la: Ii, _: gn, B: Ci, I: Ai, ha: ki, H: Ei, a: T, wa: hn } };
    }
    var pn = { 840156: (s, l, h, y, v) => {
      if (n === void 0 || !n.Fb) return 1;
      if ((s = Te(Number(s >>> 0))).startsWith("./") && (s = s.substring(2)), !(s = n.Fb.get(s))) return 2;
      ...
      n.Pb(s, ve().subarray(l >>> 0, l + h >>> 0));
    }, 841044: () => n.oc(), 841086: (s) => {
      n.Ob(s);
    }, 841123: () => {
      n.Wb();
    }, 841154: () => {
      ...
      n.ac();
    }, 841208: (s) => n.Vb(s), 841241: (s) => n.Zb(s), 841273: (s, l, h) => {
      n.Lb(Number(s), Number(l), Number(h), true);
    }, 841336: (s, l, h) => {
      n.Lb(Number(s), Number(l), Number(h));
    }, 841393: () => typeof wasmOffsetConverter < "u", 841450: (s) => {
      n.kb("Abs", s, void 0);
    }, 841501: (s) => {
      n.kb("Neg", s, void 0);
    }, 841552: (s) => {
      ...
      n.kb("Sigmoid", s, void 0);
    }, 841924: (s, l, h) => {
      n.kb("HardSigmoid", s, { alpha: l, beta: h });
    }, 842003: (s) => {
      n.kb("Log", s, void 0);
    }, 842054: (s) => {
      n.kb("Sin", s, void 0);
      ...
      n.kb("LeakyRelu", s, { alpha: l });
    }, 843076: (s, l) => {
      n.kb("ThresholdedRelu", s, { alpha: l });
    }, 843146: (s, l) => {
      n.kb("Cast", s, { to: l });
    }, 843204: (s) => {
      n.kb("Add", s, void 0);
      ...
      n.kb("Greater", s, void 0);
    }, 843567: (s) => {
      n.kb("GreaterOrEqual", s, void 0);
    }, 843629: (s) => {
      n.kb("Less", s, void 0);
    }, 843681: (s) => {
      n.kb("LessOrEqual", s, void 0);
    }, 843740: (s, l, h, y, v) => {
      n.kb("ReduceMean", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 843915: (s, l, h, y, v) => {
      n.kb("ReduceMax", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844089: (s, l, h, y, v) => {
      n.kb("ReduceMin", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844263: (s, l, h, y, v) => {
      n.kb("ReduceProd", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844438: (s, l, h, y, v) => {
      n.kb("ReduceSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844612: (s, l, h, y, v) => {
      n.kb("ReduceL1", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844785: (s, l, h, y, v) => {
      n.kb("ReduceL2", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 844958: (s, l, h, y, v) => {
      n.kb("ReduceLogSum", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 845135: (s, l, h, y, v) => {
      n.kb("ReduceSumSquare", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 845315: (s, l, h, y, v) => {
      n.kb("ReduceLogSumExp", s, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 845495: (s) => {
      n.kb("Where", s, void 0);
    }, 845548: (s, l, h) => {
      n.kb("Transpose", s, { perm: l ? Array.from(C().subarray(Number(l) >>> 0, Number(h) >>> 0)) : [] });
    }, 845672: (s, l, h, y) => {
      n.kb("DepthToSpace", s, { blocksize: l, mode: Te(h), format: y ? "NHWC" : "NCHW" });
    }, 845805: (s, l, h, y) => {
      n.kb("DepthToSpace", s, { blocksize: l, mode: Te(h), format: y ? "NHWC" : "NCHW" });
    }, 845938: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee, Mt) => {
      n.kb("ConvTranspose", s, { format: G ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: y, kernelShape: [v], pads: [A, D], strides: [R], wIsConst: () => !!re()[K >>> 0], outputPadding: se ? Array.from(C().subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: we ? Array.from(C().subarray(Number(we) >>> 0, Number(Ee) >>> 0)) : [], activation: Te(Mt) });
    }, 846371: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("ConvTranspose", s, { format: R ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from(C().subarray(Number(h) >>> 0, 2 + (Number(h) >>> 0) >>> 0)), group: y, kernelShape: Array.from(C().subarray(Number(v) >>> 0, 2 + (Number(v) >>> 0) >>> 0)), pads: Array.from(C().subarray(Number(A) >>> 0, 4 + (Number(A) >>> 0) >>> 0)), strides: Array.from(C().subarray(Number(D) >>> 0, 2 + (Number(D) >>> 0) >>> 0)), wIsConst: () => !!re()[G >>> 0], outputPadding: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], outputShape: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [], activation: Te(Ee) });
    }, 847032: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee, Mt) => {
      n.kb("ConvTranspose", s, { format: G ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: y, kernelShape: [v], pads: [A, D], strides: [R], wIsConst: () => !!re()[K >>> 0], outputPadding: se ? Array.from(C().subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: we ? Array.from(C().subarray(Number(we) >>> 0, Number(Ee) >>> 0)) : [], activation: Te(Mt) });
    }, 847465: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("ConvTranspose", s, { format: R ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from(C().subarray(Number(h) >>> 0, 2 + (Number(h) >>> 0) >>> 0)), group: y, kernelShape: Array.from(C().subarray(Number(v) >>> 0, 2 + (Number(v) >>> 0) >>> 0)), pads: Array.from(C().subarray(Number(A) >>> 0, 4 + (Number(A) >>> 0) >>> 0)), strides: Array.from(C().subarray(Number(D) >>> 0, 2 + (Number(D) >>> 0) >>> 0)), wIsConst: () => !!re()[G >>> 0], outputPadding: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], outputShape: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [], activation: Te(Ee) });
    }, 848126: (s, l) => {
      n.kb("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
    }, 848217: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("AveragePool", s, { format: Ee ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: y, storage_order: v, dilations: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [], kernel_shape: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [], pads: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [] });
    }, 848696: (s, l) => {
      n.kb("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
    }, 848787: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("AveragePool", s, { format: Ee ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: y, storage_order: v, dilations: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [], kernel_shape: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [], pads: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [] });
    }, 849266: (s, l) => {
      n.kb("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
    }, 849353: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("MaxPool", s, { format: Ee ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: y, storage_order: v, dilations: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [], kernel_shape: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [], pads: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [] });
    }, 849828: (s, l) => {
      n.kb("GlobalMaxPool", s, { format: l ? "NHWC" : "NCHW" });
    }, 849915: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee) => {
      n.kb("MaxPool", s, { format: Ee ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: y, storage_order: v, dilations: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [], kernel_shape: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [], pads: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from(C().subarray(Number(pe) >>> 0, Number(we) >>> 0)) : [] });
    }, 850390: (s, l, h, y, v) => {
      n.kb("Gemm", s, { alpha: l, beta: h, transA: y, transB: v });
    }, 850494: (s) => {
      n.kb("MatMul", s, void 0);
    }, 850548: (s, l, h, y) => {
      n.kb("ArgMax", s, { keepDims: !!l, selectLastIndex: !!h, axis: y });
    }, 850656: (s, l, h, y) => {
      n.kb("ArgMin", s, { keepDims: !!l, selectLastIndex: !!h, axis: y });
    }, 850764: (s, l) => {
      n.kb("Softmax", s, { axis: l });
    }, 850827: (s, l) => {
      n.kb("Concat", s, { axis: l });
    }, 850887: (s, l, h, y, v) => {
      n.kb("Split", s, { axis: l, numOutputs: h, splitSizes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 851043: (s) => {
      n.kb("Expand", s, void 0);
    }, 851097: (s, l) => {
      n.kb("Gather", s, { axis: Number(l) });
    }, 851168: (s, l) => {
      n.kb("GatherElements", s, { axis: Number(l) });
    }, 851247: (s, l) => {
      n.kb("GatherND", s, { batch_dims: Number(l) });
    }, 851326: (s, l, h, y, v, A, D, R, G, K, se) => {
      n.kb("Resize", s, { antialias: l, axes: h ? Array.from(C().subarray(Number(h) >>> 0, Number(y) >>> 0)) : [], coordinateTransformMode: Te(v), cubicCoeffA: A, excludeOutside: D, extrapolationValue: R, keepAspectRatioPolicy: Te(G), mode: Te(K), nearestMode: Te(se) });
    }, 851688: (s, l, h, y, v, A, D) => {
      n.kb("Slice", s, { starts: l ? Array.from(C().subarray(Number(l) >>> 0, Number(h) >>> 0)) : [], ends: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [], axes: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [] });
    }, 851952: (s) => {
      n.kb("Tile", s, void 0);
    }, 852004: (s, l, h) => {
      n.kb("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
    }, 852118: (s, l, h) => {
      n.kb("InstanceNormalization", s, { epsilon: l, format: h ? "NHWC" : "NCHW" });
    }, 852232: (s) => {
      n.kb("Range", s, void 0);
    }, 852285: (s, l) => {
      n.kb("Einsum", s, { equation: Te(l) });
    }, 852366: (s, l, h, y, v) => {
      n.kb("Pad", s, { mode: l, value: h, pads: y ? Array.from(C().subarray(Number(y) >>> 0, Number(v) >>> 0)) : [] });
    }, 852509: (s, l, h, y, v, A) => {
      n.kb("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!v, trainingMode: !!y, format: A ? "NHWC" : "NCHW" });
    }, 852678: (s, l, h, y, v, A) => {
      n.kb("BatchNormalization", s, { epsilon: l, momentum: h, spatial: !!v, trainingMode: !!y, format: A ? "NHWC" : "NCHW" });
    }, 852847: (s, l, h) => {
      n.kb("CumSum", s, { exclusive: Number(l), reverse: Number(h) });
    }, 852944: (s, l, h) => {
      n.kb("DequantizeLinear", s, { axis: l, blockSize: h });
    }, 853034: (s, l, h, y, v) => {
      n.kb("GridSample", s, { align_corners: l, mode: Te(h), padding_mode: Te(y), format: v ? "NHWC" : "NCHW" });
    }, 853204: (s, l, h, y, v) => {
      n.kb("GridSample", s, { align_corners: l, mode: Te(h), padding_mode: Te(y), format: v ? "NHWC" : "NCHW" });
    }, 853374: (s, l) => {
      n.kb("ScatterND", s, { reduction: Te(l) });
    }, 853459: (s, l, h, y, v, A, D, R, G) => {
      n.kb("Attention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: y, scale: v, doRotary: A, qkvHiddenSizes: D ? Array.from(C().subarray(Number(R) >>> 0, Number(R) + D >>> 0)) : [], pastPresentShareBuffer: !!G });
    }, 853731: (s) => {
      n.kb("BiasAdd", s, void 0);
    }, 853786: (s) => {
      n.kb("BiasSplitGelu", s, void 0);
    }, 853847: (s) => {
      n.kb("FastGelu", s, void 0);
    }, 853903: (s, l, h, y, v, A, D, R, G, K, se, pe, we, Ee, Mt, Np) => {
      n.kb("Conv", s, { format: pe ? "NHWC" : "NCHW", auto_pad: l, dilations: h ? Array.from(C().subarray(Number(h) >>> 0, Number(y) >>> 0)) : [], group: v, kernel_shape: A ? Array.from(C().subarray(Number(A) >>> 0, Number(D) >>> 0)) : [], pads: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [], strides: K ? Array.from(C().subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], w_is_const: () => !!re()[Number(we) >>> 0], activation: Te(Ee), activation_params: Mt ? Array.from(le().subarray(Number(Mt) >>> 0, Number(Np) >>> 0)) : [] });
    }, 854487: (s) => {
      n.kb("Gelu", s, void 0);
    }, 854539: (s, l, h, y, v, A, D, R, G) => {
      n.kb("GroupQueryAttention", s, { numHeads: l, kvNumHeads: h, scale: y, softcap: v, doRotary: A, rotaryInterleaved: D, smoothSoftmax: R, localWindowSize: G });
    }, 854756: (s, l, h, y) => {
      n.kb("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!y });
    }, 854867: (s, l, h, y) => {
      n.kb("LayerNormalization", s, { axis: l, epsilon: h, simplified: !!y });
    }, 854978: (s, l, h, y, v, A) => {
      n.kb("MatMulNBits", s, { k: l, n: h, accuracyLevel: y, bits: v, blockSize: A });
    }, 855105: (s, l, h, y, v, A) => {
      n.kb("MultiHeadAttention", s, { numHeads: l, isUnidirectional: h, maskFilterValue: y, scale: v, doRotary: A });
    }, 855264: (s, l) => {
      n.kb("QuickGelu", s, { alpha: l });
    }, 855328: (s, l, h, y, v) => {
      n.kb("RotaryEmbedding", s, { interleaved: !!l, numHeads: h, rotaryEmbeddingDim: y, scale: v });
    }, 855467: (s, l, h) => {
      n.kb("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
    }, 855569: (s, l, h) => {
      n.kb("SkipLayerNormalization", s, { epsilon: l, simplified: !!h });
    }, 855671: (s, l, h, y) => {
      n.kb("GatherBlockQuantized", s, { gatherAxis: l, quantizeAxis: h, blockSize: y });
    }, 855792: (s) => {
      n.$b(s);
    }, 855826: (s, l) => n.bc(Number(s), Number(l), n.Gb.ec, n.Gb.errors) };
    function yc(s, l, h) {
      return mi(async () => {
        await n.Yb(Number(s), Number(l), Number(h));
      });
    }
    function _c() {
    ...
    var Do = (s) => {
      ...
      ft.length == 0 && (Wo(), Vo(ft[0]));
      var l = ft.pop();
      if (!l) return 6;
      Ht.push(l), xt[s.Bb] = l, l.Bb = s.Bb;
      var h = { Cb: "run", hc: s.fc, Ib: s.Ib, Bb: s.Bb };
      return l.postMessage(h, s.Nb), 0;
    }, mt = 0, $e = (s, l, ...h) => {
      for (var y = 2 * h.length, v = On(), A = Pn(8 * y), D = A >>> 3, R = 0; R < h.length; R++) {
        var G = h[R];
        typeof G == "bigint" ? (V[D + 2 * R] = 1n, V[D + 2 * R + 1] = G) : (V[D + 2 * R] = 0n, Ce()[D + 2 * R + 1 >>> 0] = G);
      }
      return s = Bi(s, 0, y, A, l), fr(v), s;
    };
    function hn(s) {
      if (u) return $e(0, 1, s);
      if (I = s, !(0 < mt)) {
        for (var l of Ht) Do(l);
        for (l of ft) Do(l);
        ft = [], Ht = [], xt = {}, ae = true;
      }
      g(0, new mn(s));
    ...
    var gn = (s) => {
      ...
      var l = s.Bb;
      delete xt[l], ft.push(s), Ht.splice(Ht.indexOf(s), 1), s.Bb = 0, Mi(l);
    };
    function No() {
      Ro.forEach((s) => s());
    }
    var Vo = (s) => new Promise((l) => {
      s.onmessage = (v) => {
        ...
        if (v.Hb && v.Hb != pr()) {
          var D = xt[v.Hb];
          D ? D.postMessage(v, v.Nb) : x(`Internal error! Worker sent a message "${A}" to target pthread ${v.Hb}, but that thread no longer exists!`);
        } else A === "checkMailbox" ? or() : A === "spawnThread" ? Bo(v) : A === "cleanupThread" ? Uo(xt[v.ic]) : A === "loaded" ? (s.loaded = true, l(s)) : A === "alert" ? alert(`Thread ${v.jc}: ${v.text}`) : v.target === "setimmediate" ? s.postMessage(v) : A === "callHandler" ? n[v.Rb](...v.args) : A && x(`worker sent an unknown command ${A}`);
      }, s.onerror = (v) => {
        throw x(`worker sent an error! ${v.filename}:${v.lineno}: ${v.message}`), v;
      };
      var h, y = [];
      for (h of []) n.propertyIsEnumerable(h) && y.push(h);
      s.postMessage({ Cb: "load", Sb: y, lc: T, mc: k });
    });
    function Wo() {
      var s = new Worker((() => {
        let l = URL;
    ...
    var wc = (s) => {
      ce();
      var l = L()[s + 52 >>> 2 >>> 0];
      s = L()[s + 56 >>> 2 >>> 0], Ni(l, l - s), fr(l);
    }, vc = (s, l) => {
      mt = 0, s = Vi(s, l), 0 < mt ? I = s : En(s);
    };
    class $c {
      constructor(l) {
        this.Jb = l - 24;
    ...
    function xc(s, l, h) {
      var y = new $c(s >>>= 0);
      throw l >>>= 0, h >>>= 0, L()[y.Jb + 16 >>> 2 >>> 0] = 0, L()[y.Jb + 4 >>> 2 >>> 0] = l, L()[y.Jb + 8 >>> 2 >>> 0] = h, s;
    }
    function Lo(s, l, h, y) {
      return u ? $e(2, 1, s, l, h, y) : Go(s, l, h, y);
    }
    function Go(s, l, h, y) {
      if (s >>>= 0, h >>>= 0, y >>>= 0, d === void 0) return 6;
      var v = [];
      return u && v.length === 0 ? Lo(s, l >>>= 0, h, y) : (s = { fc: h, Bb: s, Ib: y, Nb: v }, u ? (s.Cb = "spawnThread", postMessage(s, v), 0) : Bo(s));
    }
    var Ho = typeof TextDecoder < "u" ? new TextDecoder() : void 0, Fo = (s, l = 0, h = NaN) => {
      ...
      for (y = ""; l < h; ) {
        ...
        if (128 & v) {
          var A = 63 & s[l++];
          if ((224 & v) == 192) y += String.fromCharCode((31 & v) << 6 | A);
          else {
            var D = 63 & s[l++];
            65536 > (v = (240 & v) == 224 ? (15 & v) << 12 | A << 6 | D : (7 & v) << 18 | A << 12 | D << 6 | 63 & s[l++]) ? y += String.fromCharCode(v) : (v -= 65536, y += String.fromCharCode(55296 | v >> 10, 56320 | 1023 & v));
          }
        } else y += String.fromCharCode(v);
      }
      return y;
    }, Te = (s, l) => (s >>>= 0) ? Fo(ve(), s, l) : "";
    function qo(s, l, h) {
      return u ? $e(3, 1, s, l, h) : 0;
    }
    function Ko(s, l) {
      if (u) return $e(4, 1, s, l);
    }
    var jo = (s) => {
      ...
      if (l >>>= 0, 0 < h) {
        ...
        for (var A = 0; A < s.length; ++A) {
          ...
          if (55296 <= D && 57343 >= D && (D = 65536 + ((1023 & D) << 10) | 1023 & s.charCodeAt(++A)), 127 >= D) {
            if (l >= h) break;
            y[l++ >>> 0] = D;
          } else {
            if (2047 >= D) {
              ...
              if (65535 >= D) {
                ...
                if (l + 3 >= h) break;
                y[l++ >>> 0] = 240 | D >> 18, y[l++ >>> 0] = 128 | D >> 12 & 63;
              }
              y[l++ >>> 0] = 128 | D >> 6 & 63;
            }
            y[l++ >>> 0] = 128 | 63 & D;
    ...
    function Zo(s, l) {
      if (u) return $e(5, 1, s, l);
    }
    function Qo(s, l, h) {
      if (u) return $e(6, 1, s, l, h);
    }
    function Yo(s, l, h) {
      return u ? $e(7, 1, s, l, h) : 0;
    }
    function Xo(s, l) {
      if (u) return $e(8, 1, s, l);
    }
    function Jo(s, l, h) {
      if (u) return $e(9, 1, s, l, h);
    }
    function ei(s, l, h, y) {
      if (u) return $e(10, 1, s, l, h, y);
    }
    function ti(s, l, h, y) {
      if (u) return $e(11, 1, s, l, h, y);
    }
    function ri(s, l, h, y) {
      if (u) return $e(12, 1, s, l, h, y);
    }
    function ni(s) {
      if (u) return $e(13, 1, s);
    }
    function oi(s, l) {
      if (u) return $e(14, 1, s, l);
    }
    function ii(s, l, h) {
      if (u) return $e(15, 1, s, l, h);
    }
    var ai, ht, Sc = () => pt(""), Ze = (s) => {
      for (var l = ""; ve()[s >>> 0]; ) l += ai[ve()[s++ >>> 0]];
      return l;
    }, bn = {}, yn = {}, Tc = {};
    function at(s, l, h = {}) {
      return (function(y, v, A = {}) {
        var D = v.name;
        if (!y) throw new ht(`type "${D}" must have a positive integer typeid pointer`);
        if (yn.hasOwnProperty(y)) {
          if (A.Tb) return;
          throw new ht(`Cannot register type '${D}' twice`);
        }
        yn[y] = v, delete Tc[y], bn.hasOwnProperty(y) && (v = bn[y], delete bn[y], v.forEach((R) => R()));
      })(s, l, h);
    }
    var si = (s, l, h) => {
      switch (l) {
        case 1:
          return h ? (y) => re()[y >>> 0] : (y) => ve()[y >>> 0];
        case 2:
          return h ? (y) => _e()[y >>> 1 >>> 0] : (y) => ee()[y >>> 1 >>> 0];
        case 4:
          return h ? (y) => C()[y >>> 2 >>> 0] : (y) => L()[y >>> 2 >>> 0];
        case 8:
          return h ? (y) => V[y >>> 3] : (y) => de[y >>> 3];
        default:
          throw new TypeError(`invalid integer width (${l}): ${s}`);
      }
    };
    function Ic(s, l, h) {
      h >>>= 0, at(s >>>= 0, { name: l = Ze(l >>> 0), fromWireType: (y) => y, toWireType: function(y, v) {
      ...
      }, Db: gt, readValueFromPointer: si(l, h, l.indexOf("u") == -1), Eb: null });
    }
    var gt = 8;
    function Cc(s, l, h, y) {
      at(s >>>= 0, { name: l = Ze(l >>> 0), fromWireType: function(v) {
        return !!v;
      }, toWireType: function(v, A) {
        return A ? h : y;
      }, Db: gt, readValueFromPointer: function(v) {
        return this.fromWireType(ve()[v >>> 0]);
      }, Eb: null });
    }
    var _n = [], st = [];
    function wn(s) {
      9 < (s >>>= 0) && --st[s + 1] == 0 && (st[s] = void 0, _n.push(s));
    }
    var Oe = (s) => {
      if (!s) throw new ht("Cannot use deleted val. handle = " + s);
      return st[s];
    }, Ve = (s) => {
      switch (s) {
        case void 0:
        ...
        case false:
          return 8;
        default:
          let l = _n.pop() || st.length;
          return st[l] = s, st[l + 1] = 1, l;
      }
    };
    function vn(s) {
      return this.fromWireType(L()[s >>> 2 >>> 0]);
    }
    var Ac = { name: "emscripten::val", fromWireType: (s) => {
      var l = Oe(s);
      return wn(s), l;
    }, toWireType: (s, l) => Ve(l), Db: gt, readValueFromPointer: vn, Eb: null };
    function kc(s) {
      return at(s >>> 0, Ac);
    }
    var Ec = (s, l) => {
      switch (l) {
        case 4:
          return function(h) {
            return this.fromWireType(le()[h >>> 2 >>> 0]);
          };
        case 8:
          return function(h) {
            return this.fromWireType(Ce()[h >>> 3 >>> 0]);
          };
        default:
    ...
    function Pc(s, l, h) {
      h >>>= 0, at(s >>>= 0, { name: l = Ze(l >>> 0), fromWireType: (y) => y, toWireType: (y, v) => v, Db: gt, readValueFromPointer: Ec(l, h), Eb: null });
    }
    function Oc(s, l, h, y, v) {
      if (s >>>= 0, h >>>= 0, l = Ze(l >>> 0), v === -1 && (v = 4294967295), v = (R) => R, y === 0) {
        var A = 32 - 8 * h;
        v = (R) => R << A >>> A;
      }
      var D = l.includes("unsigned") ? function(R, G) {
        return G >>> 0;
      } : function(R, G) {
        return G;
      };
      at(s, { name: l, fromWireType: v, toWireType: D, Db: gt, readValueFromPointer: si(l, h, y !== 0), Eb: null });
    }
    function zc(s, l, h) {
      function y(A) {
        var D = L()[A >>> 2 >>> 0];
        return A = L()[A + 4 >>> 2 >>> 0], new v(re().buffer, A, D);
      }
      var v = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, BigInt64Array, BigUint64Array][l];
      at(s >>>= 0, { name: h = Ze(h >>> 0), fromWireType: y, Db: gt, readValueFromPointer: y }, { Tb: true });
    }
    function Dc(s, l) {
      at(s >>>= 0, { name: l = Ze(l >>> 0), fromWireType: function(h) {
        for (var y, v = L()[h >>> 2 >>> 0], A = h + 4, D = A, R = 0; R <= v; ++R) {
          var G = A + R;
          R != v && ve()[G >>> 0] != 0 || (D = Te(D, G - D), y === void 0 ? y = D : (y += "\0", y += D), D = G + 1);
        }
        return Ye(h), y;
      }, toWireType: function(h, y) {
        y instanceof ArrayBuffer && (y = new Uint8Array(y));
        var v = typeof y == "string";
        if (!(v || y instanceof Uint8Array || y instanceof Uint8ClampedArray || y instanceof Int8Array)) throw new ht("Cannot pass non-string to std::string");
        var A = v ? jo(y) : y.length, D = mr(4 + A + 1), R = D + 4;
        if (L()[D >>> 2 >>> 0] = A, v) Dt(y, R, A + 1);
        else if (v) for (v = 0; v < A; ++v) {
          var G = y.charCodeAt(v);
          if (255 < G) throw Ye(D), new ht("String has UTF-16 code units that do not fit in 8 bits");
          ve()[R + v >>> 0] = G;
        }
        else for (v = 0; v < A; ++v) ve()[R + v >>> 0] = y[v];
        return h !== null && h.push(Ye, D), D;
      }, Db: gt, readValueFromPointer: vn, Eb(h) {
        Ye(h);
      } });
    }
    var ui = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Bc = (s, l) => {
      for (var h = s >> 1, y = h + l / 2; !(h >= y) && ee()[h >>> 0]; ) ++h;
      if (32 < (h <<= 1) - s && ui) return ui.decode(ve().slice(s, h));
      for (h = "", y = 0; !(y >= l / 2); ++y) {
        var v = _e()[s + 2 * y >>> 1 >>> 0];
        if (v == 0) break;
      ...
      for (var v = 0; v < h; ++v) {
        var A = s.charCodeAt(v);
        _e()[l >>> 1 >>> 0] = A, l += 2;
      }
      return _e()[l >>> 1 >>> 0] = 0, l - y;
    }, Rc = (s) => 2 * s.length, Uc = (s, l) => {
      for (var h = 0, y = ""; !(h >= l / 4); ) {
        var v = C()[s + 4 * h >>> 2 >>> 0];
        if (v == 0) break;
        ++h, 65536 <= v ? (v -= 65536, y += String.fromCharCode(55296 | v >> 10, 56320 | 1023 & v)) : y += String.fromCharCode(v);
      }
      return y;
    }, Nc = (s, l, h) => {
      ...
      for (var v = 0; v < s.length; ++v) {
        var A = s.charCodeAt(v);
        if (55296 <= A && 57343 >= A && (A = 65536 + ((1023 & A) << 10) | 1023 & s.charCodeAt(++v)), C()[l >>> 2 >>> 0] = A, (l += 4) + 4 > h) break;
      }
    ...
    function Wc(s, l, h) {
      if (s >>>= 0, l >>>= 0, h = Ze(h >>>= 0), l === 2) var y = Bc, v = Mc, A = Rc, D = (R) => ee()[R >>> 1 >>> 0];
      else l === 4 && (y = Uc, v = Nc, A = Vc, D = (R) => L()[R >>> 2 >>> 0]);
      at(s, { name: h, fromWireType: (R) => {
        for (var G, K = L()[R >>> 2 >>> 0], se = R + 4, pe = 0; pe <= K; ++pe) {
          var we = R + 4 + pe * l;
          pe != K && D(we) != 0 || (se = y(se, we - se), G === void 0 ? G = se : (G += "\0", G += se), se = we + l);
        }
        return Ye(R), G;
      }, toWireType: (R, G) => {
        if (typeof G != "string") throw new ht(`Cannot pass non-string to C++ string type ${h}`);
        var K = A(G), se = mr(4 + K + l);
        return L()[se >>> 2 >>> 0] = K / l, v(G, se + 4, K + l), R !== null && R.push(Ye, se), se;
      }, Db: gt, readValueFromPointer: vn, Eb(R) {
        Ye(R);
      } });
    }
    function Lc(s, l) {
      at(s >>>= 0, { Ub: true, name: l = Ze(l >>> 0), Db: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }
    function Gc(s) {
      kn(s >>> 0, !a, 1, !i, 131072, false), No();
    }
    var $n = (s) => {
      if (!ae) try {
        if (s(), !(0 < mt)) try {
          ...
          l instanceof mn || l == "unwind" || g(0, l);
        }
      } catch (l) {
        l instanceof mn || l == "unwind" || g(0, l);
      }
    ...
    function xn(s) {
      s >>>= 0, typeof Atomics.kc == "function" && (Atomics.kc(C(), s >>> 2, s).value.then(or), s += 128, Atomics.store(C(), s >>> 2, 1));
    }
    var or = () => {
      var s = pr();
      s && (xn(s), $n(Ui));
    ...
    function Hc(s, l) {
      (s >>>= 0) == l >>> 0 ? setTimeout(or) : u ? postMessage({ Hb: s, Cb: "checkMailbox" }) : (s = xt[s]) && s.postMessage({ Cb: "checkMailbox" });
    }
    var Sn = [];
    function Fc(s, l, h, y, v) {
      for (l >>>= 0, y /= 2, Sn.length = y, h = v >>> 0 >>> 3, v = 0; v < y; v++) Sn[v] = V[h + 2 * v] ? V[h + 2 * v + 1] : Ce()[h + 2 * v + 1 >>> 0];
      return (l ? pn[l] : Up[s])(...Sn);
    }
    var qc = () => {
      mt = 0;
    };
    function Kc(s) {
      s >>>= 0, u ? postMessage({ Cb: "cleanupThread", ic: s }) : Uo(xt[s]);
    }
    function jc(s) {
    }
    var ir = (s, l) => {
      var h = yn[s];
      if (h === void 0) throw s = Oi(s), h = Ze(s), Ye(s), new ht(`${l} has unknown type ${h}`);
      return h;
    }, di = (s, l, h) => {
      var y = [];
      return s = s.toWireType(y, h), y.length && (L()[l >>> 2 >>> 0] = Ve(y)), s;
    };
    function Zc(s, l, h) {
      return l >>>= 0, h >>>= 0, s = Oe(s >>> 0), l = ir(l, "emval::as"), di(l, h, s);
    }
    function Qc(s, l) {
      return l >>>= 0, s = Oe(s >>> 0), (l = ir(l, "emval::as")).toWireType(null, s);
    }
    var ar = (s) => {
      try {
        s();
    ...
    }, bt = 0, Qe = null, li = 0, sr = [], ci = {}, pi = {}, Yc = 0, Tn = null, Xc = [];
    function mi(s) {
      return (function(l) {
        if (!ae) {
          if (bt === 0) {
            ...
            l((v = 0) => {
              if (!ae && (li = v, h = true, y)) {
                bt = 2, ar(() => Gi(Qe)), typeof MainLoop < "u" && MainLoop.Qb && MainLoop.resume(), v = false;
                try {
                  var A = (function() {
                    var G = C()[Qe + 8 >>> 2 >>> 0];
                    return G = Q[pi[G]], --mt, G();
                  })();
                } catch (G) {
                  A = G, v = true;
                }
                ...
                if (!Qe) {
                  var R = Tn;
                  R && (Tn = null, (v ? R.reject : R.resolve)(A), D = true);
                }
                if (v && !D) throw A;
              }
            }), y = true, h || (bt = 1, Qe = (function() {
              var v = mr(65548), A = v + 12;
              L()[v >>> 2 >>> 0] = A, L()[v + 4 >>> 2 >>> 0] = A + 65536, A = sr[0];
              var D = ci[A];
              return D === void 0 && (D = Yc++, ci[A] = D, pi[D] = A), A = D, C()[v + 8 >>> 2 >>> 0] = A, v;
            })(), typeof MainLoop < "u" && MainLoop.Qb && MainLoop.pause(), ar(() => Wi(Qe)));
          } else bt === 2 ? (bt = 0, ar(Hi), Ye(Qe), Qe = null, Xc.forEach($n)) : pt(`invalid state: ${bt}`);
          return li;
        }
      })((l) => {
        s().then(l);
    ...
    var ur = [];
    function ep(s, l, h, y) {
      return h >>>= 0, y >>>= 0, (s = ur[s >>> 0])(null, l = Oe(l >>> 0), h, y);
    }
    var tp = {}, dr = (s) => {
      var l = tp[s];
      return l === void 0 ? Ze(s) : l;
    };
    function rp(s, l, h, y, v) {
      return h >>>= 0, y >>>= 0, v >>>= 0, (s = ur[s >>> 0])(l = Oe(l >>> 0), l[h = dr(h)], y, v);
    }
    function np(s, l) {
      return l >>>= 0, (s = Oe(s >>> 0)) == Oe(l);
    }
    var fi = () => typeof globalThis == "object" ? globalThis : Function("return this")();
    function op(s) {
      return (s >>>= 0) == 0 ? Ve(fi()) : (s = dr(s), Ve(fi()[s]));
    }
    var ip = (s) => {
      var l = ur.length;
      return ur.push(s), l;
    }, ap = (s, l) => {
      for (var h = Array(s), y = 0; y < s; ++y) h[y] = ir(L()[l + 4 * y >>> 2 >>> 0], "parameter " + y);
      return h;
    }, hi = (s, l) => Object.defineProperty(l, "name", { value: s });
    function sp(s, l, h) {
      var y = (l = ap(s, l >>> 0)).shift();
      s--;
      var v = `return function (obj, func, destructorsRef, args) {
`, A = 0, D = [];
      h === 0 && D.push("obj");
      for (var R = ["retType"], G = [y], K = 0; K < s; ++K) D.push("arg" + K), R.push("argType" + K), G.push(l[K]), v += `  var arg${K} = argType${K}.readValueFromPointer(args${A ? "+" + A : ""});
`, A += l[K].Db;
      return v += `  var rv = ${h === 1 ? "new func" : "func.call"}(${D.join(", ")});
`, y.Ub || (R.push("emval_returnValue"), G.push(di), v += `  return emval_returnValue(retType, destructorsRef, rv);
`), R.push(v + `};
`), s = (function(se) {
        var pe = Function;
        if (!(pe instanceof Function)) throw new TypeError(`new_ called with constructor type ${typeof pe} which is not a function`);
        var we = hi(pe.name || "unknownFunctionName", function() {
        });
        return we.prototype = pe.prototype, we = new we(), (se = pe.apply(we, se)) instanceof Object ? se : we;
      })(R)(...G), h = `methodCaller<(${l.map((se) => se.name).join(", ")}) => ${y.name}>`, ip(hi(h, s));
    }
    function up(s) {
      return s = dr(s >>> 0), Ve(n[s]);
    }
    function dp(s, l) {
      return l >>>= 0, s = Oe(s >>> 0), l = Oe(l), Ve(s[l]);
    }
    function lp(s) {
      9 < (s >>>= 0) && (st[s + 1] += 1);
    }
    ...
    function gp(s, l, h) {
      l >>>= 0, h >>>= 0, s = Oe(s >>> 0), l = Oe(l), h = Oe(h), s[l] = h;
    }
    function bp(s, l) {
      return l >>>= 0, s = (s = ir(s >>> 0, "_emval_take_value")).readValueFromPointer(l), Ve(s);
    }
    function yp(s, l) {
    ...
    function wp(s) {
      s >>>= 0;
      var l = new Date(C()[s + 20 >>> 2 >>> 0] + 1900, C()[s + 16 >>> 2 >>> 0], C()[s + 12 >>> 2 >>> 0], C()[s + 8 >>> 2 >>> 0], C()[s + 4 >>> 2 >>> 0], C()[s >>> 2 >>> 0], 0), h = C()[s + 32 >>> 2 >>> 0], y = l.getTimezoneOffset(), v = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(), A = new Date(l.getFullYear(), 0, 1).getTimezoneOffset(), D = Math.min(A, v);
      return 0 > h ? C()[s + 32 >>> 2 >>> 0] = +(v != A && D == y) : 0 < h != (D == y) && (v = Math.max(A, v), l.setTime(l.getTime() + 6e4 * ((0 < h ? D : v) - y))), C()[s + 24 >>> 2 >>> 0] = l.getDay(), h = (gi(l.getFullYear()) ? bi : yi)[l.getMonth()] + l.getDate() - 1 | 0, C()[s + 28 >>> 2 >>> 0] = h, C()[s >>> 2 >>> 0] = l.getSeconds(), C()[s + 4 >>> 2 >>> 0] = l.getMinutes(), C()[s + 8 >>> 2 >>> 0] = l.getHours(), C()[s + 12 >>> 2 >>> 0] = l.getDate(), C()[s + 16 >>> 2 >>> 0] = l.getMonth(), C()[s + 20 >>> 2 >>> 0] = l.getYear(), s = l.getTime(), BigInt(isNaN(s) ? -1 : s / 1e3);
    }
    function _i(s, l, h, y, v, A, D) {
      return u ? $e(16, 1, s, l, h, y, v, A, D) : -52;
    }
    function wi(s, l, h, y, v, A) {
      if (u) return $e(17, 1, s, l, h, y, v, A);
    }
    var Ft = {}, vp = () => performance.timeOrigin + performance.now();
    function vi(s, l) {
      if (u) return $e(18, 1, s, l);
      if (Ft[s] && (clearTimeout(Ft[s].id), delete Ft[s]), !l) return 0;
      var h = setTimeout(() => {
        delete Ft[s], $n(() => Ri(s, performance.timeOrigin + performance.now()));
      }, l);
      return Ft[s] = { id: h, rc: l }, 0;
    }
    function $p(s, l, h, y) {
      s >>>= 0, l >>>= 0, h >>>= 0, y >>>= 0;
      var v = (/* @__PURE__ */ new Date()).getFullYear(), A = new Date(v, 0, 1).getTimezoneOffset();
      v = new Date(v, 6, 1).getTimezoneOffset();
      var D = Math.max(A, v);
      L()[s >>> 2 >>> 0] = 60 * D, C()[l >>> 2 >>> 0] = +(A != v), s = (l = (R) => {
        var G = Math.abs(R);
        return `UTC${0 <= R ? "-" : "+"}${String(Math.floor(G / 60)).padStart(2, "0")}${String(G % 60).padStart(2, "0")}`;
      })(A), l = l(v), v < A ? (Dt(s, h, 17), Dt(l, y, 17)) : (Dt(s, y, 17), Dt(l, h, 17));
    }
    var xp = () => Date.now(), Sp = 1;
    function Tp(s, l, h) {
      ...
      return V[h >>> 0 >>> 3] = BigInt(Math.round(1e6 * s)), 0;
    }
    var In = [], $i = (s, l) => {
      In.length = 0;
      for (var h; h = ve()[s++ >>> 0]; ) {
        var y = h != 105;
        l += (y &= h != 112) && l % 8 ? 4 : 0, In.push(h == 112 ? L()[l >>> 2 >>> 0] : h == 106 ? V[l >>> 3] : h == 105 ? C()[l >>> 2 >>> 0] : Ce()[l >>> 3 >>> 0]), l += y ? 8 : 4;
      }
      return In;
    };
    function Ip(s, l, h) {
      return s >>>= 0, l = $i(l >>> 0, h >>> 0), pn[s](...l);
    }
    function Cp(s, l, h) {
      return s >>>= 0, l = $i(l >>> 0, h >>> 0), pn[s](...l);
    }
    ...
    var Op = () => navigator.hardwareConcurrency;
    function zp() {
      return pt("Cannot use emscripten_pc_get_function without -sUSE_OFFSET_CONVERTER"), 0;
    }
    function Dp(s) {
      s >>>= 0;
      var l = ve().length;
    ...
    var lr = () => (pt("Cannot use convertFrameToPC (needed by __builtin_return_address) without -sUSE_OFFSET_CONVERTER"), 0), Bt = {}, xi = (s) => {
      s.forEach((l) => {
        var h = lr();
        h && (Bt[h] = l);
      });
...
`);
      return s[0] == "Error" && s.shift(), xi(s), Bt.Mb = lr(), Bt.dc = s, Bt.Mb;
    }
    function Mp(s, l, h) {
      if (s >>>= 0, l >>>= 0, Bt.Mb == s) var y = Bt.dc;
      else (y = Error().stack.toString().split(`
`))[0] == "Error" && y.shift(), xi(y);
      for (var v = 3; y[v] && lr() != s; ) ++v;
      for (s = 0; s < h && y[s + v]; ++s) C()[l + 4 * s >>> 2 >>> 0] = lr();
      return s;
    }
    var Cn, An = {}, Si = () => {
      if (!Cn) {
        ...
        for (s in An) An[s] === void 0 ? delete l[s] : l[s] = An[s];
        var h = [];
    ...
    function Ti(s, l) {
      if (u) return $e(19, 1, s, l);
      s >>>= 0, l >>>= 0;
      var h = 0;
      return Si().forEach((y, v) => {
        var A = l + h;
        for (v = L()[s + 4 * v >>> 2 >>> 0] = A, A = 0; A < y.length; ++A) re()[v++ >>> 0] = y.charCodeAt(A);
        re()[v >>> 0] = 0, h += y.length + 1;
      }), 0;
    }
    function Ii(s, l) {
      if (u) return $e(20, 1, s, l);
      s >>>= 0, l >>>= 0;
      var h = Si();
      L()[s >>> 2 >>> 0] = h.length;
      var y = 0;
      return h.forEach((v) => y += v.length + 1), L()[l >>> 2 >>> 0] = y, 0;
    }
    function Ci(s) {
      return u ? $e(21, 1, s) : 52;
    }
    function Ai(s, l, h, y) {
      return u ? $e(22, 1, s, l, h, y) : 52;
    }
    function ki(s, l, h, y) {
      return u ? $e(23, 1, s, l, h, y) : 70;
    }
    var Rp = [null, [], []];
    function Ei(s, l, h, y) {
      if (u) return $e(24, 1, s, l, h, y);
      l >>>= 0, h >>>= 0, y >>>= 0;
      for (var v = 0, A = 0; A < h; A++) {
        var D = L()[l >>> 2 >>> 0], R = L()[l + 4 >>> 2 >>> 0];
        l += 8;
        for (var G = 0; G < R; G++) {
          var K = ve()[D + G >>> 0], se = Rp[s];
          K === 0 || K === 10 ? ((s === 1 ? w : x)(Fo(se)), se.length = 0) : se.push(K);
        }
        v += R;
      }
      return L()[y >>> 2 >>> 0] = v, 0;
    ...
    u || (function() {
      ...
      fn.unshift(() => {
        ct++, (function(l) {
          u ? l() : Promise.all(ft.map(Vo)).then(l);
        })(() => Oo());
      });
    })();
    for (var Pi = Array(256), cr = 0; 256 > cr; ++cr) Pi[cr] = String.fromCharCode(cr);
    ai = Pi, ht = n.BindingError = class extends Error {
      constructor(s) {
    ...
    }, st.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), n.count_emval_handles = () => st.length / 2 - 5 - _n.length;
    var Q, Up = [hn, Mo, Lo, qo, Ko, Zo, Qo, Yo, Xo, Jo, ei, ti, ri, ni, oi, ii, _i, wi, vi, Ti, Ii, Ci, Ai, ki, Ei];
    (async function() {
      function s(y, v) {
        return Q = y.exports, Q = (function() {
          var A = Q, D = {};
          for (let [R, G] of Object.entries(A)) D[R] = typeof G == "function" ? (...K) => {
            sr.push(R);
            try {
              return G(...K);
            } finally {
              ae || (sr.pop(), Qe && bt === 1 && sr.length === 0 && (bt = 0, mt += 1, ar(Li), typeof Fibers < "u" && Fibers.sc()));
            }
          } : G;
          return D;
        })(), Q = (function() {
          var A = Q, D = (G) => (K) => G(K) >>> 0, R = (G) => () => G() >>> 0;
          return (A = Object.assign({}, A)).Ea = D(A.Ea), A.gb = R(A.gb), A.ib = D(A.ib), A.ub = D(A.ub), A.vb = R(A.vb), A.__cxa_get_exception_ptr = D(A.__cxa_get_exception_ptr), A;
        })(), Ro.push(Q.jb), k = v, Oo(), Q;
      }
      ct++;
      var l = zo();
      if (n.instantiateWasm) return new Promise((y) => {
        n.instantiateWasm(l, (v, A) => {
          s(v, A), y(v.exports);
        });
      });
      if (u) return new Promise((y) => {
        ze = (v) => {
          var A = new WebAssembly.Instance(v, zo());
          y(s(A, v));
        };
      });
      lt ?? (lt = n.locateFile ? n.locateFile ? n.locateFile("ort-wasm-simd-threaded.jsep.wasm", _) : _ + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href);
      try {
        var h = await (async function(y) {
          var v = lt;
          if (!H && typeof WebAssembly.instantiateStreaming == "function" && !Z(v)) try {
            var A = fetch(v, { credentials: "same-origin" });
          ...
          return (async function(D, R) {
            try {
              ...
              x(`failed to asynchronously prepare wasm: ${K}`), pt(K);
            }
          })(v, y);
        })(l);
    ...
    return n.stackSave = () => On(), n.stackRestore = (s) => fr(s), n.stackAlloc = (s) => Pn(s), n.setValue = function(s, l, h = "i8") {
      switch (h.endsWith("*") && (h = "*"), h) {
        ...
        case "*":
          ...
          break;
        default:
          pt(`invalid type for setValue: ${h}`);
      }
      ...
      switch (l.endsWith("*") && (l = "*"), l) {
        ...
        case "*":
          return L()[s >>> 2 >>> 0];
        default:
          pt(`invalid type for getValue: ${l}`);
      }
    }, n.UTF8ToString = Te, n.stringToUTF8 = Dt, n.lengthBytesUTF8 = jo, (function s() {
      if (0 < ct) zt = s;
      else if (u) t(n), Ge();
      else {
        for (; 0 < fn.length; ) fn.shift()(n);
        0 < ct ? zt = s : (n.calledRun = true, ae || (Ge(), t(n)));
      }
    })(), n.PTR_SIZE = 4, o;
  }), Kp = Sa, jp = (_b = (_a2 = globalThis.self) == null ? void 0 : _a2.name) == null ? void 0 : _b.startsWith("em-pthread");
  jp && Sa();
});
var ka;
var Hn;
...
var wr = U(() => {
  "use strict";
  _r();
  ka = typeof location > "u" ? void 0 : location.origin, Hn = import.meta.url > "file:" && import.meta.url < "file;", Zp = () => {
    if (true) {
      if (Hn) {
        let e = URL;
        return new URL(new e("ort.bundle.min.mjs", import.meta.url).href, ka).href;
      }
    ...
    try {
      let r = t ?? Ue;
      return (r ? new URL(e, r) : new URL(e)).origin === ka;
    } catch {
      return false;
    }
  }, Qp = (e, t) => {
  ...
  }, Yp = (e, t) => `${t ?? "./"}${e}`, Pa = async (e) => {
    let r = await (await fetch(e, { credentials: "same-origin" })).blob();
    return URL.createObjectURL(r);
  }, Xp = async (e) => (await import(
    /*webpackIgnore:true*/
    e
  )).default, Ca = (xa(), qt($a)).default, Oa = async () => {
    if (!Ue) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
    if (Gn(Ue)) return [void 0, Ca()];
    let e = await Pa(Ue);
    return [e, Ca(e)];
  }, Aa = (Ia(), qt(Ta)).default, za = async (e, t, r) => {
    if (!e && !t && Aa && Ue && Gn(Ue)) return [void 0, Aa];
    {
      let n = "ort-wasm-simd-threaded.jsep.mjs", o = e ?? Qp(n, t), i = r && o && !Gn(o, t), a = i ? await Pa(o) : o ?? Yp(n, t);
      return [i ? a : void 0, await Xp(a)];
    }
  };
});
var Fn;
...
var yt = U(() => {
  ...
  qn = false, kr = false, Da = false, Jp = () => {
    ...
    if (kr) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
    if (Da) throw new Error("previous call to 'initializeWebAssembly()' failed.");
    kr = true;
    let t = e.initTimeout, r = e.numThreads;
    if (e.simd !== false) {
      if (e.simd === "relaxed") {
        if (!tm()) throw new Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
    ...
    let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, a = o == null ? void 0 : o.mjs, u = (a == null ? void 0 : a.href) ?? a, d = o == null ? void 0 : o.wasm, c = (d == null ? void 0 : d.href) ?? d, p = e.wasmBinary, [m, f] = await za(u, i, r > 1), b = false, g = [];
    if (t > 0 && g.push(new Promise((_) => {
      ...
      let $ = { numThreads: r };
      if (p) $.wasmBinary = p;
      else if (c || i) $.locateFile = (w) => c ?? i + w;
      else if (u && u.indexOf("blob:") !== 0) $.locateFile = (w) => new URL(w, u).href;
      else if (m) {
        let w = Ea();
        w && ($.locateFile = (x) => w + x);
      }
      f($).then((w) => {
        kr = false, qn = true, Fn = w, _(), m && URL.revokeObjectURL(m);
      }, (w) => {
        kr = false, Da = true, S(w);
      });
...
var Er = U(() => {
  ...
  yt();
  Ne = (e, t) => {
    let r = ge(), n = r.lengthBytesUTF8(e) + 1, o = r._malloc(n);
...
var Ma = U(() => {
  ...
  Ba = (e) => {
    let t = ge(), r = 0, n = [], o = e || {};
    try {
      if ((e == null ? void 0 : e.logSeverityLevel) === void 0) o.logSeverityLevel = 2;
      ...
      if ((e == null ? void 0 : e.logVerbosityLevel) === void 0) o.logVerbosityLevel = 0;
      ...
      (e == null ? void 0 : e.terminate) === void 0 && (o.terminate = false);
      let i = 0;
      return (e == null ? void 0 : e.tag) !== void 0 && (i = Ne(e.tag, n)), r = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && fe("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && Zt(e.extra, "", /* @__PURE__ */ new WeakSet(), (a, u) => {
        let d = Ne(a, n), c = Ne(u, n);
        t._OrtAddRunConfigEntry(r, d, c) !== 0 && fe(`Can't set a run config entry: ${a} - ${u}.`);
      }), [r, n];
    } catch (i) {
...
var Ua = U(() => {
  ...
  rm = (e) => {
    ...
    ge()._OrtAddSessionConfigEntry(e, o, i) !== 0 && fe(`Can't set a session config entry: ${t} - ${r}.`);
  }, im = async (e, t, r) => {
    for (let n of t) {
      ...
      switch (o) {
        case "webnn":
          if (o = "WEBNN", typeof n != "string") {
            let m = n == null ? void 0 : n.deviceType;
            m && Pr(e, "deviceType", m, r);
          }
          break;
        case "webgpu":
          if (o = "JS", typeof n != "string") {
            let p = n;
            if (p == null ? void 0 : p.preferredLayout) {
              ...
              Pr(e, "preferredLayout", p.preferredLayout, r);
            }
          }
          break;
        case "wasm":
      ...
      if (u > 0) {
        d = ge()._malloc(u * ge().PTR_SIZE), r.push(d), c = ge()._malloc(u * ge().PTR_SIZE), r.push(c);
        for (let p = 0; p < u; p++) ge().setValue(d + p * ge().PTR_SIZE, i[p][0], "*"), ge().setValue(c + p * ge().PTR_SIZE, i[p][1], "*");
      }
      await ge()._OrtAppendExecutionProvider(e, a, d, c, u) !== 0 && fe(`Can't append execution provider: ${o}.`);
    }
  }, Ra = async (e) => {
    let t = ge(), r = 0, n = [], o = e || {};
    om(o);
    try {
      let i = rm(o.graphOptimizationLevel ?? "all"), a = nm(o.executionMode ?? "sequential"), u = typeof o.logId == "string" ? Ne(o.logId, n) : 0, d = o.logSeverityLevel ?? 2;
      ...
      if (r = t._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, a, !!o.enableProfiling, 0, u, d, c, p), r === 0 && fe("Can't create session options."), o.executionProviders && await im(r, o.executionProviders, n), o.enableGraphCapture !== void 0) {
        if (typeof o.enableGraphCapture != "boolean") throw new Error(`enableGraphCapture must be a boolean value: ${o.enableGraphCapture}`);
        Pr(r, "enableGraphCapture", o.enableGraphCapture.toString(), n);
      }
      if (o.freeDimensionOverrides) for (let [m, f] of Object.entries(o.freeDimensionOverrides)) {
        ...
        let b = Ne(m, n);
        t._OrtAddFreeDimensionOverride(r, b, f) !== 0 && fe(`Can't set a free dimension override: ${m} - ${f}.`);
      }
      return o.extra !== void 0 && Zt(o.extra, "", /* @__PURE__ */ new WeakSet(), (m, f) => {
        Pr(r, m, f, n);
      }), [r, n];
    } catch (i) {
      throw r !== 0 && t._OrtReleaseSessionOptions(r) !== 0 && fe("Can't release session options."), n.forEach((a) => t._free(a)), i;
    }
  };
});
var _t;
...
var Y = U(() => {
  ...
  }, Or = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", zr = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Kn = (e) => {
    switch (e) {
      case "none":
        return 0;
      case "cpu":
...
var jn = U(() => {
  ...
  Yt = async (e) => {
    if (typeof e == "string") if (false) try {
      let { readFile: t } = Dn("node:fs/promises");
      return new Uint8Array(await t(e));
    } catch (t) {
      if (t.code === "ERR_FS_FILE_TOO_LARGE") {
        let { createReadStream: r } = Dn("node:fs"), n = r(e), o = [];
...
var Je = U(() => {
  ...
  Y();
  am = ["V", "I", "W", "E", "F"], sm = (e, t) => {
    console.log(`[${am[e]},${(/* @__PURE__ */ new Date()).toISOString()}]${t}`);
  }, Dr = (e, t) => {
    Na = e, Va = t;
  }, um = (e, t) => {
    let r = Qt(e), n = Qt(Na);
    r >= n && sm(r, typeof t == "function" ? t() : t);
  }, ue = (...e) => {
    Va && um(...e);
  };
});
...
var ne = U(() => {
  ...
  Zn = class {
    ...
    static calcShape(t, r, n = false) {
      ...
      if (n) {
        if (o < 2 || i < 2) return;
        let d = Zn.calcMatMulShape([t[o - 2], t[o - 1]], [r[i - 2], r[i - 1]]);
        if (d === void 0) return;
        [u[a - 2], u[a - 1]] = d;
      }
    ...
    static getShapeOfGemmResult(t, r, n, o, i) {
      ...
      if (i && !et.isValidBroadcast(i, [a, d])) throw new Error("gemm: invalid bias shape for broadcast");
      return [a, d, u];
    }
...
var ja = U(() => {
  ...
  Y();
  Je();
  Ha = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Xn = (e, t) => {
    if (t === "int32") return e;
    let r = Ha.get(t);
    if (!r) throw new Error(`WebNN backend does not support data type: ${t}`);
    let n = r / 8;
    if (e.byteLength % n !== 0) throw new Error(`Invalid Uint8Array length - must be a multiple of ${n}.`);
    let o = e.byteLength / n, i = new (Ut(t))(e.buffer, e.byteOffset, o);
    switch (t) {
      case "int64":
      case "uint64": {
        let a = new Int32Array(o);
        for (let u = 0; u < o; u++) {
          let d = i[u];
      ...
      case "uint8":
      case "uint32": {
        if (t === "uint32" && i.some((u) => u > 2147483647)) throw new Error("Can not convert uint32 data to int32 - value out of range.");
        let a = Int32Array.from(i, Number);
        return new Uint8Array(a.buffer);
      }
      default:
    ...
    let r = e.byteLength / 4, n = new Int32Array(e.buffer, e.byteOffset, r);
    switch (t) {
      case "int64": {
  ...
  }, dm = 1, Ga = () => dm++, lm = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), qa = (e, t) => {
    let r = Ha.get(e);
    ...
    constructor(t) {
      ...
      let { sessionId: r, context: n, tensor: o, dataType: i, shape: a, fallbackDataType: u } = t;
      this.sessionId = r, this.mlContext = n, this.mlTensor = o, this.dataType = i, this.tensorShape = a, this.fallbackDataType = u;
    }
    get tensor() {
    ...
    get byteLength() {
      return qa(this.dataType, this.tensorShape);
    }
    destroy() {
    ...
    async read(t) {
      if (this.fallbackDataType) {
        let r = await this.mlContext.readTensor(this.mlTensor), n = Fa(new Uint8Array(r), this.dataType);
        if (t) {
          (t instanceof ArrayBuffer ? new Uint8Array(t) : new Uint8Array(t.buffer, t.byteOffset, t.byteLength)).set(n);
          return;
    ...
    async ensureTensor(t, r, n, o) {
      let i = this.tensorManager.getMLContext(t), a;
      if (!i.opSupportLimits().input.dataTypes.includes(r)) {
        if (a = lm.get(r), !a || !i.opSupportLimits().input.dataTypes.includes(a)) throw new Error(`WebNN backend does not support data type: ${r}`);
        ue("verbose", () => `[WebNN] TensorIdTracker.ensureTensor: fallback dataType from ${r} to ${a}`);
      }
      if (this.wrapper) {
        if (this.wrapper.canReuseTensor(i, r, n)) return this.wrapper.tensor;
        if (o) {
          if (this.wrapper.byteLength !== qa(r, n)) throw new Error("Unable to copy data to tensor with different size.");
          this.activeUpload = new Uint8Array(await this.wrapper.read());
        }
        this.tensorManager.releaseTensor(this.wrapper);
      }
      let u = typeof MLTensorUsage > "u" ? void 0 : MLTensorUsage.READ | MLTensorUsage.WRITE;
      return this.wrapper = await this.tensorManager.getCachedTensor(t, r, n, u, true, true, a), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
    }
    upload(t) {
      let r = t;
      if (this.wrapper) {
        if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") r = Xn(t, this.wrapper.type), this.wrapper.setIsDataConverted(true);
    ...
    async download(t) {
      ...
      if (this.activeUpload) {
        let r = ((_a2 = this.wrapper) == null ? void 0 : _a2.isDataConverted) ? Fa(this.activeUpload, (_b = this.wrapper) == null ? void 0 : _b.type) : this.activeUpload;
        if (t) {
    ...
    async ensureTensor(t, r, n, o, i) {
      ue("verbose", () => `[WebNN] TensorManager.ensureTensor {tensorId: ${r}, dataType: ${n}, shape: ${o}, copyOld: ${i}}`);
    ...
    async download(t, r) {
      ue("verbose", () => `[WebNN] TensorManager.download {tensorId: ${t}, dstBuffer: ${r == null ? void 0 : r.byteLength}}`);
      let n = this.tensorTrackersById.get(t);
      if (!n) throw new Error("Tensor not found.");
      return n.download(r);
    }
    ...
    async getCachedTensor(t, r, n, o, i, a, u) {
      let d = this.getMLContext(t);
      for (let [p, m] of this.freeTensors.entries()) if (m.canReuseTensor(d, r, n)) {
        ue("verbose", () => `[WebNN] Reusing tensor {dataType: ${r}, ${u ? `fallbackDataType: ${u},` : ""} shape: ${n}`);
        let f = this.freeTensors.splice(p, 1)[0];
        return f.sessionId = t, f;
      }
      ue("verbose", () => `[WebNN] MLContext.createTensor {dataType: ${r}, ${u ? `fallbackDataType: ${u},` : ""} shape: ${n}}`);
      let c = await d.createTensor({ dataType: u ?? r, shape: n, dimensions: n, usage: o, writable: i, readable: a });
      return new Rr({ sessionId: t, context: d, tensor: c, dataType: r, shape: n, fallbackDataType: u });
    }
    releaseTensor(t) {
...
var Za = U(() => {
  ...
  ja();
  Je();
  Nr = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), cm = (e, t) => {
    if (e === t) return true;
    ...
    onRunStart(t) {
      ue("verbose", () => `[WebNN] onRunStart {sessionId: ${t}}`), this.activeSessionId = t;
    }
    onRunEnd(t) {
      ue("verbose", () => `[WebNN] onRunEnd {sessionId: ${t}}`);
      let r = this.temporarySessionTensorIds.get(t);
      if (r) {
        for (let n of r) ue("verbose", () => `[WebNN] releasing temporary tensor {tensorId: ${n}}`), this.tensorManager.releaseTensorId(n);
    ...
    async createMLContext(t) {
      ...
      let r = this.mlContextCache.findIndex((n) => cm(n.options, t));
    ...
    async createTemporaryTensor(t, r, n) {
      ue("verbose", () => `[WebNN] createTemporaryTensor {onnxDataType: ${r}, shape: ${n}}`);
      let o = Nr.get(r);
    ...
    registerMLTensor(t, r, n, o) {
      ...
      return ue("verbose", () => `[WebNN] registerMLTensor {tensor: ${r}, dataType: ${i}, dimensions: ${o}} -> {tensorId: ${a}}`), a;
    }
    registerMLConstant(t, r, n, o, i, a, u = false) {
      ...
      switch (i.dataType) {
        ...
        case "int64":
          if (u) {
            let f = Xn(new Uint8Array(p), "int64");
            m = new Int32Array(f.buffer), i.dataType = "int32";
      ...
      return ue("verbose", () => `[WebNN] registerMLConstant {dataType: ${i.dataType}, shape: ${i.shape}}} ${u ? "(Note: it was int64 data type and registered to int32 as workaround)" : ""}`), o.constant(i, m);
    }
    ...
    isGraphOutput(t, r) {
      let n = this.sessionGraphOutputs.get(t);
      return n ? n.includes(r) : false;
    }
    isGraphInputOutputTypeSupported(t, r, n = true) {
      let o = this.mlContextBySessionId.get(t), i = Nr.get(_t(r));
      return typeof i > "u" ? false : n ? !!(o == null ? void 0 : o.opSupportLimits().input.dataTypes.includes(i)) : !!(o == null ? void 0 : o.opSupportLimits().output.dataTypes.includes(i));
    }
    flush() {
    }
  };
...
var es = U(() => {
  ...
  Je();
  Wr();
  Qa = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Jn = [], eo = (e) => Math.ceil(Number(e) / 16) * 16, pm = (e) => {
    for (let t = 0; t < Jn.length; t++) {
      let r = Jn[t];
      if (e <= r) return r;
    }
    return Math.ceil(e / 16) * 16;
  }, mm = 1, Ya = () => mm++, ro = async (e, t, r, n) => {
    ...
    constructor(t) {
      ...
      for (let [r] of Qa) Jn.push(r), this.freeBuffers.set(r, []), this.freeUniformBuffers.set(r, []);
      this.sessionCount = 0;
    }
    upload(t, r) {
      ...
      p.copyBufferToBuffer(d, 0, u.gpuData.buffer, 0, a), this.backend.device.queue.submit([p.finish()]), d.destroy(), ue("verbose", () => `[WebGPU] GpuDataManager.upload(id=${t})`);
    }
    memcpy(t, r) {
    ...
    registerExternalBuffer(t, r, n) {
      ...
      return this.storageCache.set(o, { gpuData: { id: o, type: 0, buffer: t }, originalSize: r }), ue("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${o}, registered.`), o;
    }
    ...
    create(t, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
      let n = pm(t), o, i = (r & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, a = (r & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
      if (i || a) {
      ...
      let u = { id: Ya(), type: 0, buffer: o };
      return this.storageCache.set(u.id, { gpuData: u, originalSize: Number(t) }), ue("verbose", () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${u.id}`), u;
    }
    get(t) {
      var _a2;
...
var ie = U(() => {
  ...
  }, me = (e) => e % 4 === 0 ? 4 : e % 2 === 0 ? 2 : 1, ao = (e = "f32", t, r = "0") => !t || t === 1 ? `${e}(${r})` : `vec${t}<${e}>(${r})`, Et = (e, t, r) => e === "f32" ? r : t === 1 ? `f32(${r})` : `vec${t}<f32>(${r})`, Fe = (e, t) => t === 4 ? `(${e}.x + ${e}.y + ${e}.z + ${e}.w)` : t === 2 ? `(${e}.x + ${e}.y)` : t === 3 ? `(${e}.x + ${e}.y + ${e}.z)` : e, F = (e, t, r, n) => e.startsWith("uniforms.") && r > 4 ? typeof t == "string" ? n === "f16" ? `${e}[(${t}) / 8][(${t}) % 8 / 4][(${t}) % 8 % 4]` : `${e}[(${t}) / 4][(${t}) % 4]` : n === "f16" ? `${e}[${Math.floor(t / 8)}][${Math.floor(t % 8 / 4)}][${t % 8 % 4}]` : `${e}[${Math.floor(t / 4)}][${t % 4}]` : r > 1 ? `${e}[${t}]` : e, Lr = (e, t, r, n, o) => {
    let i = typeof r == "number", a = i ? r : r.length, u = [...new Array(a).keys()], d = a < 2 ? "u32" : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`, c = io(t, o), p = typeof c == "string" ? c : c[1], m = typeof c == "string" ? c : c[0], f = { indices: d, value: p, storage: m, tensor: t }, b = (C) => typeof C == "string" ? C : `${C}u`, g = { offsetToIndices: false, indicesToOffset: false, broadcastedIndicesToOffset: false, set: false, setByIndices: false, get: false, getByIndices: false }, _ = i ? "uniforms." : "", S = `${_}${e}_shape`, $ = `${_}${e}_strides`, w = "";
    for (let C = 0; C < a - 1; C++) w += `
  ...
  fn o2i_${e}(offset: u32) -> ${f.indices} {
    ...
    ${w}
    return indices;
  }`, T = (C) => (g.offsetToIndices = true, a < 2 ? C : `o2i_${e}(${C})`), k = [];
    if (a >= 2) for (let C = a - 1; C >= 0; C--) k.push(`${F($, C, a)} * (indices[${C}])`);
    let I = a < 2 ? "" : `
  fn i2o_${e}(indices: ${f.indices}) -> u32 {
    return ${k.join("+")};
  }`, O = (C) => (g.indicesToOffset = true, a < 2 ? C : `i2o_${e}(${C})`), z = (...C) => a === 0 ? "0u" : `${f.indices}(${C.map(b).join(",")})`, B = (C, L) => a < 2 ? `${C}` : `${F(C, L, a)}`, W = (C, L, le) => a < 2 ? `${C}=${le};` : `${F(C, L, a)}=${le};`, q = {}, j = (C, L) => {
      g.broadcastedIndicesToOffset = true;
      let le = `${L.name}broadcastedIndicesTo${e}Offset`;
      if (le in q) return `${le}(${C})`;
      let Ce = [];
      for (let ze = a - 1; ze >= 0; ze--) {
        let xe = L.indicesGet("outputIndices", ze + L.rank - a);
        Ce.push(`${B($, ze)} * (${xe} % ${B(S, ze)})`);
      }
      return q[le] = `fn ${le}(outputIndices: ${L.type.indices}) -> u32 {
             return ${Ce.length > 0 ? Ce.join("+") : "0u"};
           }`, `${le}(${C})`;
    }, te = (C, L) => (() => {
      if (f.storage === f.value) return `${e}[${C}]=${L};`;
      if (f.storage === "vec2<u32>" && f.value === "i32") return `${e}[${C}]=vec2<u32>(u32(${L}), select(0u, 0xFFFFFFFFu, ${L} < 0));`;
      if (f.storage === "vec2<u32>" && f.value === "u32") return `${e}[${C}]=vec2<u32>(u32(${L}), 0u);`;
      if (f.storage === "u32" && f.value === "vec4<bool>") return `${e}[${C}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${L}));`;
  ...
  fn get_${e}ByIndices(indices: ${f.indices}) -> ${p} {
    return ${V(`i2o_${e}(indices)`)};
      ...
      let C = u.map((le) => `d${le}: u32`).join(", "), L = u.map((le) => `d${le}`).join(", ");
      return `
  fn get_${e}(${C}) -> ${p} {
    return get_${e}ByIndices(${z(L)});
      ...
      let L = C.map(b).join(",");
      return a === 0 ? V("0u") : a === 1 ? V(L[0]) : (g.get = true, g.getByIndices = true, g.indicesToOffset = true, `get_${e}(${L})`);
    }, ae = (C) => a < 2 ? V(C) : (g.getByIndices = true, g.indicesToOffset = true, `get_${e}ByIndices(${C})`), Z = a < 2 ? "" : `
  ...
  fn set_${e}(${C}, value: ${p}) {
    ...
    return { impl: () => {
      let C = [], L = false;
      return g.offsetToIndices && (C.push(x), L = true), g.indicesToOffset && (C.push(I), L = true), g.broadcastedIndicesToOffset && (Object.values(q).forEach((le) => C.push(le)), L = true), g.set && (C.push(re), L = true), g.setByIndices && (C.push(Z), L = true), g.get && (C.push(J), L = true), g.getByIndices && (C.push(de), L = true), !i && L && C.unshift(`const ${S} = ${f.indices}(${r.join(",")});`, `const ${$} = ${f.indices}(${E.computeStrides(r).join(",")});`), C.join(`
`);
    }, type: f, offsetToIndices: T, indicesToOffset: O, broadcastedIndicesToOffset: j, indices: z, indicesGet: B, indicesSet: W, set: (...C) => {
      if (C.length !== a + 1) throw new Error(`indices length must be ${a}`);
      let L = C[a];
      if (typeof L != "string") throw new Error("value must be string");
      let le = C.slice(0, a).map(b).join(",");
      return a === 0 ? te("0u", L) : a === 1 ? te(le[0], L) : (g.set = true, g.setByIndices = true, g.indicesToOffset = true, `set_${e}(${le}, ${L})`);
    }, setByOffset: te, setByIndices: (C, L) => a < 2 ? te(C, L) : (g.setByIndices = true, g.indicesToOffset = true, `set_${e}ByIndices(${C}, ${L});`), get: H, getByOffset: V, getByIndices: ae, usage: n, name: e, strides: $, shape: S, rank: a };
  }, P = (e, t, r, n = 1) => Lr(e, t, r, "input", n), M = (e, t, r, n = 1) => Lr(e, t, r, "output", n), ts = (e, t, r) => Lr(e, t, r, "atomicOutput", 1), Gr = (e, t, r, n = 1) => Lr(e, t, r, "internal", n), oo = class {
    constructor(t, r) {
...
var ut = U(() => {
  ...
  fm = (e, t) => {
  ...
  }, ns = (e, t) => t.length !== 0 ? t : [...new Array(e).keys()].reverse(), hm = (e, t) => E.sortBasedOnPerm(e, ns(e.length, t)), gm = (e, t, r, n) => {
    ...
    let r = e.dataType, n = e.dims.length, o = ns(n, t), i = hm(e.dims, o), a = e.dims, u = i, d = n < 2 || ym(o, e.dims), c;
    if (d) return c = (_) => {
  ...
  ${_.mainStart()}
    ...
    let { newShape: p, newPerm: m } = bm(e.dims, o), f = E.areEqual(m, [2, 3, 1]), b = E.areEqual(m, [3, 1, 2]);
    if (p.length === 2 || f || b) {
      a = f ? [p[0], p[1] * p[2]] : b ? [p[0] * p[1], p[2]] : p, u = [a[1], a[0]];
      let _ = 16;
      return c = (S) => {
        let $ = P("a", r, a.length), w = M("output", r, u.length);
        return `
  ...
  ${_.mainStart()}
    ...
    fm(e.inputs, t.perm), e.compute(ke(e.inputs[0], t.perm));
  }, is = (e) => X({ perm: e.perm });
});
var _m;
var wm;
...
var gs = U(() => {
  ...
  _m = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, wm = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, vm = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, $m = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, xm = (e, t) => {
    ...
    let u = r[0].dims, d = E.size(i), c = E.size(a), p = P("_A", r[0].dataType, u), m = M("output", o, i), f = 64;
    d === 1 && (f = 256);
    let b = `
    ...
    let a = E.normalizeAxes(i, e.inputs[0].dims.length), u = a, d = e.inputs[0], c = Cm(u, e.inputs[0].dims.length);
    c.length > 0 && (d = e.compute(ke(e.inputs[0], c), { inputs: [0], outputs: [-1] })[0], u = xm(u.length, d.dims.length));
    let [p, m] = Sm(d.dims, u), f = p;
    o.keepDims && (f = Tm(p, a)), e.compute(Am(t, o.cacheKey, [d], n, e.inputs[0].dataType, f, m), { inputs: [d] });
  }, as = (e, t) => {
    tt(e, "ReduceMeanShared", t, "mean");
  }, ss = (e, t) => {
    tt(e, "ReduceL1Shared", t, "l1");
  }, us = (e, t) => {
    tt(e, "ReduceL2Shared", t, "l2");
  }, ds = (e, t) => {
    tt(e, "ReduceLogSumExpShared", t, "logSumExp");
  }, ls = (e, t) => {
    tt(e, "ReduceMaxShared", t, "max");
  }, cs = (e, t) => {
    tt(e, "ReduceMinShared", t, "min");
  }, ps = (e, t) => {
    tt(e, "ReduceProdShared", t, "prod");
  }, ms = (e, t) => {
    tt(e, "ReduceSumShared", t, "sum");
  }, fs = (e, t) => {
    tt(e, "ReduceSumSquareShared", t, "sumSquare");
  }, hs = (e, t) => {
    tt(e, "ReduceLogSumShared", t, "logSum");
  };
});
var rt;
var km;
...
var Hr = U(() => {
  ...
  }, km = (e) => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""], Fr = (e, t, r, n, o, i, a = false, u = false) => {
    let d = [], c = r[0].dims, p = c.length, m = E.normalizeAxes(o, p), f = !u && m.length === 0;
    c.forEach((S, $) => {
      f || m.indexOf($) >= 0 ? a && d.push(1) : d.push(S);
    });
    let b = d.length, g = E.size(d);
    return { name: e, shaderCache: t, getShaderSource: (S) => {
      let $ = [], w = P("_A", r[0].dataType, p), x = M("output", i, b), T = n(w, x, m), k = T[2];
      for (let I = 0, O = 0; I < p; I++) f || m.indexOf(I) >= 0 ? (a && O++, k = `for(var j${I}: u32 = 0; j${I} < ${c[I]}; j${I}++) {
                  ${T[2].includes("last_index") ? `let last_index = j${I};` : ""}
                  ${w.indicesSet("input_indices", I, `j${I}`)}
                  ${k}
                }`) : ($.push(`${w.indicesSet("input_indices", I, x.indicesGet("output_indices", O))};`), O++);
      return `
...
`)}
    ...
    let r = [];
    return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((n) => r.push(Number(n))), X({ axes: r, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes });
  }, nt = (e, t, r, n) => {
    let o = e.inputs, i = o.length === 1 ? r : so(o, r);
    e.compute(Fr(t, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? km : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
  }, Em = (e, t) => {
    rt(e.inputs), nt(e, "ReduceLogSum", t, (n, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${n.getByIndices("input_indices")};`, "value = log(value);"]);
  }, Pm = (e, t) => {
    rt(e.inputs), nt(e, "ReduceL1", t, (n, o) => [`var value = ${o.type.storage}(0);`, "", `value += abs(${n.getByIndices("input_indices")});`, ""]);
  }, Om = (e, t) => {
    rt(e.inputs), nt(e, "ReduceL2", t, (n, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${n.getByIndices("input_indices")}; value += (t * t);`, "value = sqrt(value);"]);
  }, zm = (e, t) => {
    rt(e.inputs), nt(e, "ReduceLogSumExp", t, (n, o) => [`var value = ${o.type.storage}(0);`, "", `value += exp(${n.getByIndices("input_indices")});`, "value = log(value);"]);
  }, Dm = (e, t) => {
    rt(e.inputs), nt(e, "ReduceMax", t, (n, o, i) => {
      let a = [];
...
`)}`, `var value = ${n.getByIndices("input_indices")};`, `value = max(value, ${n.getByIndices("input_indices")});`, ""];
    ...
    rt(e.inputs), nt(e, "ReduceMean", t, (n, o, i) => {
      let a = 1;
    ...
    rt(e.inputs), nt(e, "ReduceMin", t, (n, o, i) => {
      let a = [];
...
`)}`, `var value = ${n.getByIndices("input_indices")};`, `value = min(value, ${n.getByIndices("input_indices")});`, ""];
    ...
    rt(e.inputs), nt(e, "ReduceProd", t, (n, o) => [`var value = ${o.type.storage}(1);`, "", `value *= ${n.getByIndices("input_indices")};`, ""]);
  }, Um = (e, t) => {
    rt(e.inputs), nt(e, "ReduceSum", t, (n, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${n.getByIndices("input_indices")};`, ""]);
  }, Nm = (e, t) => {
    rt(e.inputs), nt(e, "ReduceSumSquare", t, (n, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${n.getByIndices("input_indices")}; value += t * t;`, ""]);
  }, ot = (e, t, r) => {
    ...
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bm(e, t) : as(e, t);
  }, ys = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pm(e, t) : ss(e, t);
  }, _s = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Om(e, t) : us(e, t);
  }, ws = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zm(e, t) : ds(e, t);
  }, vs = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dm(e, t) : ls(e, t);
  }, $s = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Mm(e, t) : cs(e, t);
  }, xs = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Rm(e, t) : ps(e, t);
  }, Ss = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Um(e, t) : ms(e, t);
  }, Ts = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Nm(e, t) : fs(e, t);
  }, Is = (e, t) => {
    ot(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Em(e, t) : hs(e, t);
  };
});
var Cs;
var As;
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? "<=" : "<"} value) {
    ...
    e.compute(Fr("ArgMin", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], r, [t.axis], 7, t.keepDims), { inputs: [0] });
  }, ks = (e, t) => {
    Cs(e.inputs);
    let r = (n, o, i) => {
      let a = [];
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
    ...
    e.compute(Fr("argMax", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], r, [t.axis], 7, t.keepDims), { inputs: [0] });
  }, uo = (e) => X(e);
});
var Vm;
var lo;
...
var qr = U(() => {
  ...
  Vm = (e, t) => {
    ...
    return { batchSize: d, sequenceLength: c, pastSequenceLength: _, kvSequenceLength: g, totalSequenceLength: S, maxSequenceLength: $, inputHiddenSize: p, hiddenSize: m, vHiddenSize: b, headSize: Math.floor(m / t.numHeads), vHeadSize: Math.floor(b / t.numHeads), numHeads: t.numHeads, isUnidirectional: false, pastPresentShareBuffer: false, maskFilterValue: t.maskFilterValue, maskType: w, scale: t.scale, broadcastResPosBias: false, passPastInKv: false, qkvFormat: 1 };
  }, lo = (e, t, r) => t && e ? `
    ...
    `, Wm = (e, t, r, n, o, i, a, u) => {
    let d = me(a ? 1 : i), c = 64, p = i / d;
    p < c && (c = 32);
    let m = Math.ceil(i / d / c), f = [{ type: 12, data: t }, { type: 12, data: r }, { type: 12, data: n }, { type: 12, data: o }, { type: 12, data: p }, { type: 12, data: m }], b = ye(e.dataType, d), g = Ae(1, d), _ = ["type"];
    a && _.push("type"), u && _.push("type");
    let S = ($) => {
      let w = M("x", e.dataType, e.dims, d), x = [w], T = a ? P("seq_lens", a.dataType, a.dims) : void 0;
      T && x.push(T);
      let k = u ? P("total_sequence_length_input", u.dataType, u.dims) : void 0;
      k && x.push(k);
      let I = Ae(e.dataType), O = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
      return `
  ...
  }, Lm = (e, t, r, n, o, i, a, u, d) => {
    let c = a + i.kvSequenceLength, p = [i.batchSize, i.numHeads, i.sequenceLength, c], m = e > 1 && n, f = i.kvNumHeads ? i.kvNumHeads : i.numHeads, b = m ? [i.batchSize, f, c, i.headSize] : void 0, g = i.nReps ? i.nReps : 1, _ = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, S = me(i.headSize), $ = i.headSize / S, w = 12, x = { x: Math.ceil(c / w), y: Math.ceil(i.sequenceLength / w), z: i.batchSize * i.numHeads }, T = [{ type: 12, data: i.sequenceLength }, { type: 12, data: $ }, { type: 12, data: c }, { type: 12, data: i.numHeads }, { type: 12, data: i.headSize }, { type: 1, data: _ }, { type: 12, data: a }, { type: 12, data: i.kvSequenceLength }, { type: 12, data: g }], k = m && n && E.size(n.dims) > 0, I = ["type", "type"];
    k && I.push("type"), o && I.push("type"), u && I.push("type"), d && I.push("type");
    let O = [{ dims: p, dataType: t.dataType, gpuDataType: 0 }];
    m && O.push({ dims: b, dataType: t.dataType, gpuDataType: 0 });
    let z = (B) => {
      let W = P("q", t.dataType, t.dims, S), q = P("key", r.dataType, r.dims, S), j = [W, q];
      if (k) {
        let Z = P("past_key", n.dataType, n.dims, S);
        j.push(Z);
      }
      o && j.push(P("attention_bias", o.dataType, o.dims));
      let te = u ? P("seq_lens", u.dataType, u.dims) : void 0;
      te && j.push(te);
      let V = d ? P("total_sequence_length_input", d.dataType, d.dims) : void 0;
      V && j.push(V);
      let de = M("output", t.dataType, p), J = [de];
      m && J.push(M("present_key", t.dataType, b, S));
      let H = Ae(1, S), ae = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
      return `
  const TILE_SIZE = ${w}u;
  ...
  ${B.mainStart([w, w, 1])}
    ...
    return { name: "AttentionProbs", shaderCache: { hint: `${S};${o !== void 0};${n !== void 0};${e}`, inputDependencies: I }, getRunData: () => ({ outputs: O, dispatchGroup: x, programUniforms: T }), getShaderSource: z };
  }, Gm = (e, t, r, n, o, i, a = void 0, u = void 0) => {
    let d = i + o.kvSequenceLength, c = o.nReps ? o.nReps : 1, p = o.vHiddenSize * c, m = e > 1 && n, f = o.kvNumHeads ? o.kvNumHeads : o.numHeads, b = m ? [o.batchSize, f, d, o.headSize] : void 0, g = [o.batchSize, o.sequenceLength, p], _ = 12, S = { x: Math.ceil(o.vHeadSize / _), y: Math.ceil(o.sequenceLength / _), z: o.batchSize * o.numHeads }, $ = [{ type: 12, data: o.sequenceLength }, { type: 12, data: d }, { type: 12, data: o.vHeadSize }, { type: 12, data: o.numHeads }, { type: 12, data: o.headSize }, { type: 12, data: p }, { type: 12, data: i }, { type: 12, data: o.kvSequenceLength }, { type: 12, data: c }], w = m && n && E.size(n.dims) > 0, x = ["type", "type"];
    w && x.push("type"), a && x.push("type"), u && x.push("type");
    let T = [{ dims: g, dataType: t.dataType, gpuDataType: 0 }];
    m && T.push({ dims: b, dataType: t.dataType, gpuDataType: 0 });
    let k = (I) => {
      let O = P("probs", t.dataType, t.dims), z = P("v", r.dataType, r.dims), B = [O, z];
      w && B.push(P("past_value", n.dataType, n.dims));
      let W = a ? P("seq_lens", a.dataType, a.dims) : void 0;
      a && B.push(W);
      let q = u ? P("total_sequence_length_input", u.dataType, u.dims) : void 0;
      u && B.push(q);
      let te = [M("output", t.dataType, g)];
      m && te.push(M("present_value", t.dataType, b));
      let V = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "v_hidden_size", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
      return `
  const TILE_SIZE = ${_}u;
  ...
  ${I.mainStart([_, _, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
    ...
    return { name: "AttentionScore", shaderCache: { hint: `${n !== void 0};${e}`, inputDependencies: x }, getRunData: () => ({ outputs: T, dispatchGroup: S, programUniforms: $ }), getShaderSource: k };
  }, Nt = (e, t, r, n, o, i, a, u, d, c, p = void 0, m = void 0) => {
    let f = Math.min(e.outputCount, 1 + (a ? 1 : 0) + (u ? 1 : 0)), b = f > 1 ? c.pastSequenceLength : 0, g = b + c.kvSequenceLength, _ = d && E.size(d.dims) > 0 ? d : void 0, S = [t, r];
    f > 1 && a && E.size(a.dims) > 0 && S.push(a), _ && S.push(_), p && S.push(p), m && S.push(m);
    let $ = e.compute(Lm(f, t, r, a, _, c, b, p, m), { inputs: S, outputs: f > 1 ? [-1, 1] : [-1] })[0];
    e.compute(Wm($, c.batchSize, c.numHeads, b, c.sequenceLength, g, p, m), { inputs: p && m ? [$, p, m] : [$], outputs: [] });
    let w = [$, n];
    f > 1 && u && E.size(u.dims) > 0 && w.push(u), p && w.push(p), m && w.push(m), e.compute(Gm(f, $, n, u, c, b, p, m), { inputs: w, outputs: f > 1 ? [0, 2] : [0] });
  }, Hm = (e, t) => {
    let r = [t.batchSize, t.numHeads, t.sequenceLength, t.headSize], n = t.sequenceLength, o = t.inputHiddenSize, i = t.headSize, a = 12, u = { x: Math.ceil(t.headSize / a), y: Math.ceil(t.sequenceLength / a), z: t.batchSize * t.numHeads }, d = [e.inputs[0], e.inputs[1], e.inputs[2]], c = [{ type: 12, data: n }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: t.numHeads }, { type: 12, data: t.headSize }, { type: 12, data: t.hiddenSize }, { type: 12, data: t.hiddenSize + t.hiddenSize + t.vHiddenSize }], p = (m) => {
      let f = M("output_q", d[0].dataType, r), b = M("output_k", d[0].dataType, r), g = M("output_v", d[0].dataType, r), _ = P("input", d[0].dataType, d[0].dims), S = P("weight", d[1].dataType, d[1].dims), $ = P("bias", d[2].dataType, d[2].dims), w = _.type.storage, x = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "ldb", type: "u32" }];
      return `
  const TILE_SIZE = ${a}u;
  ...
  ${m.mainStart([a, a, 1])}
    ...
    let r = Vm(e.inputs, t), [n, o, i] = Hm(e, r);
    return Nt(e, n, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], r);
  };
});
var Fm;
var qm;
...
var zs = U(() => {
  ...
  Fm = (e, t) => {
    ...
    let { epsilon: r, spatial: n, format: o } = t, i = e[0].dims, a = n ? me(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? a : 1, d = E.size(i) / a, c = n, p = c ? i.length : i, m = P("x", e[0].dataType, e[0].dims, a), f = P("scale", e[1].dataType, e[1].dims, u), b = P("bias", e[2].dataType, e[2].dims, u), g = P("inputMean", e[3].dataType, e[3].dims, u), _ = P("inputVar", e[4].dataType, e[4].dims, u), S = M("y", e[0].dataType, p, a), $ = () => {
      let x = "";
  ...
  ${x.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    return { name: "BatchNormalization", shaderCache: { hint: `${t.epsilon}_${t.format}_${n}_${a}`, inputDependencies: c ? ["rank", "type", "type", "type", "type"] : void 0 }, getShaderSource: w, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(d / 64) }, programUniforms: c ? [{ type: 12, data: d }, ...N(i)] : [{ type: 12, data: d }] }) };
  }, Km = (e) => X(e), Os = (e, t) => {
    let { inputs: r, outputCount: n } = e, o = Km({ ...t, outputCount: n });
    if (be.webgpu.validateInputContent && Fm(r, o), t.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
    e.compute(qm(r, o));
  };
});
var jm;
...
var Bs = U(() => {
  ...
  jm = (e) => {
    ...
    let t = e[0].dims, r = e[0].dims[2], n = E.size(t) / 4, o = e[0].dataType, i = P("input", o, t, 4), a = P("bias", o, [r], 4), u = P("residual", o, t, 4), d = M("output", o, t, 4);
  ...
  ${p.mainStart()}
    ...
    jm(e.inputs), e.compute(Zm(e.inputs));
  };
});
var Qm;
var he;
...
var jr = U(() => {
  ...
  ${e.mainStart()}
  ...
  }, he = (e, t, r, n, o, i = e.dataType, a, u) => {
    let d = [{ type: 12, data: Math.ceil(E.size(e.dims) / 4) }];
    return a && d.push(...a), { name: t, shaderCache: { hint: o, inputDependencies: ["type"] }, getShaderSource: (c) => Qm(c, E.size(e.dims), e.dataType, i, r, n, u), getRunData: (c) => ({ outputs: [{ dims: e.dims, dataType: i }], dispatchGroup: { x: Math.ceil(E.size(c[0].dims) / 64 / 4) }, programUniforms: d }) };
  }, Ms = (e) => {
    ...
    return X({ min: t, max: r });
  }, Fs = (e, t) => {
    let r = t || Ym(e.inputs), n = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "Clip", (o) => `clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`, void 0, r.cacheKey, void 0, [{ type: e.inputs[0].dataType, data: r.min }, { type: e.inputs[0].dataType, data: r.max }], [{ name: "min", type: n }, { name: "max", type: n }]), { inputs: [0] });
  }, qs = (e) => {
    ...
    e.compute(he(e.inputs[0], "Elu", (n) => `elu_vf32(${n})`, `
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
    ...
    e.compute(he(e.inputs[0], "Erf", (r) => `erf_vf32(${r})`, Kr(t)));
  }, Ys = (e) => {
    ...
    let t = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "Gelu", (r) => `0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`, Kr(t)));
  }, eu = (e, t) => {
    let r = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "LeakyRelu", (n) => `select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`, `const leaky_relu_alpha_ = ${r}(${t.alpha});`, t.cacheKey));
  }, tu = (e) => {
    ...
    let t = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "Relu", (r) => `select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`));
  }, iu = (e) => {
    e.compute(he(e.inputs[0], "Sigmoid", (t) => `(1.0 / (1.0 + exp(-${t})))`));
  }, au = (e) => X(e), su = (e, t) => {
    let r = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "HardSigmoid", (n) => `max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`, void 0, t.cacheKey));
  }, uu = (e) => {
    ...
    e.compute(he(e.inputs[0], "Tanh", pu));
  }, co = (e = "f32") => `
...
`, po = (e) => `(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`, fu = (e) => {
    let t = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "FastGelu", po, co(t), void 0, e.inputs[0].dataType));
  }, hu = (e, t) => {
    let r = Ae(e.inputs[0].dataType);
    return e.compute(he(e.inputs[0], "ThresholdedRelu", (n) => `select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`, `const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`, t.cacheKey)), 0;
  }, gu = (e) => {
...
`, Jm = (e) => `quick_gelu_impl(${e})`, bu = (e, t) => {
    let r = Ae(e.inputs[0].dataType);
    e.compute(he(e.inputs[0], "QuickGelu", Jm, Xm(r, t.alpha), t.cacheKey, e.inputs[0].dataType));
  };
});
var ef;
var tf;
...
var wu = U(() => {
  ...
  ef = (e) => {
    ...
    t[2] = t[2] / 2;
    let r = P("input", e[0].dataType, e[0].dims, 4), n = P("bias", e[0].dataType, [e[0].dims[2]], 4), o = M("output", e[0].dataType, t, 4), i = E.size(t) / 4, a = ye(e[0].dataType);
  ...
  ${d.mainStart()}
    ...
    ef(e.inputs), e.compute(tf(e.inputs));
  };
});
var rf;
var nf;
...
var Pu = U(() => {
  ...
  ne();
  ie();
  rf = (e, t, r, n, o, i, a, u, d, c, p, m) => {
    let f, b;
    typeof u == "string" ? f = b = (w, x) => `${u}((${w}),(${x}))` : typeof u == "function" ? f = b = u : (f = u.scalar, b = u.vector);
    let g = M("outputData", p, n.length, 4), _ = P("aData", d, t.length, 4), S = P("bData", c, r.length, 4), $;
    if (o) if (i) {
      let w = E.size(t) === 1, x = E.size(r) === 1, T = t.length > 0 && t[t.length - 1] % 4 === 0, k = r.length > 0 && r[r.length - 1] % 4 === 0;
      w || x ? $ = g.setByOffset("global_idx", b(w ? `${_.type.value}(${_.getByOffset("0")}.x)` : _.getByOffset("global_idx"), x ? `${S.type.value}(${S.getByOffset("0")}.x)` : S.getByOffset("global_idx"))) : $ = `
      ...
      let w = (x, T, k = "") => {
        let I = `aData[indexA${T}][componentA${T}]`, O = `bData[indexB${T}][componentB${T}]`;
        return `
  ...
  }, nf = (e, t, r, n, o, i, a = r.dataType) => {
    let u = r.dims.map((_) => Number(_) ?? 1), d = n.dims.map((_) => Number(_) ?? 1), c = !E.areEqual(u, d), p = u, m = E.size(u), f = false, b = false, g = [c];
    if (c) {
      let _ = et.calcShape(u, d, false);
      if (!_) throw new Error("Can't perform binary op on the given tensors");
      p = _.slice(), m = E.size(p);
      let S = E.size(u) === 1, $ = E.size(d) === 1, w = u.length > 0 && u[u.length - 1] % 4 === 0, x = d.length > 0 && d[d.length - 1] % 4 === 0;
      g.push(S), g.push($), g.push(w), g.push(x);
      let T = 1;
      for (let k = 1; k < p.length; k++) {
        let I = u[u.length - k], O = d[d.length - k];
        if (I === O) T *= I;
        else break;
      }
      T % 4 === 0 ? (b = true, f = true) : (S || $ || w || x) && (f = true);
    } else f = true;
    return g.push(f), { name: e, shaderCache: { hint: t + g.map((_) => _.toString()).join("_"), inputDependencies: ["rank", "rank"] }, getShaderSource: (_) => rf(_, u, d, p, f, c, b, o, r.dataType, n.dataType, a, i), getRunData: () => ({ outputs: [{ dims: p, dataType: a }], dispatchGroup: { x: Math.ceil(m / 64 / 4) }, programUniforms: [{ type: 12, data: Math.ceil(E.size(p) / 4) }, ...N(u, d, p)] }) };
  }, it = (e, t, r, n, o, i) => {
    e.compute(nf(t, o ?? "", e.inputs[0], e.inputs[1], r, n, i));
  }, vu = (e) => {
    it(e, "Add", (t, r) => `${t}+${r}`);
  }, $u = (e) => {
    it(e, "Div", (t, r) => `${t}/${r}`);
  }, xu = (e) => {
    it(e, "Equal", { scalar: (t, r) => `u32(${t}==${r})`, vector: (t, r) => `vec4<u32>(${t}==${r})` }, void 0, void 0, 9);
  }, Su = (e) => {
    it(e, "Mul", (t, r) => `${t}*${r}`);
  }, Tu = (e) => {
    let t = P("input", e.inputs[0].dataType, e.inputs[0].dims).type.value;
    it(e, "Pow", { scalar: (n, o) => `pow_custom(${n},${o})`, vector: (n, o) => `pow_vector_custom(${n},${o})` }, `
    ...
    it(e, "Greater", { scalar: (t, r) => `u32(${t}>${r})`, vector: (t, r) => `vec4<u32>(${t}>${r})` }, void 0, void 0, 9);
  }, Au = (e) => {
    it(e, "Less", { scalar: (t, r) => `u32(${t}<${r})`, vector: (t, r) => `vec4<u32>(${t}<${r})` }, void 0, void 0, 9);
  }, ku = (e) => {
    it(e, "GreaterOrEqual", { scalar: (t, r) => `u32(${t}>=${r})`, vector: (t, r) => `vec4<u32>(${t}>=${r})` }, void 0, void 0, 9);
  }, Eu = (e) => {
    it(e, "LessOrEqual", { scalar: (t, r) => `u32(${t}<=${r})`, vector: (t, r) => `vec4<u32>(${t}<=${r})` }, void 0, void 0, 9);
  };
});
var af;
var sf;
...
`);
    ...
    let o = E.size(r), i = new Array(e.length), a = new Array(e.length), u = 0, d = [], c = [], p = [{ type: 12, data: o }];
  ...
  ${_.mainStart()}
    ...
    let r = e.inputs, n = r[0].dims, o = E.normalizeAxis(t.axis, n.length);
    af(r, o);
    let i = n.slice();
    i[o] = r.reduce((u, d) => u + (d.dims.length > o ? d.dims[o] : 0), 0);
    let a = r.filter((u) => E.size(u.dims) > 0);
    e.compute(df(a, o, i, r[0].dataType), { inputs: a });
  }, zu = (e) => X({ axis: e.axis });
});
var qe;
var Ke;
...
var vt = U(() => {
  ...
  qe = (e, t, r = "f32") => {
    ...
    if (t === "HardSigmoid") {
      ...
      let [r, n] = (e == null ? void 0 : e.activation_params) || [Wa, La];
...
`;
    ...
    let a = e[0].dims, u = e[1].dims, d = a[a.length - 2], c = u[u.length - 1], p = a[a.length - 1], m = me(c), f = me(p), b = me(d), g = E.size(r) / m / b, _ = e.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), w = [E.size(S), d, c], x = [{ type: 12, data: g }, { type: 12, data: d }, { type: 12, data: c }, { type: 12, data: p }];
    Ke(t, x), x.push(...N(S, a, u)), _ && x.push(...N(e[2].dims)), x.push(...N(w));
    let T = (k) => {
      let I = Gr("batch_dims", e[0].dataType, S.length), O = P("a", e[0].dataType, a.length, f), z = P("b", e[1].dataType, u.length, m), B = M("output", e[0].dataType, w.length, m), W = ye(B.type.tensor), q = qe(t, B.type.value, W), j = [O, z], te = "";
      if (_) {
        let J = o ? m : 1;
        j.push(P("bias", e[2].dataType, e[2].dims.length, J)), te = `${o ? `value += bias[col / ${J}];` : `value += ${B.type.value}(bias[row + i]);`}`;
      }
      let V = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }];
      je(t, V);
      let de = () => {
        let J = `var a_data: ${O.type.value};`;
        for (let H = 0; H < f; H++) J += `
              let b_data${H} = b[(b_offset + (k + ${H}) * uniforms.N + col) / ${m}];`;
        for (let H = 0; H < b; H++) {
          J += `a_data = a[(a_offset + (row + ${H}) * uniforms.K + k) / ${f}];`;
          for (let ae = 0; ae < f; ae++) J += `
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, pf = (e) => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", fo = (e, t, r = "f32", n, o = false, i = 32, a = false, u = 32, d = false) => {
...
`;
    ...
    let [i, a, u, d] = n, c = ye(n[0].type.tensor);
    return `
    ...
    `;
  }, er = (e, t, r, n, o = false, i) => {
    let a = e[0].dims, u = e[1].dims, d = a.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = E.size(p), f = a[a.length - 2], b = a[a.length - 1], g = u[u.length - 1], _ = b % 4 === 0 && g % 4 === 0, S = f <= 8 ? [4, 1, 1] : [4, 4, 1], $ = [8, 8, 1], w = [Math.ceil(g / $[0] / S[0]), Math.ceil(f / $[1] / S[1]), Math.ceil(m / $[2] / S[2])], x = _ ? 4 : 1, T = [...d, f, b / x], k = T.length, I = [...c, b, g / x], O = I.length, z = [m, f, g / x], B = [{ type: 6, data: f }, { type: 6, data: g }, { type: 6, data: b }];
    Ke(t, B), B.push(...N(p, T, I));
    let W = ["rank", "rank"], q = e.length > 2;
    q && (B.push(...N(e[2].dims)), W.push("rank")), B.push(...N(z));
    let j = (te) => {
      let V = p.length, de = Gr("batchDims", e[0].dataType, V, 1), J = ye(e[0].dataType), H = P("a", e[0].dataType, k, x), ae = P("b", e[1].dataType, O, x), Z = M("result", e[0].dataType, z.length, x), re = [H, ae];
      if (q) {
        let L = o ? x : 1;
        re.push(P("bias", e[2].dataType, e[2].dims.length, L));
      }
      let ve = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }];
      je(t, ve);
      let _e = ye(Z.type.tensor), ee = qe(t, Z.type.value, _e), C = mf(x, q, ee, [de, H, ae, Z], o);
      return `
  ...
  ${_ ? mo(S, $, J, de) : fo(S, $, J, de)}
    ...
    return { name: "MatMul", shaderCache: { hint: `${S};${t.activation};${_};${o}`, inputDependencies: W }, getRunData: () => ({ outputs: [{ dims: i ? i(r) : r, dataType: e[0].dataType }], dispatchGroup: { x: w[0], y: w[1], z: w[2] }, programUniforms: B }), getShaderSource: j };
  };
});
var ff;
var Nu;
var Vu = U(() => {
  ...
  Ru();
  Jr();
  ff = (e, t, r, n, o = false, i, a = 4, u = 4, d = 4, c = "f32") => {
    let p = (W) => {
      switch (W) {
        case 1:
    ...
    return ${Ie(u, c)}(0.0);`, k = Ie(d, c), I = e ? Ie(a, c) : Ie(u, c), O = e ? Ie(u, c) : Ie(a, c), z = qe(i, k, c);
    return `
  ...
  }, Nu = (e, t, r, n, o, i, a, u, d) => {
    let c = t.format === "NHWC", p = c ? e[0].dims[3] : e[0].dims[1], m = r[0], f = c ? r[2] : r[3], b = c ? r[1] : r[2], g = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && g % 4 === 0, S = c ? g : f * b, $ = c ? f * b : g, w = [8, 8, 1], x = n <= 8 ? [4, 1, 1] : [4, 4, 1], T = [Math.ceil(S / w[0] / x[0]), Math.ceil($ / w[1] / x[1]), Math.ceil(m / w[2] / x[2])];
    ue("verbose", () => `[conv2d_mm_webgpu] dispatch = ${T}`);
    let k = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, I = w[1] * x[1], O = w[0] * x[0], z = Math.max(w[0] * k, w[1]), B = n % I === 0, W = o % O === 0, q = i % z === 0, j = _ ? [k, 4, 4] : [1, 1, 1], te = [{ type: 6, data: n }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [t.pads[0], t.pads[1]] }, { type: 6, data: t.strides }, { type: 6, data: t.dilations }];
    Ke(t, te), te.push(...N(e[0].dims, e[1].dims));
    let V = ["rank", "rank"];
    a && (te.push(...N(e[2].dims)), V.push("rank")), te.push(...N(r));
    let de = (J) => {
      let H = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }];
      je(t, H);
      let ae = _ ? 4 : 1, Z = ye(e[0].dataType), re = `
      ...
      }`, ve = P("x", e[0].dataType, e[0].dims.length, k === 3 ? 1 : k), _e = P("w", e[1].dataType, e[1].dims.length, ae), ee = [ve, _e], C = M("result", e[0].dataType, r.length, ae);
      if (a) {
        let L = P("bias", e[2].dataType, e[2].dims.length, ae);
        ee.push(L), re += `
      ...
      return `
        ...
        ${_ ? mo(x, w, Z, void 0, !c, z) : fo(x, w, Z, void 0, !c, z, false, void 0, u)}`;
    };
    return { name: "Conv2DMatMul", shaderCache: { hint: `${t.cacheKey};${k};${_};${B};${W};${q};${I};${O};${z}`, inputDependencies: V }, getRunData: () => ({ outputs: [{ dims: d ? d(r) : r, dataType: e[0].dataType }], dispatchGroup: { x: T[0], y: T[1], z: T[2] }, programUniforms: te }), getShaderSource: de };
  };
});
var hf;
var Wu;
...
var Fu = U(() => {
  ...
  hf = (e) => {
    ...
    if (e === "VALID" && (e = 0), typeof e == "number") {
      ...
      let g = Lu([t, r, n, 1], [u, d, c], 1, [o, i, a], e[0]);
      m = g[0], f = g[1], b = g[2];
    } else if (e === "SAME_UPPER") {
      m = Math.ceil(t / o), f = Math.ceil(r / i), b = Math.ceil(n / a);
      let g = (m - 1) * o + u - t, _ = (f - 1) * i + d - r, S = (b - 1) * a + c - n, $ = Math.floor(g / 2), w = g - $, x = Math.floor(_ / 2), T = _ - x, k = Math.floor(S / 2), I = S - k;
      p = { top: x, bottom: T, left: k, right: I, front: $, back: w };
    ...
    let [f, , b, g, _] = t, [S, $, w] = Wu(r), [x, T, k] = Wu(n), I = en(b, x), O = en(g, T), z = en(_, k), { padInfo: B, outDepth: W, outHeight: q, outWidth: j } = bf(o, d, c, p, S, $, w, I, O, z), te = i ? f * m : f, V = [0, 0, 0, 0, 0];
    return a === "channelsFirst" ? V = [u, te, W, q, j] : a === "channelsLast" && (V = [u, W, q, j, te]), { batchSize: u, dataFormat: a, inDepth: d, inHeight: c, inWidth: p, inChannels: m, outDepth: W, outHeight: q, outWidth: j, outChannels: te, padInfo: B, strideDepth: S, strideHeight: $, strideWidth: w, filterDepth: b, filterHeight: g, filterWidth: _, effectiveFilterDepth: I, effectiveFilterHeight: O, effectiveFilterWidth: z, dilationDepth: x, dilationHeight: T, dilationWidth: k, inShape: e, outShape: V, filterShape: t };
  }, Hu = (e, t, r, n, o, i) => {
    let a = i === "channelsLast", u = a ? e[0].dims[3] : e[0].dims[1], d = false, c = [64, 1, 1], p = { x: r.map((w, x) => x) }, m = [Math.ceil(hf(p.x.map((w) => r[w])) / c[0]), 1, 1];
    ue("verbose", () => `[conv3d_naive_webgpu] dispatch = ${m}`);
    let f = d ? a && u % 4 !== 0 ? 3 : 4 : 1, b = E.size(r), g = [{ type: 12, data: b }, { type: 12, data: n }, { type: 12, data: o }, { type: 12, data: t.strides }, { type: 12, data: t.dilations }];
    Ke(t, g), g.push(...N(e[0].dims, e[1].dims));
    ...
    let $ = (w) => {
      ...
      je(t, x);
      let T = d ? 4 : 1, k = ye(e[0].dataType), I = P("x", e[0].dataType, e[0].dims.length, f === 3 ? 1 : f), O = P("W", e[1].dataType, e[1].dims.length, T), z = [I, O], B = M("result", e[0].dataType, r.length, T), W = "";
      if (S) {
        let te = P("bias", e[2].dataType, e[2].dims.length, T);
        z.push(te), W += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${d ? `vec4<${k}>` : k} {
          return bias[${a ? F("coords", 4, 5) : F("coords", 1, 5)}${d ? "/ 4" : ""}];
        }`;
      }
      let q = Ie(f, k), j = qe(t, q, k);
      return `
            ${W}
...
var ju = U(() => {
  ...
  vt();
  qu = (e, t, r, n) => {
    let o = e.length > 2, i = o ? "value += b[output_channel];" : "", a = e[0].dims, u = e[1].dims, d = t.format === "NHWC", c = d ? r[3] : r[1], p = c / t.group, m = d && p >= 4 ? me(c) : 1, f = E.size(r) / m, b = [{ type: 12, data: f }, { type: 12, data: t.dilations }, { type: 12, data: [t.strides[0], t.strides[1]] }, { type: 12, data: [t.pads[0], t.pads[1]] }, { type: 12, data: p }];
    Ke(t, b), b.push(...N(a, [u[0], u[1], u[2], u[3] / m]));
    let g = o ? ["rank", "rank", "rank"] : ["rank", "rank"];
    b.push(...N([r[0], r[1], r[2], r[3] / m]));
    let _ = (S) => {
      let $ = M("output", e[0].dataType, r.length, m), w = ye($.type.tensor), x = qe(t, $.type.value, w), T = P("x", e[0].dataType, a.length), k = P("w", e[1].dataType, u.length, m), I = [T, k];
  ...
  ${S.mainStart()}
    ...
    let o = e.length > 2, i = me(r[3]), a = me(r[2]), u = E.size(r) / i / a, d = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / i], c = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / i], p = [r[0], r[1], r[2], r[3] / i], m = [{ type: 12, data: u }, { type: 6, data: [t.strides[0], t.strides[1]] }, { type: 6, data: [t.pads[0], t.pads[1]] }];
    Ke(t, m), m.push(...N(d, c, p));
    let f = (a - 1) * t.strides[1] + c[1], b = (g) => {
      let _ = M("output", e[0].dataType, p.length, i), S = ye(_.type.tensor), $ = qe(t, _.type.value, S), w = P("x", e[0].dataType, d.length, i), x = P("w", e[1].dataType, c.length, i), T = [w, x];
      o && T.push(P("b", e[2].dataType, e[2].dims, i));
      let k = o ? "value += b[output_channel];" : "", I = [{ name: "output_size", type: "u32" }, { name: "strides", type: "i32", length: 2 }, { name: "pads", type: "i32", length: 2 }];
      return je(t, I), `
...
var Qu = U(() => {
  ...
  yf = (e, t, r, n, o, i) => {
    ...
    let n = e.pads.slice();
    At.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, r, n, e.format === "NHWC", e.autoPad);
    let o = Object.assign({}, e);
    return Object.assign(o, { kernelShape: r, pads: n }), o;
  }, bo = (e) => {
    let t = Zr(e), r = e.format, n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], o = e.dilations, i = e.group, a = e.kernel_shape, u = e.pads, d = e.strides, c = e.w_is_const();
    return { autoPad: n, format: r, dilations: o, group: i, kernelShape: a, pads: u, strides: d, wIsConst: c, ...t, cacheKey: `${e.format};${t.activation};` };
  }, Zu = (e, t, r, n) => {
    let o = r.format === "NHWC", i = yf(t[0].dims, t[1].dims, r.dilations, r.pads, r.strides, o);
    if (r.group !== 1) {
      let I = [t[0]];
      if (o) {
        let z = e.kernelCustomData.wT ?? e.compute(ke(t[1], ho), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = z), I.push(z);
      } else I.push(t[1]);
      t.length === 3 && I.push(t[2]), !e.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === r.group && t[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? e.compute(Ku(I, r, i, n), { inputs: I }) : e.compute(qu(I, r, i, n), { inputs: I });
      return;
    }
    ...
    if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
      let I = i[0], O, z, B, W = [];
      if (o) {
        let te = e.kernelCustomData.wT ?? e.compute(ke(t[1], ho), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        if (r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = te), _) {
          let V = u * d * c;
          O = t[0].reshape([1, I, V]), z = te.reshape([1, V, g]), B = [1, I, g];
        } else O = t[0].reshape([I, u * d, c]), z = te.reshape([1, c, g]), B = [I, f * b, g];
        W.push(O), W.push(z);
      } else O = t[0].reshape([I, c, u * d]), z = t[1].reshape([1, g, c]), B = [I, g, f * b], W.push(z), W.push(O);
      a && W.push(t[2]);
      let q = B[2], j = W[0].dims[W[0].dims.length - 1];
      q < 8 && j < 8 ? e.compute(Yr(W, r, i, B, o, n), { inputs: W }) : e.compute(er(W, r, i, B, o, n), { inputs: W });
      return;
    }
    let S = true, $ = e.kernelCustomData.wT ?? e.compute(ke(t[1], ho), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
    r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = $);
    let w = [t[0], $];
    a && w.push(t[2]);
    let x = o ? f * b : g, T = o ? g : f * b, k = p * m * c;
    e.compute(Nu(w, r, i, x, T, k, a, S, n), { inputs: w });
  }, wf = (e, t) => {
    ...
    Zu(e, n, d, (c) => r ? [c[0], c[2], c[3]] : [c[0], c[1], c[3]]);
  }, vf = (e, t, r) => {
    let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = go(r, t), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = Gu(t[0].dims, t[1].dims, r.strides, r.dilations, i, false, n);
    e.compute(Hu(t, o, a.outShape, [a.filterDepth, a.filterHeight, a.filterWidth], [a.padInfo.front, a.padInfo.top, a.padInfo.left], n));
  }, yo = (e, t) => {
    if (_f(e.inputs, t), e.inputs[0].dims.length === 3) wf(e, t);
    else if (e.inputs[0].dims.length === 5) vf(e, e.inputs, t);
    else {
      let r = go(t, e.inputs);
      Zu(e, e.inputs, r);
    }
...
var Xu = U(() => {
  ...
  ie();
  Yu = (e, t, r) => {
    let n = e.length > 2, o = t.outputShape, i = t.format === "NHWC", a = t.group, u = e[1].dims, d = u[2] / a, c = u[3], p = i ? me(d) : 1, m = i && c === 1 && d >= 4, f = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, b = d - f, g = i ? me(c) : 1, _ = i ? c === 1 ? p : g : 1, S = E.size(o) / g, $ = [Math.ceil(S / 64), 1, 1];
    ue("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${$}`);
    let w = ["rank", "rank"], x = [t.strides[0], t.strides[1]], T = [t.kernelShape[i ? 1 : 2], t.kernelShape[i ? 2 : 3]], k = [t.dilations[0], t.dilations[1]], I = [T[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)), T[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1))], O = [I[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2), I[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2)], z = [{ type: 12, data: S }, { type: 12, data: x }, { type: 12, data: T }, { type: 12, data: k }, { type: 12, data: I }, { type: 6, data: O }, { type: 12, data: f }, { type: 12, data: d }, { type: 12, data: c }, ...N(e[0].dims, e[1].dims)];
    n && (z.push(...N(e[2].dims)), w.push("rank")), z.push(...N(o));
    let B = (W) => {
      let q = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: x.length }, { name: "filter_dims", type: "u32", length: T.length }, { name: "dilations", type: "u32", length: T.length }, { name: "effective_filter_dims", type: "u32", length: I.length }, { name: "pads", type: "i32", length: O.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], j = ye(e[0].dataType), te = i ? 1 : 2, V = i ? 2 : 3, de = i ? 3 : 1, J = P("W", e[1].dataType, e[1].dims.length, _), H = P("Dy", e[0].dataType, e[0].dims.length, p), ae = [H, J];
      n && ae.push(P("bias", e[2].dataType, [o[de]].length, g));
      let Z = M("result", e[0].dataType, o.length, g), re = () => {
        let ee = "";
        if (m) p === 4 ? ee += `
        ...
        if (p === 1) {
          ee += "dotProd = dotProd";
          for (let C = 0; C < b; C++) ee += `
            + ${H.getByOffset(`x_offset + ${C}`)} * ${J.getByOffset(`w_offset + ${C}`)}`;
          ee += ";";
        } else if (p === 2) {
    ...
    return { name: "ConvTranspose2D", shaderCache: { hint: `${t.cacheKey};${p}${_}${g}${m}${b}`, inputDependencies: w }, getRunData: () => ({ dispatchGroup: { x: $[0], y: $[1], z: $[2] }, outputs: [{ dims: r ? r(o) : o, dataType: e[0].dataType }], programUniforms: z }), getShaderSource: B };
  };
});
var $f;
var xf;
...
var nd = U(() => {
  ...
  $f = (e, t, r, n, o, i) => (e - 1) * t + r + (n - 1) * o + 1 - i, xf = (e, t, r, n, o) => {
    ...
    for (let g = 0, _ = e.length - p - (u ? 1 : 0); g < p; ++g, ++_) {
      let S = e[_], $ = m ? S * a[g] : c[g], w = $f(S, a[g], i[g], t[_], r[g], $);
      xf(w, n, i, g, g + p), m && c.push(a[g] * (S - 1) + d[g] + (t[_] - 1) * r[g] + 1 - i[g] - i[g + p]);
    }
    ...
    Sf(u, r, d, e.autoPad, e.group, o, c, n, a, i);
    let p = Object.assign({}, e);
    return Object.assign(p, { kernelShape: r, pads: o, outputPadding: a, outputShape: i, dilations: d, strides: c }), p;
  }, ed = (e) => {
    let t = Zr(e), r = e.format, n = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][typeof e.autoPad > "u" ? 0 : e.autoPad], o = e.dilations, i = e.group, a = e.kernelShape, u = e.pads, d = e.strides, c = e.wIsConst(), p = e.outputPadding, m = e.outputShape;
    ...
    let o = e.kernelCustomData.wT ?? e.compute(ke(t[1], [2, 3, 0, 1]), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
    r.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = o);
    let i = [t[0], o];
    t.length === 3 && i.push(t[2]), e.compute(Yu(i, r, n), { inputs: i });
  }, If = (e, t) => {
    let r = t.format === "NHWC", n = [e.inputs[0].reshape(r ? [e.inputs[0].dims[0], 1, e.inputs[0].dims[1], e.inputs[0].dims[2]] : [e.inputs[0].dims[0], e.inputs[0].dims[1], 1, e.inputs[0].dims[2]]), e.inputs[1].reshape([e.inputs[1].dims[0], e.inputs[1].dims[1], 1, e.inputs[1].dims[2]])];
    e.inputs.length === 3 && n.push(e.inputs[2]);
    let o = t.kernelShape;
    ...
    d = [0].concat(d);
    let c = Ju({ ...t, pads: u, strides: a, dilations: i, kernelShape: o, outputPadding: d }, n);
    td(e, n, c, (p) => r ? [p[0], p[2], p[3]] : [p[0], p[1], p[3]]);
  }, rd = (e, t) => {
    if (Tf(e.inputs, t), e.inputs[0].dims.length === 3) If(e, t);
    else {
      let r = Ju(t, e.inputs);
      td(e, e.inputs, r);
    }
...
var ad = U(() => {
  ...
  ie();
  Cf = (e, t, r, n) => {
    let o = E.size(t), i = t.length, a = P("input", e, i), u = M("output", e, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = E.normalizeAxis(d, i), p = (m) => {
    ...
    e.compute(Cf(n, r, o, t), { inputs: [0] });
  }, id = (e) => {
    let t = e.exclusive === 1, r = e.reverse === 1;
    return X({ exclusive: t, reverse: r });
  };
});
var Af;
var kf;
...
`);
  ...
  ${$.mainStart()}
    ...
    return { name: "DepthToSpace", shaderCache: { hint: `${e.dims};${t.blocksize};${t.mode}`, inputDependencies: ["rank"] }, getRunData: ($) => {
      let w = d ? [r, n * c, o * c, i / c ** 2] : [r, i / c ** 2, n * c, o * c], x = E.size(w), T = m.dims, k = E.sortBasedOnPerm(T, u);
      return { outputs: [{ dims: w, dataType: $[0].dataType }], dispatchGroup: { x: Math.ceil(x / 64) }, programUniforms: [{ type: 12, data: x }, ...N(T, k)] };
    }, getShaderSource: S };
  }, sd = (e, t) => {
    Af(e.inputs), e.compute(Ef(e.inputs[0], t));
  }, ud = (e) => X({ blocksize: e.blocksize, mode: e.mode, format: e.format });
});
var _o;
var tn;
var ld;
...
var fd = U(() => {
  ...
  Se();
  ie();
  _o = "[a-zA-Z]|\\.\\.\\.", tn = "(" + _o + ")+", ld = "^" + tn + "$", Pf = "(" + tn + ",)*" + tn, Of = "^" + Pf + "$", wo = class {
    constructor(t = -1) {
    ...
    constructor(t, r) {
      ...
      if (!n.match(RegExp(Of))) throw new Error("Invalid LHS term");
      if (n.split(",").forEach((u, d) => {
        let c = t[d].dims.slice();
        if (!u.match(RegExp(ld))) throw new Error("Invalid LHS term");
      ...
      (_a2 = o.match(RegExp(_o, "g"))) == null ? void 0 : _a2.forEach((u) => {
    ...
    processTerm(t, r, n, o = -1) {
      ...
      return c == null ? void 0 : c.forEach((m, f) => {
        if (m === "...") {
  ...
  }, cd = (e) => e + "_max", zf = (e, t, r, n) => {
    let i = e.map((p) => p.length).map((p, m) => P(`input${m}`, t, p)), a = E.size(n), u = M("output", t, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
      let m = [], f = "var prod = 1.0;", b = "var sum = 0.0;", g = "sum += prod;", _ = [], S = [], $ = [], w = [], x = r.symbolToInfo.size === r.rhs.symbolToIndices.size;
      r.symbolToInfo.forEach((k, I) => {
        var _a2;
        if (r.rhs.symbolToIndices.has(I)) {
          let O = (_a2 = r.rhs.symbolToIndices.get(I)) == null ? void 0 : _a2[0];
          O !== void 0 && r.lhs.forEach((z, B) => {
            if (k.inputIndices.includes(B)) {
              let W = z.symbolToIndices.get(I);
              if (W === void 0) throw new Error("Invalid symbol error");
              W.forEach((q) => {
                m.push(`${i[B].indicesSet(`input${B}Indices`, q, u.indicesGet("outputIndices", O))}`);
              });
            }
          });
        } else r.lhs.forEach((O, z) => {
          if (k.inputIndices.includes(z)) {
            let B = O.symbolToIndices.get(I);
            if (B === void 0) throw new Error("Invalid symbol error");
            B.forEach((W) => {
              _.push(`${i[z].indicesSet(`input${z}Indices`, W, `${I}`)}`);
            }), w.push(`prod *= ${i[z].getByIndices(`input${z}Indices`)};`);
          }
        }), S.push(`for(var ${I}: u32 = 0; ${I} < uniforms.${cd(I)}; ${I}++) {`), $.push("}");
      });
      let T = x ? [...m, `let sum = ${i.map((k, I) => k.getByIndices(`input${I}Indices`)).join(" * ")};`] : [...m, b, ...S, ..._, f, ...w, g, ...$];
      return `
...
`)};
    ...
    return { name: "Einsum", shaderCache: { hint: r.equation, inputDependencies: e.map(() => "rank") }, getRunData: () => {
      let p = d.filter((f) => r.symbolToInfo.has(f)).map((f) => {
        var _a2;
        return { type: 12, data: ((_a2 = r.symbolToInfo.get(f)) == null ? void 0 : _a2.dimValue) || 0 };
      });
    ...
    e.compute(zf(o, e.inputs[0].dataType, r, n));
  }, md = (e) => {
...
var bd = U(() => {
  ...
  Df = (e) => {
    ...
    return n;
  }, Bf = (e, t) => e.length > t.length ? hd(e, t) : hd(t, e), Mf = (e) => {
    let t = e[0].dims, r = Array.from(e[1].getBigInt64Array(), Number), n = Bf(t, r), o = e[0].dataType, i = o === 9 || E.size(t) === 1, a = o === 9 || t.length > 0 && t[t.length - 1] % 4 === 0 ? 4 : 1, u = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, d = Math.ceil(E.size(n) / u), c = (m) => {
    ...
    Df(e.inputs), e.compute(Mf(e.inputs), { inputs: [0] });
  };
});
var Rf;
var yd;
var _d = U(() => {
  ...
  jr();
  Rf = (e) => {
    let t = e[0].dataType, r = E.size(e[0].dims), n = E.size(e[1].dims), o = n % 4 === 0, i = (a) => {
    ...
    return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (a) => ({ outputs: [{ dims: a[0].dims, dataType: a[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(r / 4) }, { type: 12, data: n }], dispatchGroup: { x: Math.ceil(r / kt / 4) } }) };
  }, yd = (e) => {
    e.inputs.length < 2 || E.size(e.inputs[1].dims) === 0 ? fu(e) : e.compute(Rf(e.inputs));
  };
});
var Uf;
var Nf;
...
var $d = U(() => {
  ...
  Uf = (e) => {
    ...
    let r = e[0].dims, n = e[1].dims, o = r.length, i = E.normalizeAxis(t.axis, o), a = r.slice(0);
    a.splice(i, 1, ...n);
    let u = r[i], d = e[0].dataType === 9 ? 4 : 1, c = Math.ceil(E.size(a) / d), p = [{ type: 12, data: c }, { type: 6, data: u }, { type: 12, data: i }, ...N(e[0].dims, e[1].dims, a)], m = (f) => {
      let b = P("data", e[0].dataType, e[0].dims.length, d), g = P("inputIndices", e[1].dataType, e[1].dims.length), _ = M("output", e[0].dataType, a.length, d), S = (w) => {
        let x = n.length, T = `var indicesIndices${w}  = ${g.type.indices}(0);`;
        for (let k = 0; k < x; k++) T += `${x > 1 ? `indicesIndices${w}[${k}]` : `indicesIndices${w}`} = ${a.length > 1 ? `outputIndices${w}[uniforms.axis + ${k}]` : `outputIndices${w}`};`;
        T += `
        ...
        `;
        for (let k = 0, I = 0; k < o; k++) k === i ? (T += `${o > 1 ? `dataIndices${w}[${k}]` : `dataIndices${w}`} = u32(idx${w});`, I += x) : (T += `${o > 1 ? `dataIndices${w}[${k}]` : `dataIndices${w}`} = ${a.length > 1 ? `outputIndices${w}[${I}]` : `outputIndices${w}`};`, I++);
        return T;
      }, $;
      if (e[0].dataType === 9) {
        let w = (x, T, k = "") => `
...
var Td = U(() => {
  ...
  ${f.mainStart()}
    ...
    let r = e.inputs, n = r[0].dims, o = r[0].dataType, i = r[1].dims, a = i[i.length - 1], u = E.sizeToDimension(i, i.length - 1), d = E.sizeFromDimension(n, t.batchDims + a), c = E.sizeToDimension(n, t.batchDims), p = E.sizeFromDimension(n, t.batchDims), m = u / c, f = new Array(a), b = d;
    for (let T = 0; T < a; ++T) f[a - 1 - T] = b, b *= n[t.batchDims + a - 1 - T];
    let g = Vf(e, r[1], f, t.batchDims, n, u, m, p, a), _ = t.batchDims + a;
    if (_ > n.length) throw new Error("last dimension of indices must not be larger than rank of input tensor");
    let S = i.slice(0, -1).concat(n.slice(_)), $ = E.size(S), w = [{ type: 12, data: $ }, { type: 12, data: d }, ...N(r[0].dims, g.dims, S)], x = (T) => {
      let k = P("data", r[0].dataType, r[0].dims.length), I = P("slice_offsets", 12, g.dims.length), O = M("output", r[0].dataType, S.length);
      return `
    ...
    e.compute({ name: "GatherND", shaderCache: { hint: t.cacheKey, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: S, dataType: o }], dispatchGroup: { x: Math.ceil($ / 64) }, programUniforms: w }), getShaderSource: x }, { inputs: [r[0], g] });
...
var Ad = U(() => {
  ...
  Wf = (e, t) => {
    ...
    let r = E.normalizeAxis(t.quantizeAxis, e[0].dims.length), n = t.blockSize, o = e[0], i = e[2], a = e.length === 4 ? e[3] : void 0;
    ...
    let r = e[0].dims, n = e[1].dims, o = r.length, i = E.normalizeAxis(t.gatherAxis, o), a = E.normalizeAxis(t.quantizeAxis, o), u = r.slice(0);
    u.splice(i, 1, ...n);
    let d = E.size(u), c = e[2].dataType, m = e[0].dataType === 22, f = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }, { type: 12, data: t.blockSize }, ...N(...e.map((g, _) => g.dims), u)], b = (g) => {
      let _ = P("data", e[0].dataType, e[0].dims.length), S = P("inputIndices", e[1].dataType, e[1].dims.length), $ = P("scales", e[2].dataType, e[2].dims.length), w = e.length > 3 ? P("zeroPoint", e[3].dataType, e[3].dims.length) : void 0, x = M("output", c, u.length), T = [_, S, $];
      w && T.push(w);
      let k = [{ name: "output_size", type: "u32" }, { name: "quantize_axis", type: "u32" }, { name: "gather_axis", type: "u32" }, { name: "block_size", type: "u32" }];
      return `
    ...
    let r = e.inputs;
    Wf(r, t), e.compute(Lf(e.inputs, t));
  }, Cd = (e) => X({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
});
var Gf;
var Hf;
var kd;
...
var Pd = U(() => {
  ...
  Gf = (e) => {
    ...
    let r = e[0].dims, n = e[0].dataType, o = r.length, i = e[1].dims, a = e[1].dataType, u = E.normalizeAxis(t.axis, o), d = r[u], c = i.slice(0), p = E.size(c), m = P("input", n, o), f = P("indicesInput", a, i.length), b = M("output", n, c.length), g = [{ type: 12, data: p }, { type: 6, data: d }, { type: 12, data: u }];
  ...
  }, kd = (e) => X({ axis: e.axis }), Ed = (e, t) => {
    let r = e.inputs;
    Gf(r), e.compute(Hf(e.inputs, t));
  };
});
var Ff;
var qf;
...
var Dd = U(() => {
  ...
  Ff = (e) => {
    ...
    let r = e[0].dims.slice(), n = e[1].dims.slice(), [o, i, a] = Br.getShapeOfGemmResult(r, t.transA, n, t.transB, e.length === 3 ? e[2].dims : void 0), u = [o, i];
    if (!u) throw new Error("Can't use gemm on the given tensors");
    let d = 16, c = Math.ceil(i / d), p = Math.ceil(o / d), m = true, f = E.size(u), b = [{ type: 12, data: m ? c : f }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: a }, { type: 1, data: t.alpha }, { type: 1, data: t.beta }], g = ["type", "type"];
    ...
    let _ = ($) => {
      ...
      let x = t.alpha === 1 ? "" : "value *= uniforms.alpha;", T = P("a", e[0].dataType, e[0].dims), k = P("b", e[1].dataType, e[1].dims), I = T.type.value, O = null, z = [T, k];
      e.length === 3 && (O = P("c", e[2].dataType, e[2].dims.length), z.push(O));
      let B = M("output", e[0].dataType, u.length);
      z.push(B);
      let W = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }];
      return `
  ...
  ${$.mainStart()}
    ...
    output[global_idx] = value;
      ...
      let w = P("a", e[0].dataType, e[0].dims), x = P("b", e[1].dataType, e[1].dims), T = null, k = [w, x];
      e.length === 3 && (T = P("c", e[2].dataType, e[2].dims.length), k.push(T));
      let I = M("output", e[0].dataType, u.length);
      k.push(I);
      let O = [{ name: "num_tile_n", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }], z = "", B = "";
      t.transA && t.transB ? (B = `
      ...
      `, z = "value += tile_a[local_id.y][k] * tile_b[k][local_id.x];");
  ...
  ${$.mainStart([d, d, 1])}
    ...
    Ff(e.inputs), e.compute(qf(e.inputs, t));
  };
});
var dt;
var $t;
...
`, Jf = (e, t, r) => (() => {
  ...
  })() + `${e.setByOffset("global_idx", "result")}`, eh = (e, t) => {
    ...
    t.format === "NHWC" && (i = [e[0].dims[0], e[1].dims[1], e[1].dims[2], e[0].dims[3]], [dt, $t, Vt, Wt] = [0, 3, 1, 2]);
    let a = M("output", e[0].dataType, i.length), u = r.type.value, d = E.size(i), c = [{ type: 12, data: d }, ...N(e[0].dims, n, i)], p = (m) => `
  ...
  ${m.mainStart()}
    ...
    Kf(e.inputs), e.compute(eh(e.inputs, t));
  }, Md = (e) => X({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
});
var Be;
var nh;
var Nd;
...
var $o = U(() => {
  ...
  ie();
  ut();
  Be = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, nh = (e, t) => {
    ...
    if (a && E.size(a.dims) > 0) {
      x = 8;
      let O = a.dims;
      throw O.length === 1 ? O[0] === p ? x = 1 : O[0] === 3 * p + 2 && (x = 3) : O.length === 2 && O[0] === p && O[1] === w && (x = 5), x === 8 ? new Error('Input "key_padding_mask" shape shall be (batch_size) or (batch_size, total_sequence_length)') : new Error("Mask not supported");
    }
    let T = false, k = f;
    if (o && E.size(o.dims) > 0) {
      ...
      if (o.dims.length === 3) {
        ...
        k = o.dims[1] * o.dims[3], T = true;
      }
    }
    let I = false;
    if (a && E.size(a.dims) > 0) throw new Error("Key padding mask is not supported");
    if (u && E.size(u.dims) > 0) {
      if (u.dims.length !== 4) throw new Error('Input "attention_bias" is expected to have 4 dimensions');
      if (u.dims[0] !== p || u.dims[1] !== t.numHeads || u.dims[2] !== m || u.dims[3] !== w) throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)');
    }
    return { batchSize: p, sequenceLength: m, pastSequenceLength: g, kvSequenceLength: b, totalSequenceLength: w, maxSequenceLength: _, inputHiddenSize: 0, hiddenSize: f, vHiddenSize: k, headSize: S, vHeadSize: Math.floor(k / t.numHeads), numHeads: t.numHeads, isUnidirectional: false, pastPresentShareBuffer: false, maskFilterValue: t.maskFilterValue, maskType: x, scale: t.scale, broadcastResPosBias: I, passPastInKv: T, qkvFormat: $ };
  }, Nd = (e) => X({ ...e }), Ud = X({ perm: [0, 2, 1, 3] }), oh = (e, t, r, n, o, i, a) => {
    let u = [n, o, i], d = E.size(u), c = [{ type: 12, data: d }, { type: 12, data: a }, { type: 12, data: i }], p = (m) => {
  ...
  ${m.mainStart()}
    ...
    if (a && E.size(a.dims) > 0) {
      ...
      return d = oh(e, i, a, t, n, r * o, u), d = d.reshape([t, n, r, o]), r === 1 || n === 1 ? d : e.compute(ke(d, Ud.perm), { inputs: [d], outputs: [-1] })[0];
    } else return i.dims.length === 3 && (d = i.reshape([t, n, r, o])), r === 1 || n === 1 ? d : e.compute(ke(d, Ud.perm), { inputs: [d], outputs: [-1] })[0];
  }, Vd = (e, t) => {
    let r = nh(e.inputs, t), n = e.inputs[0], o = Be(e.inputs, 1), i = Be(e.inputs, 2), a = Be(e.inputs, 3), u = Be(e.inputs, 4), d = Be(e.inputs, 5), c = Be(e.inputs, 6), p = Be(e.inputs, 7);
    ...
    let m = o && i && o.dims.length === 4 && i.dims.length === 4, f = tr(e, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, a, 0);
    if (m) return Nt(e, f, o, i, u, void 0, c, p, d, r);
    if (!o || !i) throw new Error("key and value must be provided");
    let b = tr(e, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, a, r.hiddenSize), g = tr(e, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, a, 2 * r.hiddenSize);
    Nt(e, f, b, g, u, void 0, c, p, d, r);
  };
});
var ih;
var ah;
...
var So = U(() => {
  ...
  ih = (e) => {
    ...
    return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => r.push(Number(o))), n = r.length), X({ numOutputs: n, axis: t.axis, splitSizes: r });
  }, sh = (e) => `
...
`)}
    ...
    let r = e[0].dims, n = E.size(r), o = e[0].dataType, i = E.normalizeAxis(t.axis, r.length), a = new Array(t.numOutputs), u = P("input", o, r.length), d = new Array(t.numOutputs), c = [], p = [], m = 0, f = [{ type: 12, data: n }];
  ...
  ${g.mainStart()}
    ...
    ih(e.inputs);
    let r = e.inputs.length === 1 ? t : ah(e.inputs, t);
    ...
    return X({ axis: t, numOutputs: n, splitSizes: r });
  };
});
var dh;
var rn;
...
var To = U(() => {
  ...
  dh = (e, t) => {
    ...
    if (!E.areEqual(o.dims, i.dims)) throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");
    if (u > 0 && a === 0) throw new Error("num_heads must be provided if rotary_embedding_dim is specified");
    let d = r.dims[0], c = r.dims[r.dims.length - 2], p = o.dims[0], m = E.sizeFromDimension(r.dims, 1) / c, f = u === 0 ? o.dims[1] * 2 : m / a;
    ...
    let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = t, a = e[0].dims[0], u = E.sizeFromDimension(e[0].dims, 1), d = e[0].dims[e[0].dims.length - 2], c = u / d, p = e[2].dims[1], m = o === 0 ? p * 2 : c / n, f = new Array(a, d, c / m, m - p), b = E.computeStrides(f), g = [{ type: 1, data: i }, { type: 12, data: f }, { type: 12, data: b }, ...e[0].dims.length === 3 ? new Array({ type: 12, data: [u, c, m, 1] }) : [], ...e[0].dims.length === 4 ? new Array({ type: 12, data: [u, m, d * m, 1] }) : [], ...N(e[0].dims, e[1].dims, e[2].dims, e[3].dims, e[0].dims)], _ = (S) => {
      let $ = P("input", e[0].dataType, e[0].dims.length), w = P("position_ids", e[1].dataType, e[1].dims.length), x = P("cos_cache", e[2].dataType, e[2].dims.length), T = P("sin_cache", e[3].dataType, e[3].dims.length), k = M("output", e[0].dataType, e[0].dims.length);
    ...
    return { name: "RotaryEmbedding", shaderCache: { hint: X({ interleaved: r }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: _, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(E.size(f) / kt) }, programUniforms: g }) };
  }, Gd = (e, t) => {
    dh(e.inputs, t), e.compute(rn(e.inputs, t));
  };
});
var lh;
var ch;
...
var qd = U(() => {
  ...
  lh = (e, t) => {
    ...
    let x = 0, T = false, k = t.kvNumHeads ? g * t.kvNumHeads : p;
    ...
    return { batchSize: d, sequenceLength: c, pastSequenceLength: f, kvSequenceLength: m, totalSequenceLength: -1, maxSequenceLength: -1, inputHiddenSize: 0, hiddenSize: p, vHiddenSize: k, headSize: g, vHeadSize: Math.floor(k / t.kvNumHeads), numHeads: t.numHeads, kvNumHeads: t.kvNumHeads, nReps: t.numHeads / t.kvNumHeads, pastPresentShareBuffer: false, maskType: x, scale: t.scale, broadcastResPosBias: false, passPastInKv: T, qkvFormat: w };
  }, ch = X({ perm: [0, 2, 1, 3] }), Hd = (e, t, r) => {
    let n = t, o = r.kvNumHeads;
    return t.dims.length === 3 && r.kvSequenceLength !== 0 && (n = t.reshape([r.batchSize, r.kvSequenceLength, o, r.headSize]), n = e.compute(ke(n, ch.perm), { inputs: [n], outputs: [-1] })[0]), n;
  }, ph = (e, t, r, n) => {
  ...
  `;
    ...
    let n = e.inputs[0], o = e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0, i = e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0, a = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, u = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, d = e.inputs.length > 4 ? e.inputs[5] : void 0, c = e.inputs.length > 5 ? e.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = X({ axis: 2, numOutputs: 3, splitSizes: [r.numHeads * r.headSize, p * r.headSize, p * r.headSize] }), [f, b, g] = !o && !i ? e.compute(xo([n], m), { inputs: [n], outputs: [-1, -1, -1] }) : [n, o, i], _, S;
    if (t.doRotary) {
      let T = e.compute(ph(r.batchSize, r.sequenceLength, d, c), { inputs: [d, c], outputs: [-1] })[0], k = e.inputs[7], I = e.inputs[8], O = X({ interleaved: t.rotaryInterleaved !== 0, numHeads: r.numHeads, rotaryEmbeddingDim: 0, scale: t.scale }), z = [f, T, k, I], B = [-1];
      _ = e.compute(rn(z, O), { inputs: z, outputs: B })[0], z.splice(0, 1, b);
      let W = X({ interleaved: t.rotaryInterleaved !== 0, numHeads: r.kvNumHeads, rotaryEmbeddingDim: 0, scale: t.scale });
      S = e.compute(rn(z, W), { inputs: z, outputs: B })[0];
    }
    let $ = tr(e, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, t.doRotary ? _ : f, void 0, 0), w = Hd(e, t.doRotary ? S : b, r), x = Hd(e, g, r);
    Nt(e, $, w, x, void 0, void 0, a, u, void 0, r, d, c);
  };
});
var Kd;
var mh;
...
var Zd = U(() => {
  ...
  ie();
  Kd = (e, t, r, n, o, i, a, u) => {
    let d = me(i), c = d === 1 ? "f32" : `vec${d}f`, p = d === 1 ? "vec2f" : `mat2x${d}f`, m = o * a, f = 64;
    m === 1 && (f = 256);
    let b = [o, a, i / d], g = [o, a, 2], _ = ["rank", "type", "type"], S = [];
    S.push(...N(b, g));
    let $ = (w) => {
      let x = P("x", t.dataType, 3, d), T = P("scale", r.dataType, r.dims), k = P("bias", n.dataType, n.dims), I = M("output", 1, 3, 2), O = [x, T, k, I];
      return `
  ...
  ${w.mainStart(f)}
    ...
    let n = t[0].dims, o = n, i = 2, a = n[0], u = n[1], d = E.sizeFromDimension(n, i), c = me(d), p = E.size(o) / c, m = Kd(e, t[0], t[1], t[2], a, d, u, r.epsilon), f = [a, u, d / c], b = [a, u], g = ["type", "none"], _ = (S) => {
      let $ = P("x", t[0].dataType, f.length, c), w = P("scale_shift", 1, b.length, 2), x = M("output", t[0].dataType, f.length, c), T = [$, w, x];
      return `
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    ...
    let n = t[0].dims, o = n, i = n[0], a = n[n.length - 1], u = E.sizeFromDimension(n, 1) / a, d = me(a), c = E.size(o) / d, p = [{ type: 12, data: u }, { type: 12, data: Math.floor(a / d) }], m = ["type", "type"], f = false, b = [0, n.length - 1];
    for (let $ = 0; $ < n.length - 2; $++) f = f || n[$ + 1] !== 1, b.push($ + 1);
    f = f && n[n.length - 1] !== 1;
    let g = f ? e.compute(ke(e.inputs[0], b), { inputs: [e.inputs[0]], outputs: [-1] })[0] : e.inputs[0].reshape(Array.from({ length: n.length }, ($, w) => n[b[w]])), _ = Kd(e, g, t[1], t[2], i, u, a, r.epsilon), S = ($) => {
      let w = ye(t[0].dataType), x = d === 1 ? "vec2f" : `mat${d}x2f`, T = (O) => {
        let z = O === 0 ? "x" : "y", B = d === 1 ? "f32" : `vec${d}f`;
        switch (d) {
          case 1:
            return `${w}(${B}(scale.${z}))`;
          case 2:
            return `vec2<${w}>(${B}(scale[0].${z}, scale[1].${z}))`;
          case 4:
            return `vec4<${w}>(${B}(scale[0].${z}, scale[1].${z}, scale[2].${z}, scale[3].${z}))`;
          default:
            throw new Error(`Not supported compoents ${d}`);
        }
      }, k = P("input", t[0].dataType, t[0].dims, d), I = M("output", t[0].dataType, o, d);
      return `
  ...
  ${$.mainStart()}
    ...
    t.format === "NHWC" ? fh(e, e.inputs, t) : mh(e, e.inputs, t);
  };
});
var hh;
var gh;
...
var Yd = U(() => {
  ...
  hh = (e) => {
    ...
    let n = t.simplified, o = e[0].dims, i = e[1], a = !n && e[2], u = o, d = E.normalizeAxis(t.axis, o.length), c = E.sizeToDimension(o, d), p = E.sizeFromDimension(o, d), m = E.size(i.dims), f = a ? E.size(a.dims) : 0;
    if (m !== p || a && f !== p) throw new Error(`Size of X.shape()[axis:] == ${p}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${m} and bias size of ${f}`);
    let b = [];
    for (let k = 0; k < o.length; ++k) k < d ? b.push(o[k]) : b.push(1);
    let g = me(p), _ = ["type", "type"], S = [{ type: 12, data: c }, { type: 1, data: p }, { type: 12, data: Math.floor(p / g) }, { type: 1, data: t.epsilon }];
    a && _.push("type");
    let $ = r > 1, w = r > 2, x = (k) => {
      let I = ye(e[0].dataType), O = [P("x", e[0].dataType, e[0].dims, g), P("scale", i.dataType, i.dims, g)];
      a && O.push(P("bias", a.dataType, a.dims, g)), O.push(M("output", e[0].dataType, u, g)), $ && O.push(M("mean_data_output", 1, b)), w && O.push(M("inv_std_output", 1, b));
  ...
  ${k.mainStart()}
    ...
    return $ && T.push({ dims: b, dataType: 1 }), w && T.push({ dims: b, dataType: 1 }), { name: "LayerNormalization", shaderCache: { hint: `${g};${r};${n}`, inputDependencies: _ }, getRunData: () => ({ outputs: T, dispatchGroup: { x: Math.ceil(c / 64) }, programUniforms: S }), getShaderSource: x };
  }, Qd = (e, t) => {
    hh(e.inputs), e.compute(gh(e.inputs, t, e.outputCount));
  };
});
var bh;
var Xd;
var Jd = U(() => {
  ...
  bh = (e) => {
    ...
    bh(e.inputs);
    let t = et.calcShape(e.inputs[0].dims, e.inputs[1].dims, true);
    ...
    if (r < 8 && n < 8) e.compute(Yr(e.inputs, { activation: "" }, t));
      ...
      let o = t[t.length - 2], i = E.size(e.inputs[0].dims.slice(0, -2)), a = E.size(e.inputs[1].dims.slice(0, -2));
      if (i !== 1 && o === 1 && a === 1) {
        let u = e.inputs[0].reshape([1, i, n]), d = e.inputs[1].reshape([1, n, r]), c = [1, i, r], p = [u, d];
        e.compute(er(p, { activation: "" }, t, c), { inputs: p });
      } else e.compute(er(e.inputs, { activation: "" }, t));
    }
  };
});
var yh;
...
var rl = U(() => {
  ...
  yh = (e, t) => {
    ...
    if (!E.areEqual(a.dims, [t.n, o, i])) throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");
    let d = e[2].dims;
    if (E.size(d) !== t.n * o) throw new Error("scales input size error.");
    if (e.length === 4) {
      let p = e[3].dims, m = t.bits > 4 ? t.n * o : t.n * Math.floor((o + 1) / 2);
      if (E.size(p) !== m) throw new Error("zeroPoints input size error.");
    }
  }, _h = (e, t) => {
    let r = e[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, u = r.slice(0, n - 2), d = E.size(u), p = e[1].dims[2] / 4, m = e[0].dataType, f = me(t.k), b = me(p), g = me(a), _ = u.concat([o, a]), S = o > 1 && a / g % 2 === 0 ? 2 : 1, $ = E.size(_) / g / S, w = 64, x = [], T = [d, o, i / f], k = E.convertShape(e[1].dims).slice();
    k.splice(-1, 1, p / b), x.push(...N(T)), x.push(...N(k)), x.push(...N(e[2].dims)), e.length === 4 && x.push(...N(E.convertShape(e[3].dims)));
    let I = [d, o, a / g];
    x.push(...N(I));
    let O = (z) => {
      let B = T.length, W = P("a", e[0].dataType, B, f), q = P("b", 12, k.length, b), j = P("scales", e[2].dataType, e[2].dims.length), te = [W, q, j], V = e.length === 4 ? P("zero_points", 12, e[3].dims.length) : void 0;
      V && te.push(V);
      let de = I.length, J = M("output", e[0].dataType, de, g), H = ye(e[0].dataType), ae = (() => {
        switch (f) {
          case 1:
            return `array<${H}, 8>`;
          case 2:
        ...
        return _e += `
            ...
            var b_dequantized_values: ${ae};`, _e;
      };
      return `
    ...
    return { name: "MatMulNBits", shaderCache: { hint: `${t.blockSize};${t.bits};${f};${b};${g};${S};${w}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: _, dataType: m }], dispatchGroup: { x: $ }, programUniforms: x }), getShaderSource: O };
  }, wh = (e, t) => {
    let r = e[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, u = r.slice(0, n - 2), d = E.size(u), p = e[1].dims[2] / 4, m = e[0].dataType, f = me(t.k), b = me(p), g = u.concat([o, a]), _ = 128, S = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, $ = _ / S, w = $ * b * 8, x = w / f, T = w / t.blockSize, k = E.size(g) / S, I = [], O = [d, o, i / f], z = E.convertShape(e[1].dims).slice();
    z.splice(-1, 1, p / b), I.push(...N(O)), I.push(...N(z)), I.push(...N(e[2].dims)), e.length === 4 && I.push(...N(E.convertShape(e[3].dims)));
    let B = [d, o, a];
    I.push(...N(B));
    let W = (q) => {
      let j = O.length, te = P("a", e[0].dataType, j, f), V = P("b", 12, z.length, b), de = P("scales", e[2].dataType, e[2].dims.length), J = [te, V, de], H = e.length === 4 ? P("zero_points", 12, e[3].dims.length) : void 0;
      H && J.push(H);
      let ae = B.length, Z = M("output", e[0].dataType, ae), re = ye(e[0].dataType), ve = () => {
        switch (f) {
          case 1:
            return `
          let a_data0 = vec4<${re}>(sub_a[word_offset], sub_a[word_offset + 1], sub_a[word_offset + 2], sub_a[word_offset + 3]);
          let a_data1 = vec4<${re}>(sub_a[word_offset + 4], sub_a[word_offset + 5], sub_a[word_offset + 6], sub_a[word_offset + 7]);`;
          case 2:
            return `
          let a_data0 = vec4<${re}>(sub_a[word_offset], sub_a[word_offset + 1]);
          let a_data1 = vec4<${re}>(sub_a[word_offset + 2], sub_a[word_offset + 3]);`;
          case 4:
            return `
    ...
    return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${t.blockSize};${f};${b};${$};${S}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: g, dataType: m }], dispatchGroup: { x: k }, programUniforms: I }), getShaderSource: W };
  }, el = (e, t) => {
    yh(e.inputs, t), t.blockSize === 32 && e.adapterInfo.isVendor("intel") && e.adapterInfo.isArchitecture("gen-12lp") ? e.compute(wh(e.inputs, t)) : e.compute(_h(e.inputs, t));
  }, tl = (e) => X(e);
});
var vh;
var $h;
...
var ol = U(() => {
  ...
  vh = (e) => {
    ...
    switch (r.mode) {
      ...
      case 2:
        return Sh(e, t, r.pads.length);
      case 3:
        return Th(e, t, r.pads.length);
      default:
        throw new Error("Invalid mode");
    }
  }, Ch = (e, t) => {
    let r = E.padShape(e[0].dims.slice(), t.pads), n = e[0].dims, o = E.size(r), i = [{ type: 12, data: o }, { type: 6, data: t.pads }], a = e.length >= 3 && e[2].data;
    t.mode === 0 && i.push({ type: a ? e[2].dataType : 1, data: t.value }), i.push(...N(e[0].dims, r));
    let u = ["rank"], d = (c) => {
      let p = M("output", e[0].dataType, r.length), m = P("x", e[0].dataType, n.length), f = m.type.value, b = Ih(p, n.length, t), g = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: t.pads.length }];
    ...
    return { name: "Pad", shaderCache: { hint: `${t.mode}${a}`, inputDependencies: u }, getRunData: () => ({ outputs: [{ dims: r, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(E.size(r) / 64) }, programUniforms: i }), getShaderSource: d };
  }, Ah = (e, t) => {
    if (e.length > 1) {
    ...
    vh(e.inputs);
    let r = Ah(e.inputs, t);
    e.compute(Ch(e.inputs, r), { inputs: [0] });
  };
});
var nn;
var il;
...
var vl = U(() => {
  ...
  nn = (e) => {
    ...
    At.adjustPoolAttributes(r, o, a, u, d, c);
    let p = At.computePoolOutputShape(r, o, u, d, a, c, t.autoPad), m = Object.assign({}, t);
    ...
    let r = t.format === "NHWC", n = E.size(e), o = E.size(t.kernelShape), i = [{ type: 12, data: n }, { type: 12, data: o }], a = [{ name: "outputSize", type: "u32" }, { name: "kernelSize", type: "u32" }];
  ...
  }, ul = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, kh = (e) => `${ul(e)};${e.countIncludePad}`, Eh = (e) => `${ul(e)};${e.storageOrder};${e.dilations}`, dl = (e) => ({ format: e.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], ceilMode: e.ceil_mode, kernelShape: e.kernel_shape, strides: e.strides, pads: e.pads }), ll = (e, t, r, n) => {
    let [o, i] = il(t, n, r), a = P("x", t.dataType, t.dims.length), u = a.type.value, d = "value += x_val;", c = "";
    o.countIncludePad ? c += `value /= ${u}(uniforms.kernelSize);` : c += `value /= ${u}(i32(uniforms.kernelSize) - pad);`;
    let [p, m, f, b, g] = al(i, o);
    p.push(...N(t.dims, i));
    let _ = ["rank"];
    return { name: e, shaderCache: { hint: `${n.cacheKey};${f};${b};${g}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(E.size(i) / 64) }, programUniforms: p }), getShaderSource: (S) => sl(S, a, t.dims.length, i.length, o, d, c, 0, m, f, b, g) };
  }, cl = (e) => {
    let t = e.count_include_pad !== 0, r = dl(e);
    ...
    return { ...n, cacheKey: kh(n) };
  }, pl = (e, t) => {
    nn(e.inputs), e.compute(ll("AveragePool", e.inputs[0], false, t));
  }, ml = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, fl = (e) => {
    let t = e.format;
    return { format: t, ...ml, cacheKey: t };
  }, hl = (e, t) => {
    nn(e.inputs), e.compute(ll("GlobalAveragePool", e.inputs[0], true, t));
  }, gl = (e, t, r, n) => {
    let [o, i] = il(t, n, r), a = `
      value = max(x_val, value);
    `, u = "", d = P("x", t.dataType, t.dims.length), c = ["rank"], [p, m, f, b, g] = al(i, o);
    return p.push(...N(t.dims, i)), { name: e, shaderCache: { hint: `${n.cacheKey};${f};${b};${g}`, inputDependencies: c }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(E.size(i) / 64) }, programUniforms: p }), getShaderSource: (_) => sl(_, d, t.dims.length, i.length, o, a, u, t.dataType === 10 ? -65504 : -1e5, m, f, b, g) };
  }, bl = (e, t) => {
    nn(e.inputs), e.compute(gl("MaxPool", e.inputs[0], false, t));
  }, yl = (e) => {
    let t = e.storage_order, r = e.dilations, n = dl(e);
    ...
    return { ...o, cacheKey: Eh(o) };
  }, _l = (e) => {
    let t = e.format;
    return { format: t, ...ml, cacheKey: t };
  }, wl = (e, t) => {
    nn(e.inputs), e.compute(gl("GlobalMaxPool", e.inputs[0], true, t));
  };
});
var Oh;
var zh;
...
var Sl = U(() => {
  ...
  Oh = (e, t) => {
    ...
    let r = E.normalizeAxis(t.axis, e[0].dims.length), n = e[0].dataType, o = n === 3, i = e[0].dims, a = e[1].dataType, u = E.size(i), d = n === 3 || n === 2, c = d ? [Math.ceil(E.size(e[0].dims) / 4)] : e[0].dims, p = e[1].dims, m = e.length > 2 ? e[2] : void 0, f = m ? d ? [Math.ceil(E.size(m.dims) / 4)] : m.dims : void 0, b = p.length === 0 || p.length === 1 && p[0] === 1, g = b === false && p.length === 1, _ = me(u), S = b && (!d || _ === 4), $ = S ? _ : 1, w = S && !d ? _ : 1, x = P("input", d ? 12 : n, c.length, w), T = P("scale", a, p.length), k = m ? P("zero_point", d ? 12 : n, f.length) : void 0, I = M("output", a, i.length, $), O = [x, T];
    k && O.push(k);
    let z = [c, p];
    m && z.push(f);
    let B = [{ type: 12, data: u / $ }, { type: 12, data: r }, { type: 12, data: t.blockSize }, ...N(...z, i)], W = (q) => {
      let j = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }];
      return `
    ...
    return { name: "DequantizeLinear", shaderCache: { hint: t.cacheKey, inputDependencies: k ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: W, getRunData: () => ({ outputs: [{ dims: i, dataType: a }], dispatchGroup: { x: Math.ceil(u / $ / 64), y: 1, z: 1 }, programUniforms: B }) };
  }, $l = (e, t) => {
    Oh(e.inputs, t), e.compute(zh(e.inputs, t));
  }, xl = (e) => X({ axis: e.axis, blockSize: e.blockSize });
});
var Dh;
var Bh;
var Tl;
var Il = U(() => {
  ...
  Dh = (e, t, r) => {
    ...
    let t = 0, r = 0, n = 0;
    e.inputs[0].dataType === 6 ? (t = e.inputs[0].getInt32Array()[0], r = e.inputs[1].getInt32Array()[0], n = e.inputs[2].getInt32Array()[0]) : e.inputs[0].dataType === 1 && (t = e.inputs[0].getFloat32Array()[0], r = e.inputs[1].getFloat32Array()[0], n = e.inputs[2].getFloat32Array()[0]), be.webgpu.validateInputContent && Dh(t, r, n), e.compute(Bh(t, r, n, e.inputs[0].dataType), { inputs: [] });
  };
});
var Mh;
var Cl;
...
var Pl = U(() => {
  ...
  Mh = (e, t, r, n) => {
    ...
    let r = e[0].dims, n = e[1].dims, o = r, i = 1, a = Math.ceil(E.size(n) / i), u = n[n.length - 1], d = E.sizeFromDimension(r, u), c = E.sizeFromDimension(n, 0) / u, p = [{ type: 12, data: a }, { type: 12, data: u }, { type: 12, data: d }, ...N(e[1].dims, e[2].dims, o)], m = (f) => {
      let b = P("indices", e[1].dataType, e[1].dims.length), g = P("updates", e[2].dataType, e[2].dims.length, i), _ = t.reduction !== "none" && t.reduction !== "" ? ts("output", e[0].dataType, o.length) : M("output", e[0].dataType, o.length, i);
      return `
  ...
  }, kl = (e) => X({ reduction: e.reduction }), El = (e, t) => {
    e.compute(Rh(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
  };
});
var Uh;
var Nh;
...
var Ml = U(() => {
  ...
  Uh = (e, t) => {
    ...
    if (u > 0 && e.length > u && e[u].dims.length === 1 && e[u].dims[0] > 0) {
      ...
      Uh(n, t), t.axes.length > 0 && Nh(n, t.axes, c).forEach((p, m) => n[m] = p);
    }
...
`, Wh = (e, t) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
  ...
  })() + "}", Lh = (e, t, r) => `fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {` + (() => {
    switch (e) {
...
` : "", Zh = (e, t, r, n, o) => {
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    let a = e.dims, u = Gh(i, t.axes, a.length), d = Hh(a, n, o, t.axes), c = n.slice();
    n.length === 0 && (c = a.map((w, x) => w === 0 ? 1 : d[x] / w), t.keepAspectRatioPolicy !== "stretch" && (d = Fh(a, c, t)));
    let p = M("output", e.dataType, d.length), m = P("input", e.dataType, a.length), f = E.size(d), b = a.length === d.length && a.every((w, x) => w === d[x]), g = t.coordinateTransformMode === "tf_crop_and_resize", _ = t.extrapolationValue, S = m.type.value, $ = (w) => `
      ${b ? "" : `
      ...
      switch (t.mode) {
        ...
        case "linear":
          return `
              ...
              ${(() => {
            if (a.length === 2 || a.length === 4) return `${Zh(m, p, a, g, _)}`;
            if (a.length === 3 || a.length === 5) return `${Yh(m, p, a, g, _)}`;
        ...
        case "cubic":
          return `
            ${(() => {
            if (a.length === 2 || a.length === 4) return `${Qh(m, p, a, d, c, u, t.cubicCoeffA, g, t.extrapolationValue, t.excludeOutside)}`;
...
`}
    ...
    Vh(e.inputs, t, i, r, n, o), e.compute(Xh(e.inputs[0], t, i, r, n, o), { inputs: [0] });
  }, Bl = (e) => {
    ...
    return X({ antialias: t, axes: r, coordinateTransformMode: n, cubicCoeffA: o, excludeOutside: i, extrapolationValue: a, keepAspectRatioPolicy: u, mode: d, nearestMode: c });
  };
});
var eg;
var tg;
...
var Ul = U(() => {
  ...
  eg = (e) => {
    ...
    let o = t.simplified, i = e[0].dims, a = E.size(i), u = i, d = a, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && e.length > 3, f = e.length > 4, b = n && r > 1, g = n && r > 2, _ = r > 3, S = 64, $ = me(c), w = [{ type: 12, data: d }, { type: 12, data: $ }, { type: 12, data: c }, { type: 1, data: t.epsilon }], x = (k) => {
      let I = [{ name: "output_size", type: "u32" }, { name: "components", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "epsilon", type: "f32" }], O = [P("x", e[0].dataType, e[0].dims, $), P("skip", e[1].dataType, e[1].dims, $), P("gamma", e[2].dataType, e[2].dims, $)];
      m && O.push(P("beta", e[3].dataType, e[3].dims, $)), f && O.push(P("bias", e[4].dataType, e[4].dims, $)), O.push(M("output", e[0].dataType, u, $)), b && O.push(M("mean_output", 1, p)), g && O.push(M("inv_std_output", 1, p)), _ && O.push(M("input_skip_bias_sum", e[0].dataType, u, $));
      let z = ye(e[0].dataType), B = ye(1, $);
      return `
    ...
    return r > 1 && T.push({ dims: p, dataType: 1 }), r > 2 && T.push({ dims: p, dataType: 1 }), r > 3 && T.push({ dims: i, dataType: e[0].dataType }), { name: "SkipLayerNormalization", shaderCache: { hint: `${$};${b};${g};${_}`, inputDependencies: e.map((k, I) => "type") }, getShaderSource: x, getRunData: () => ({ outputs: T, dispatchGroup: { x: Math.ceil(d / c) }, programUniforms: w }) };
  }, Rl = (e, t) => {
    eg(e.inputs);
    let n = [0];
    e.outputCount > 1 && n.push(-3), e.outputCount > 2 && n.push(-3), e.outputCount > 3 && n.push(3), e.compute(tg(e.inputs, t, e.outputCount, false), { outputs: n });
  };
});
var rg;
var on;
...
var Ll = U(() => {
  ...
  rg = (e, t) => {
    ...
    if (e.length > 1) {
      ...
      return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), X({ starts: r, ends: n, axes: o });
    } else return t;
  }, Nl = (e, t, r, n, o) => {
    let i = e;
    return e < 0 && (i += r[n[t]]), o[t] < 0 ? Math.max(0, Math.min(i, r[n[t]] - 1)) : Math.max(0, Math.min(i, r[n[t]]));
  }, og = (e, t, r) => `fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
    ...
    let r = e[0].dims, n = E.size(r), o = t.axes.length > 0 ? E.normalizeAxes(t.axes, r.length) : [...Array(r.length).keys()], i = on(e, 4);
    i.forEach(($) => $ !== 0 || (() => {
      throw new Error("step cannot be 0");
    })), i.length === 0 && (i = Array(o.length).fill(1));
    let a = t.starts.map(($, w) => Nl($, w, r, o, i)), u = t.ends.map(($, w) => Nl($, w, r, o, i));
    ...
    let p = { dims: c, dataType: e[0].dataType }, m = M("output", e[0].dataType, c.length), f = P("input", e[0].dataType, e[0].dims.length), b = E.size(c), g = [{ name: "outputSize", type: "u32" }, { name: "starts", type: "u32", length: a.length }, { name: "signs", type: "i32", length: d.length }, { name: "steps", type: "u32", length: i.length }], _ = [{ type: 12, data: b }, { type: 12, data: a }, { type: 6, data: d }, { type: 12, data: i }, ...N(e[0].dims, c)], S = ($) => `
    ...
    rg(e.inputs, t);
    let r = ng(e.inputs, t);
    e.compute(ig(e.inputs, r), { inputs: [0] });
  }, Wl = (e) => {
    let t = e.starts, r = e.ends, n = e.axes;
    return X({ starts: t, ends: r, axes: n });
  };
});
var ag;
var sg;
...
var Fl = U(() => {
  ...
  ag = (e) => {
    ...
    let r = e.inputs[0], n = r.dims, o = E.size(n), i = n.length, a = E.normalizeAxis(t.axis, i), u = a < n.length - 1, d, c = [];
    u ? (c = Array.from({ length: i }, (O, z) => z), c[a] = i - 1, c[i - 1] = a, d = e.compute(ke(r, c), { inputs: [r], outputs: [-1] })[0]) : d = r;
    let p = d.dims, m = p[i - 1], f = o / m, b = me(m), g = m / b, _ = 64;
    f === 1 && (_ = 256);
    let S = (O, z) => z === 4 ? `max(max(${O}.x, ${O}.y), max(${O}.z, ${O}.w))` : z === 2 ? `max(${O}.x, ${O}.y)` : z === 3 ? `max(max(${O}.x, ${O}.y), ${O}.z)` : O, $ = P("x", d.dataType, d.dims, b), w = M("result", d.dataType, d.dims, b), x = $.type.value, T = ye(d.dataType) === "f32" ? `var threadMax = ${x}(-3.402823e+38f);` : `var threadMax = ${x}(-65504.0h);`, k = (O) => `
      ...
      }`, I = e.compute({ name: "Softmax", shaderCache: { hint: `${b};${_}`, inputDependencies: ["type"] }, getRunData: () => ({ outputs: [{ dims: p, dataType: d.dataType }], dispatchGroup: { x: f }, programUniforms: [{ type: 6, data: g }] }), getShaderSource: k }, { inputs: [d], outputs: [u ? -1 : 0] })[0];
    u && e.compute(ke(I, c), { inputs: [I] });
  }, Gl = (e, t) => {
    ag(e.inputs), sg(e, t);
  }, Hl = (e) => X({ axis: e.axis });
});
...
var jl = U(() => {
  ...
  ne();
  ie();
  ql = (e) => Array.from(e.getBigInt64Array(), Number), ug = (e) => {
    ...
    if (ql(e[1]).length !== e[0].dims.length) throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor");
  }, dg = (e, t) => {
    let r = [];
    for (let n = 0; n < e.length; ++n) r.push(e[n] * t[n]);
    return r;
  }, lg = (e, t) => {
    let r = e[0].dims, n = t ?? ql(e[1]), o = dg(r, n), i = E.size(o), a = e[0].dataType, u = P("input", a, r.length), d = M("output", a, o.length), c = (p) => `
    ...
    ug(e.inputs), e.compute(lg(e.inputs), { inputs: [0] });
  };
});
var cg;
var pg;
...
var Ql = U(() => {
  ...
  cg = (e, t, r, n, o) => {
    ...
    let t = e[1].dims, r = e[2].dims, n = e[0].dims, o = e[1].dataType, i = !(E.areEqual(t, r) && E.areEqual(r, n)), a = t, u = E.size(t);
    if (i) {
      let c = et.calcShape(et.calcShape(t, r, false), n, false);
      if (!c) throw new Error("Can't perform where op on the given tensors");
      a = c, u = E.size(a);
    }
    let d = Math.ceil(u / 4);
    return { name: "Where", shaderCache: { inputDependencies: ["rank", "rank", "rank"] }, getShaderSource: (c) => cg(c, e, a, i, o), getRunData: () => ({ outputs: [{ dims: a, dataType: o }], dispatchGroup: { x: Math.ceil(u / 64 / 4) }, programUniforms: [{ type: 12, data: d }, ...N(n, t, r, a)] }) };
  }, Zl = (e) => {
    e.compute(pg(e.inputs));
  };
});
var Yl;
var Xl = U(() => {
...
var Jl = U(() => {
  ...
  an = class {
    ...
    build(t, r) {
      ...
      let a = rs(r, this.backend.device.limits), u = t.getShaderSource(a), d = `${o.join(`
`)}
${a.additionalImplementations}
${u}`, c = n.createShaderModule({ code: d, label: t.name });
      ue("verbose", () => `[WebGPU] ${t.name} shader code: ${d}`);
      let p = n.createComputePipeline({ compute: { module: c, entryPoint: "main" }, layout: "auto", label: t.name });
      return De(t.name), { programInfo: t, computePipeline: p, uniformVariablesInfo: a.variablesInfo };
    }
...
var tc = U(() => {
  ...
  mg = (e, t) => {
    ...
    var _a2, _b;
    let n = e.name;
    return ((_a2 = e.shaderCache) == null ? void 0 : _a2.hint) && (n += "[" + e.shaderCache.hint + "]"), n += ":" + r + `:${mg(t, ((_b = e.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(t.length).fill("dims"))}`, n;
  }, Io = class {
    constructor(t) {
    ...
    async initialize(t, r) {
      ...
      i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await r.requestDevice(o), this.adapterInfo = new Io(r.info || await r.requestAdapterInfo()), this.gpuDataManager = Ja(this), this.programManager = new an(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Dr(t.logLevel, !!t.debug), this.device.onuncapturederror = (a) => {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map(($) => ({ dims: $.dims, dataType: Xe($.dataType) })), outputsMetadata: f.map(($) => ({ dims: $.dims, dataType: Xe($.dataType) })), kernelId: a, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
          else {
            let $ = "";
            m.forEach((x, T) => {
              $ += `input[${T}]: [${x.dims}] | ${Xe(x.dataType)}, `;
            });
            let w = "";
            f.forEach((x, T) => {
              w += `output[${T}]: [${x.dims}] | ${Xe(x.dataType)}, `;
            }), console.log(`[profiling] kernel "${a}|${d}|${c}|${p}" ${$}${w}execution time: ${S - _} ns`);
          }
          br("GPU", `${p}::${b}::${g}`);
        }
    ...
    run(t, r, n, o, i, a) {
      ...
      for (let x = 0; x < r.length; ++x) {
        let T = r[x].data;
        if (T === 0) continue;
        let k = this.gpuDataManager.get(T);
        if (!k) throw new Error(`no GPU data for input: ${T}`);
        u.push(k);
      }
      ...
      for (let x = 0; x < d.length; ++x) {
        ...
        if (m[x] === -3) continue;
        let T = m[x] === -1, k = m[x] === -2, I = T || k ? i(d[x].dataType, d[x].dims) : o(m[x], d[x].dataType, d[x].dims);
        if (f.push(I), I.data === 0) continue;
        let O = this.gpuDataManager.get(I.data);
        if (!O) throw new Error(`no GPU data for output: ${I.data}`);
        if (T && this.temporaryData.push(O), k) {
          let z = this.kernelPersistentData.get(this.currentKernelId);
          z || (z = [], this.kernelPersistentData.set(this.currentKernelId, z)), z.push(O);
        }
        b.push(O);
      }
      if (u.length !== r.length || b.length !== f.length) {
        if (b.length === 0) return De(t.name), f;
      ...
      if (p) {
        let x = 0, T = [];
        p.forEach((z) => {
          let B = typeof z.data == "number" ? [z.data] : z.data;
          if (B.length === 0) return;
          let W = z.type === 10 ? 2 : 4, q, j;
          z.type === 10 ? (j = B.length > 4 ? 16 : B.length > 2 ? 8 : B.length * W, q = B.length > 4 ? 16 : W * B.length) : (j = B.length <= 2 ? B.length * W : 16, q = 16), x = Math.ceil(x / j) * j, T.push(x);
          let te = z.type === 10 ? 8 : 4;
          x += B.length > 4 ? Math.ceil(B.length / te) * q : B.length * W;
        });
        let k = 16;
        x = Math.ceil(x / k) * k;
        let I = new ArrayBuffer(x);
        p.forEach((z, B) => {
          let W = T[B], q = typeof z.data == "number" ? [z.data] : z.data;
          if (z.type === 6) new Int32Array(I, W, q.length).set(q);
          else if (z.type === 12) new Uint32Array(I, W, q.length).set(q);
          else if (z.type === 10) new Uint16Array(I, W, q.length).set(q);
          else if (z.type === 1) new Float32Array(I, W, q.length).set(q);
          else throw new Error(`Unsupported uniform type: ${Xe(z.type)}`);
        });
        let O = this.gpuDataManager.create(x, GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM);
        this.device.queue.writeBuffer(O.buffer, 0, I, 0, x), this.gpuDataManager.release(O.id), g = { offset: 0, size: x, buffer: O.buffer };
      }
      let _ = this.programManager.normalizeDispatchGroupSize(c), S = _[1] === 1 && _[2] === 1, $ = fg(t, r, S), w = this.programManager.getArtifact($);
      if (w || (w = this.programManager.build(t, _), this.programManager.setArtifact($, w), ue("info", () => `[artifact] key: ${$}, programName: ${t.name}`)), p && w.uniformVariablesInfo) {
        if (p.length !== w.uniformVariablesInfo.length) throw new Error(`Uniform variables count mismatch: expect ${w.uniformVariablesInfo.length}, got ${p.length} in program "${w.programInfo.name}".`);
        for (let x = 0; x < p.length; x++) {
          let T = p[x], k = T.type, I = typeof T.data == "number" ? 1 : T.data.length, [O, z] = w.uniformVariablesInfo[x];
          if (k !== O || I !== z) throw new Error(`Uniform variable ${x} mismatch: expect type ${O} with size ${z}, got type ${k} with size ${I} in program "${w.programInfo.name}".`);
        }
      }
      if (ue("info", () => `[ProgramManager] run "${t.name}" (key=${$}) with ${_[0]}x${_[1]}x${_[2]}`), this.queryType !== "none" || this.sessionStatus === "capturing") {
        let x = { kernelId: this.currentKernelId, programName: w.programInfo.name, inputTensorViews: r, outputTensorViews: f };
        this.pendingKernels.push(x), this.sessionStatus === "capturing" && this.capturedPendingKernels.get(this.currentSessionId).push(x);
      }
      return this.programManager.run(w, u, b, _, g), De(t.name), f;
    }
    upload(t, r) {
    ...
    computeKernel(t, r, n) {
      ...
      this.currentKernelId = t, d[0] && (d[1] = d[0](d[1]), d[0] = void 0), ue("info", () => `[WebGPU] Start to run kernel "[${i}] ${a}"...`);
...
var nc = U(() => {
  ...
  rr = class e {
    ...
    compute(t, r) {
      var _a2;
      let n = ((_a2 = r == null ? void 0 : r.inputs) == null ? void 0 : _a2.map((u) => typeof u == "number" ? this.inputs[u] : u)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (u, d, c) => new rr(this.module, d, this.output(u, c), c), a = (u, d) => {
        let c = wt(u, d);
        if (!c) throw new Error(`Unsupported data type: ${u}`);
        let p = c > 0 ? this.backend.gpuDataManager.create(c).id : 0;
        return new rr(this.module, u, p, d);
      };
    ...
    if (e === "webgpu") {
      let i = (tc(), qt(ec)).WebGpuBackend, a = new i();
      await a.initialize(r, n), o("webgpu", [a, (u) => a.alloc(Number(u)), (u) => a.free(u), (u, d, c, p = false) => {
        if (p) ue("verbose", () => `[WebGPU] jsepCopyGpuToGpu: src=${Number(u)}, dst=${Number(d)}, size=${Number(c)}`), a.memcpy(Number(u), Number(d));
        else {
          ue("verbose", () => `[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(u)}, gpuDataId=${Number(d)}, size=${Number(c)}`);
          let m = t.HEAPU8.subarray(Number(u >>> 0), Number(u >>> 0) + Number(c));
          a.upload(Number(d), m);
        }
      }, async (u, d, c) => {
        ue("verbose", () => `[WebGPU] jsepCopyGpuToCpu: gpuDataId=${u}, dataOffset=${d}, size=${c}`), await a.download(Number(u), () => t.HEAPU8.subarray(Number(d) >>> 0, Number(d + c) >>> 0));
      }, (u, d, c) => a.createKernel(u, Number(d), c, t.UTF8ToString(t._JsepGetNodeName(Number(d)))), (u) => a.releaseKernel(u), (u, d, c, p) => {
        ue("verbose", () => `[WebGPU] jsepRun: sessionHandle=${c}, kernel=${u}, contextDataOffset=${d}`);
...
var Wn = U(() => {
  ...
  gg = (e, t) => {
    ...
    gg(e.wasm.numThreads, Qt(e.logLevel));
  }, xr = async (e, t) => {
    var _a2, _b;
  ...
  }, Pt = /* @__PURE__ */ new Map(), bg = (e) => {
    let t = ge(), r = t.stackSave();
    try {
      let n = t.PTR_SIZE, o = t.stackAlloc(2 * n);
      t._OrtGetInputOutputCount(e, o, o + n) !== 0 && fe("Can't get session input/output count.");
      let a = n === 4 ? "i32" : "i64";
    ...
    try {
      ...
      r._OrtGetInputOutputMetadata(e, t, a, a + i) !== 0 && fe("Can't get session input/output metadata.");
    ...
    try {
      if ([a, d] = await Ra(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
        let T = [];
        for (let k of t.externalData) {
          let I = typeof k == "string" ? k : k.path;
          T.push(Yt(typeof k == "string" ? k : k.data).then((O) => {
            o.mountExternalData(I, O);
          }));
        }
        await Promise.all(T);
      }
      for (let T of (t == null ? void 0 : t.executionProviders) ?? []) if ((typeof T == "string" ? T : T.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof T != "string") {
          let I = T, O = I == null ? void 0 : I.context, z = I == null ? void 0 : I.gpuDevice, B = I == null ? void 0 : I.deviceType, W = I == null ? void 0 : I.powerPreference;
          O ? o.currentContext = O : z ? o.currentContext = await o.webnnCreateMLContext(z) : o.currentContext = await o.webnnCreateMLContext({ deviceType: B, powerPreference: W });
        } else o.currentContext = await o.webnnCreateMLContext();
        break;
      }
      i = await o._OrtCreateSession(r, n, a), (_a2 = o.webgpuOnCreateSession) == null ? void 0 : _a2.call(o, i), i === 0 && fe("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [m, f] = bg(i), b = !!(t == null ? void 0 : t.enableGraphCapture), g = [], _ = [], S = [], $ = [], w = [];
      for (let T = 0; T < m; T++) {
        let [k, I, O] = oc(i, T);
        k === 0 && fe("Can't get an input name."), c.push(k);
        let z = o.UTF8ToString(k);
        g.push(z), S.push(I === 0 ? { name: z, isTensor: false } : { name: z, isTensor: true, type: Xe(I), shape: O });
      }
      for (let T = 0; T < f; T++) {
        let [k, I, O] = oc(i, T + m);
        k === 0 && fe("Can't get an output name."), p.push(k);
        let z = o.UTF8ToString(k);
        _.push(z), $.push(I === 0 ? { name: z, isTensor: false } : { name: z, isTensor: true, type: Xe(I), shape: O });
        {
          if (b && (t == null ? void 0 : t.preferredOutputLocation) === void 0) {
            w.push("gpu-buffer");
            continue;
          }
          let B = typeof (t == null ? void 0 : t.preferredOutputLocation) == "string" ? t.preferredOutputLocation : ((_c = t == null ? void 0 : t.preferredOutputLocation) == null ? void 0 : _c[z]) ?? "cpu", W = o.webnnIsGraphOutput;
          if (B === "cpu" && W && W(i, z)) {
            w.push("ml-tensor-cpu-output");
            continue;
          }
          if (B !== "cpu" && B !== "cpu-pinned" && B !== "gpu-buffer" && B !== "ml-tensor") throw new Error(`Not supported preferred output location: ${B}.`);
          if (b && B !== "gpu-buffer") throw new Error(`Not supported preferred output location: ${B}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);
          w.push(B);
        }
      }
      let x = null;
      return w.some((T) => T === "gpu-buffer" || T === "ml-tensor" || T === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && fe("Can't create IO binding."), x = { handle: u, outputPreferredLocations: w, outputPreferredLocationsEncoded: w.map((T) => T === "ml-tensor-cpu-output" ? "ml-tensor" : T).map((T) => Kn(T)) }), Pt.set(i, [i, c, p, x, b, false]), [i, g, _, S, $];
    } catch (m) {
      throw c.forEach((f) => o._OrtFree(f)), p.forEach((f) => o._OrtFree(f)), u !== 0 && o._OrtReleaseBinding(u) !== 0 && fe("Can't release IO binding."), i !== 0 && o._OrtReleaseSession(i) !== 0 && fe("Can't release session."), m;
    } finally {
      o._free(r), a !== 0 && o._OrtReleaseSessionOptions(a) !== 0 && fe("Can't release session options."), d.forEach((m) => o._free(m)), (_d2 = o.unmountExternalData) == null ? void 0 : _d2.call(o);
    }
  }, Tr = (e) => {
    var _a2, _b, _c;
    let t = ge(), r = Pt.get(e);
    ...
    let [n, o, i, a, u] = r;
    a && (u && t._OrtClearBoundOutputs(a.handle) !== 0 && fe("Can't clear bound outputs."), t._OrtReleaseBinding(a.handle) !== 0 && fe("Can't release IO binding.")), (_a2 = t.jsepOnReleaseSession) == null ? void 0 : _a2.call(t, e), (_b = t.webnnOnReleaseSession) == null ? void 0 : _b.call(t, e), (_c = t.webgpuOnReleaseSession) == null ? void 0 : _c.call(t, e), o.forEach((d) => t._OrtFree(d)), i.forEach((d) => t._OrtFree(d)), t._OrtReleaseSession(n) !== 0 && fe("Can't release session."), Pt.delete(e);
  }, ic = async (e, t, r, n, o, i, a = false) => {
    if (!e) {
      t.push(0);
      return;
    }
    let u = ge(), d = u.PTR_SIZE, c = e[0], p = e[1], m = e[3], f = m, b, g;
    ...
    if (m === "gpu-buffer") {
      ...
      if (Array.isArray($)) {
        ...
        for (let w = 0; w < $.length; w++) {
          if (typeof $[w] != "string") throw new TypeError(`tensor data at index ${w} is not a string`);
          u.setValue(b + w * d, Ne($[w], r), "*");
        }
      } else {
        let w = u.webnnIsGraphInput, x = u.webnnIsGraphOutput;
        if (c !== "string" && w && x) {
          let T = u.UTF8ToString(o);
          if (w(n, T) || x(n, T)) {
            let k = _t(c);
            g = wt(k, p), f = "ml-tensor";
            let I = u.webnnCreateTemporaryTensor, O = u.webnnUploadTensor;
            if (!I || !O) throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
            let z = await I(n, k, p);
            O(z, new Uint8Array($.buffer, $.byteOffset, $.byteLength)), b = z;
    ...
    try {
      p.forEach((w, x) => u.setValue(S + x * d, w, d === 4 ? "i32" : "i64"));
      let $ = u._OrtCreateTensor(_t(c), b, g, S, p.length, Kn(f));
      $ === 0 && fe(`Can't create tensor for input/output. session=${n}, index=${i}.`), t.push($);
    } finally {
      u.stackRestore(_);
    }
  }, Ir = async (e, t, r, n, o, i) => {
    var _a2, _b, _c, _d2;
    let a = ge(), u = a.PTR_SIZE, d = Pt.get(e);
    if (!d) throw new Error(`cannot run inference. invalid session id: ${e}`);
    let c = d[0], p = d[1], m = d[2], f = d[3], b = d[4], g = d[5], _ = t.length, S = n.length, $ = 0, w = [], x = [], T = [], k = [], I = a.stackSave(), O = a.stackAlloc(_ * u), z = a.stackAlloc(_ * u), B = a.stackAlloc(S * u), W = a.stackAlloc(S * u);
    try {
      [$, w] = Ba(i);
      for (let V = 0; V < _; V++) await ic(r[V], x, k, e, p[t[V]], t[V], b);
      for (let V = 0; V < S; V++) await ic(o[V], T, k, e, m[n[V]], _ + n[V], b);
      for (let V = 0; V < _; V++) a.setValue(O + V * u, x[V], "*"), a.setValue(z + V * u, p[t[V]], "*");
      for (let V = 0; V < S; V++) a.setValue(B + V * u, T[V], "*"), a.setValue(W + V * u, m[n[V]], "*");
      if (f && !g) {
        let { handle: V, outputPreferredLocations: de, outputPreferredLocationsEncoded: J } = f;
        if (p.length !== _) throw new Error(`input count from feeds (${_}) is expected to be always equal to model's input count (${p.length}).`);
        for (let H = 0; H < _; H++) {
          let ae = t[H];
          await a._OrtBindInput(V, p[ae], x[H]) !== 0 && fe(`Can't bind input[${H}] for session=${e}.`);
        }
        for (let H = 0; H < S; H++) {
          let ae = n[H];
          ((_a2 = o[H]) == null ? void 0 : _a2[3]) ? a._OrtBindOutput(V, m[ae], T[H], 0) !== 0 && fe(`Can't bind pre-allocated output[${H}] for session=${e}.`) : a._OrtBindOutput(V, m[ae], 0, J[ae]) !== 0 && fe(`Can't bind output[${H}] to ${de[H]} for session=${e}.`);
        }
        Pt.set(e, [c, p, m, f, b, true]);
      }
      (_b = a.jsepOnRunStart) == null ? void 0 : _b.call(a, c), (_c = a.webnnOnRunStart) == null ? void 0 : _c.call(a, c);
      let q;
      f ? q = await a._OrtRunWithBinding(c, f.handle, S, B, $) : q = await a._OrtRun(c, z, O, _, W, S, B, $), q !== 0 && fe("failed to call OrtRun().");
      let j = [], te = [];
      for (let V = 0; V < S; V++) {
        let de = Number(a.getValue(B + V * u, "*"));
        if (de === T[V]) {
          j.push(o[V]);
          continue;
        }
        let J = a.stackSave(), H = a.stackAlloc(4 * u), ae = false, Z, re = 0;
        try {
          a._OrtGetTensorData(de, H, H + u, H + 2 * u, H + 3 * u) !== 0 && fe(`Can't access output tensor data on index ${V}.`);
          let _e = u === 4 ? "i32" : "i64", ee = Number(a.getValue(H, _e));
          re = a.getValue(H + u, "*");
          let C = a.getValue(H + u * 2, "*"), L = Number(a.getValue(H + u * 3, _e)), le = [];
          for (let xe = 0; xe < L; xe++) le.push(Number(a.getValue(C + xe * u, _e)));
          a._OrtFree(C) !== 0 && fe("Can't free memory for tensor dims.");
          let Ce = le.reduce((xe, ce) => xe * ce, 1);
          Z = Xe(ee);
          let ze = f == null ? void 0 : f.outputPreferredLocations[n[V]];
          if (Z === "string") {
            if (ze === "gpu-buffer" || ze === "ml-tensor") throw new Error("String tensor is not supported on GPU.");
            let xe = [];
            for (let ce = 0; ce < Ce; ce++) {
              let Ge = a.getValue(re + ce * u, "*"), lt = a.getValue(re + (ce + 1) * u, "*"), ct = ce === Ce - 1 ? void 0 : lt - Ge;
              xe.push(a.UTF8ToString(Ge, ct));
            }
            j.push([Z, le, xe, "cpu"]);
          } else if (ze === "gpu-buffer" && Ce > 0) {
            let xe = a.jsepGetBuffer;
            if (!xe) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
            let ce = xe(re), Ge = wt(ee, Ce);
            if (Ge === void 0 || !Or(Z)) throw new Error(`Unsupported data type: ${Z}`);
            ae = true, j.push([Z, le, { gpuBuffer: ce, download: a.jsepCreateDownloader(ce, Ge, Z), dispose: () => {
              a._OrtReleaseTensor(de) !== 0 && fe("Can't release tensor.");
            } }, "gpu-buffer"]);
          } else if (ze === "ml-tensor" && Ce > 0) {
            let xe = a.webnnEnsureTensor, ce = a.webnnIsGraphInputOutputTypeSupported;
            if (!xe || !ce) throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
            if (wt(ee, Ce) === void 0 || !zr(Z)) throw new Error(`Unsupported data type: ${Z}`);
            if (!ce(e, Z, false)) throw new Error(`preferredLocation "ml-tensor" for ${Z} output is not supported by current WebNN Context.`);
            let lt = await xe(e, re, ee, le, false);
            ae = true, j.push([Z, le, { mlTensor: lt, download: a.webnnCreateMLTensorDownloader(re, Z), dispose: () => {
              a.webnnReleaseTensorId(re), a._OrtReleaseTensor(de);
            } }, "ml-tensor"]);
          } else if (ze === "ml-tensor-cpu-output" && Ce > 0) {
            let xe = a.webnnCreateMLTensorDownloader(re, Z)(), ce = j.length;
            ae = true, te.push((async () => {
              let Ge = [ce, await xe];
              return a.webnnReleaseTensorId(re), a._OrtReleaseTensor(de), Ge;
            })()), j.push([Z, le, [], "cpu"]);
          } else {
            let xe = Ut(Z), ce = new xe(Ce);
            new Uint8Array(ce.buffer, ce.byteOffset, ce.byteLength).set(a.HEAPU8.subarray(re, re + ce.byteLength)), j.push([Z, le, ce, "cpu"]);
          }
        } finally {
          a.stackRestore(J), Z === "string" && re && a._free(re), ae || a._OrtReleaseTensor(de);
        }
      }
      f && !b && (a._OrtClearBoundOutputs(f.handle) !== 0 && fe("Can't clear bound outputs."), Pt.set(e, [c, p, m, f, b, false]));
      for (let [V, de] of await Promise.all(te)) j[V][2] = de;
      return j;
    } finally {
      (_d2 = a.webnnOnRunEnd) == null ? void 0 : _d2.call(a, c), a.stackRestore(I), x.forEach((q) => a._OrtReleaseTensor(q)), T.forEach((q) => a._OrtReleaseTensor(q)), k.forEach((q) => a._free(q)), $ !== 0 && a._OrtReleaseRunOptions($), w.forEach((q) => a._free(q));
    }
  }, Cr = (e) => {
    let t = ge(), r = Pt.get(e);
    if (!r) throw new Error("invalid session id");
    let n = r[0], o = t._OrtEndProfiling(n);
    o === 0 && fe("Can't get an profile file name."), t._OrtFree(o);
  }, Ar = (e) => {
    let t = [];
    for (let r of e) {
      let n = r[2];
...
var Po = U(() => {
  ...
  yt();
  wr();
  Ot = () => !!be.wasm.proxy && typeof document < "u", nr = false, un = false, dn = false, Eo = /* @__PURE__ */ new Map(), Lt = (e, t) => {
    let r = Eo.get(e);
    r ? r.push(t) : Eo.set(e, [t]);
  }, Gt = () => {
    if (nr || !un || dn || !Le) throw new Error("worker not ready");
  }, _g = (e) => {
    switch (e.data.type) {
      case "init-wasm":
        nr = false, e.data.err ? (dn = true, ko[1](e.data.err)) : (un = true, ko[0]()), sn && (URL.revokeObjectURL(sn), sn = void 0);
        break;
      case "init-ep":
      case "copy-from":
      case "create":
    ...
    if (!un) {
      ...
      if (dn) throw new Error("previous call to 'initWasm()' failed.");
      if (nr = true, Ot()) return new Promise((e, t) => {
        Le == null ? void 0 : Le.terminate(), Oa().then(([r, n]) => {
          try {
            Le = n, Le.onerror = (i) => t(i), Le.onmessage = _g, ko = [e, t];
            let o = { type: "init-wasm", in: be };
            !o.in.wasm.wasmPaths && (r || Hn) && (o.in.wasm.wasmPaths = { wasm: new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Le.postMessage(o), sn = r;
          } catch (o) {
            t(o);
          }
        }, t);
      ...
      try {
        await vr(be.wasm), await $r(be), un = true;
      } catch (e) {
        throw dn = true, e;
      } finally {
        nr = false;
    ...
    if (Ot()) return Gt(), new Promise((t, r) => {
      Lt("init-ep", [t, r]);
      let n = { type: "init-ep", in: { epName: e, env: be } };
      Le.postMessage(n);
    });
    await xr(be, e);
  }, uc = async (e) => Ot() ? (Gt(), new Promise((t, r) => {
    Lt("copy-from", [t, r]);
    ...
    if (Ot()) {
      ...
      return Gt(), new Promise((a, u) => {
        Lt("run", [a, u]);
        let d = r, c = { type: "run", in: { sessionId: e, inputIndices: t, inputs: d, outputIndices: n, options: i } };
        Le.postMessage(c, Ar(d));
      });
    } else return Ir(e, t, r, n, o, i);
  }, pc = async (e) => {
    if (Ot()) return Gt(), new Promise((t, r) => {
      Lt("end-profiling", [t, r]);
...
var fc = U(() => {
  ...
  mc = (e, t) => {
    ...
    switch (e[3]) {
      ...
      case "gpu-buffer": {
        let t = e[0];
        if (!Or(t)) throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);
        let { gpuBuffer: r, download: n, dispose: o } = e[2];
        return He.fromGpuBuffer(r, { dataType: t, dims: e[1], download: n, dispose: o });
      }
      case "ml-tensor": {
        let t = e[0];
        if (!zr(t)) throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);
        let { mlTensor: r, download: n, dispose: o } = e[2];
        return He.fromMLTensor(r, { dataType: t, dims: e[1], download: n, dispose: o });
      }
      default:
    ...
    async fetchModelAndCopyToWasmMemory(t) {
      return uc(await Yt(t));
    }
    async loadModel(t, r) {
      Re();
      let n;
      typeof t == "string" ? n = await this.fetchModelAndCopyToWasmMemory(t) : n = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await dc(n, r), De();
    }
    async dispose() {
      return lc(this.sessionId);
    }
    async run(t, r, n) {
      Re();
      let o = [], i = [];
      ...
      let d = o.map((f, b) => mc(f, () => `input "${this.inputNames[i[b]]}"`)), c = a.map((f, b) => f ? mc(f, () => `output "${this.outputNames[u[b]]}"`) : null), p = await cc(this.sessionId, i, d, u, c, n), m = {};
      for (let f = 0; f < p.length; f++) m[this.outputNames[u[f]]] = a[f] ?? wg(p[f]);
      return De(), m;
    }
    startProfiling() {
    }
...
var gc = {};
Rt(gc, { OnnxruntimeWebAssemblyBackend: () => cn, initializeFlags: () => hc, wasmBackend: () => vg });
var hc;
var cn;
var vg;
var bc = U(() => {
  ...
  fc();
  hc = () => {
    (typeof be.wasm.initTimeout != "number" || be.wasm.initTimeout < 0) && (be.wasm.initTimeout = 0);
    let e = be.wasm.simd;
    if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), be.wasm.simd = false), typeof be.wasm.proxy != "boolean" && (be.wasm.proxy = false), typeof be.wasm.trace != "boolean" && (be.wasm.trace = false), typeof be.wasm.numThreads != "number" || !Number.isInteger(be.wasm.numThreads) || be.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) be.wasm.numThreads = 1;
    else {
      let t = typeof navigator > "u" ? Dn("node:os").cpus().length : navigator.hardwareConcurrency;
      be.wasm.numThreads = Math.min(4, Math.ceil((t || 1) / 2));
    }
  }, cn = class {
    async init(t) {
      hc(), await ac(), await sc(t);
    }
...
var kS = Vn;
{
  let e = (bc(), qt(gc)).wasmBackend;
  Tt("webgpu", e, 5), Tt("webnn", e, 5), Tt("cpu", e, 10), Tt("wasm", e, 10);
}
Object.defineProperty(be.versions, "web", { value: _a, enumerable: true });
export {
  Fp as InferenceSession,
  br as TRACE,
  Re as TRACE_FUNC_BEGIN,
  De as TRACE_FUNC_END,
  He as Tensor,
  kS as default,
  be as env,
  Tt as registerBackend
};
